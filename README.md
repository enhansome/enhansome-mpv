...
* [SMPlayer](https://github.com/smplayer-dev/smplayer) ⭐ 1,041 | 🐛 78 | 🌐 C++ | 📅 2026-08-11 - Based on C++/QT.
...
* [OvoPlayer](https://github.com/varianus/ovoplayer) ⭐ 66 | 🐛 2 | 🌐 Pascal | 📅 2026-08-18 - Unmaintained, based on Pascal.
* [mpv](https://mpv.io) - Based on C/Lua.

## Windows

* [mpv.net](https://github.com/mpvnet-player/mpv.net) ⭐ 5,334 | 🐛 156 | 🌐 C# | 📅 2026-02-09 - Based on C#/WinForms/WPF.
* [MPV-EASY Player](https://github.com/422658476/MPV-EASY-Player) ⭐ 1,422 | 🐛 1 | 🌐 Lua | 📅 2026-07-12
* [mpc-qt](https://github.com/mpc-qt/mpc-qt) ⭐ 1,057 | 🐛 122 | 🌐 C++ | 📅 2026-08-19 - Based on C++/QT.
...
* [Deepin Movie](https://github.com/linuxdeepin/deepin-movie-reborn) ⭐ 88 | 🐛 4 | 🌐 C++ | 📅 2026-08-19 - Unmaintained, based on C++/QT.
...
* [android](https://github.com/mpv-android/mpv-android) ⭐ 3,477 | 🐛 163 | 🌐 Kotlin | 📅 2026-08-18 - Player for Android, based on Kotlin.
* [Kt](https://github.com/abdallahmehiz/mpvKt) ⚠️ Archived - Player for Android, based on Kotlin.

# Installation/Download

* [shinchiro GitHub](https://github.com/shinchiro/mpv-winbuild-cmake) ⭐ 1,712 | 🐛 57 | 🌐 CMake | 📅 2026-08-14 - Daily Windows builds of mpv and libmpv. This is the most popular choice on Windows.
* [zhongfly](https://github.com/zhongfly/mpv-winbuild) ⭐ 877 | 🐛 0 | 🌐 Shell | 📅 2026-08-19 - Windows builds of mpv and libmpv. This choice is very similar to `shinchiro GitHub`, so it's also a recommendation.
* [mpsm](https://github.com/mpv-easy/mpv-easy/tree/main/mpv-mpsm) ⭐ 136 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-19 - mpsm is a mpv script manager, you can install scripts provided by [mpsm-scripts](https://github.com/mpv-easy/mpsm-scripts) ⭐ 20 | 🐛 0 | 🌐 Lua | 📅 2026-07-22, or install any script with added [meta info](https://github.com/mpv-easy/mpsm-scripts?tab=readme-ov-file#meta-info) ⭐ 20 | 🐛 0 | 🌐 Lua | 📅 2026-07-22 via url.
* [mitzsch](https://github.com/mitzsch/mpv-winbuild) ⭐ 29 | 🐛 0 | 🌐 Shell | 📅 2026-08-08 - Windows builds of mpv and libmpv.
* [Andarwinux](https://github.com/Andarwinux/mpv-winbuild) ⭐ 23 | 🐛 3 | 🌐 Shell | 📅 2026-08-18 - Daily Windows builds of mpv and libmpv including ARM64 architecture.
...
* [Wiki](https://github.com/mpv-player/mpv/wiki) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17
...
* <https://github.com/mpv-player/mpv/issues> ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17
* <https://github.com/mpv-player/mpv/discussions> ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17
...
in the [wiki](https://github.com/mpv-player/mpv/wiki/User-Scripts) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17,
the advantage of the following list is that everything is categorized
into popular sections, like Subtitles etc.

## Menu

* [select](https://github.com/mpv-player/mpv/blob/master/player/lua/select.lua) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17 - Menu script built into mpv.
* [uosc](https://github.com/tomasklaen/uosc) ⭐ 3,324 | 🐛 32 | 🌐 Lua | 📅 2026-08-03 - Popular OSC with menu.
...
* [betterchapters](https://gist.github.com/Hakkin/4f978a5c87c31f7fe3ae) ([update](https://github.com/mpv-player/mpv/issues/4738#issuecomment-321298846) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17) - Loads the next or previous playlist entry if there are no more chapters in the seek direction.
* [autoload](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autoload.lua) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17 - Automatically load playlist entries before and after the currently playing file, by scanning the directory. **Obsolete:** mpv now has a native `--autocreate-playlist` option.
* [print-playlist](https://git.sr.ht/~jagrg/dotfiles/tree/master/item/common/.config/mpv/scripts/print-playlist.lua) - Cleans [the playlist formatting](https://github.com/mpv-player/mpv/issues/5868#issue-327675880) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17 on the terminal.
...
* [pause-indicator-lite](https://github.com/Samillion/ModernZ/tree/main/extras/pause-indicator-lite) ⭐ 1,165 | 🐛 23 | 🌐 Lua | 📅 2026-06-04 - A simple script that displays an indicator on pause, with options to adjust icon, color, height, width, opacity and whether to toggle pause with a keybind or not.
...
* [SimpleUndo-3.2](https://github.com/Eisa01/mpv-scripts#simpleundo) ⭐ 838 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Simple undo feature. If you accidentally seek/jump to a different time in the video, press undo \[ctrl]+\[z] to return to your previous time and vice-versa. More details in the link above.
* [SmartSkip](https://github.com/Eisa01/mpv-scripts/#smartskip) ⭐ 838 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Automatically or manually skip opening, intro, outro, and preview, like never before. Jump to next file, previous file, and save your chapter changes! Much more explained in the link above.
...
* [ModernZ](https://github.com/Samillion/ModernZ) ⭐ 1,165 | 🐛 23 | 🌐 Lua | 📅 2026-06-04 - A fork of ModernX designed to enhance functionality by adding more features, all while preserving the core standards of mpv's OSC.
...
* [ModernX zydezu](https://github.com/zydezu/ModernX) ⭐ 286 | 🐛 3 | 🌐 Lua | 📅 2026-08-11 - A fork of ModernX with many additional features and customization.
...
* [uosc\_history\_menu](https://github.com/Koopex/uosc_history_menu) ⭐ 13 | 🐛 2 | 🌐 Lua | 📅 2026-08-18 - A history and bookmark management menu integrated with uosc.
...
* [acompressor](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/acompressor.lua) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17 - Dynamic range compressor using acompressor ffmpeg filter with controls to dynamically adjust parameters.
...
* [quality-menu](https://github.com/christoph-heinrich/mpv-quality-menu) ⭐ 235 | 🐛 2 | 🌐 Lua | 📅 2026-01-30 - Change the streamed video and audio quality (ytdl-format) on the fly.
...
* [torrserver](https://github.com/kritma/mpv-torrserver) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2024-02-05 - Allows streaming torrents using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 2,949 | 🐛 29 | 🌐 Go | 📅 2026-08-17. Support magnet links and .torrent files
* [torrserver-hook](https://github.com/eNV25/mpv-torrserver-hook) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-06-07 - Allows for playback of media from the BitTorrent network using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 2,949 | 🐛 29 | 🌐 Go | 📅 2026-08-17.
...
* [autocrop](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autocrop.lua) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17 - Automatically crop the video by using lavfi's cropdetect filter to detect black bars.
* [autodeint](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autodeint.lua) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17 - Automatically deinterlace the video by using lavfi's idet filter to detect interlaced content.
* [cycle-deinterlace-pullup](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/cycle-deinterlace-pullup.lua) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17 - Cycle between deinterlacing, pullup (IVTC), and both filters off.
...
* [thumbfast](https://github.com/po5/thumbfast) ⭐ 1,662 | 🐛 55 | 🌐 Lua | 📅 2026-08-12 - High-performance on-the-fly thumbnailer for mpv.
...
* [gallery-dl\_hook](https://github.com/jgreco/mpv-scripts/blob/master/gallery-dl_hook.lua) ⭐ 47 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Load online image galleries (imgur, etc) as playlists using [gallery-dl](https://github.com/mikf/gallery-dl/) ⭐ 19,254 | 🐛 1,156 | 🌐 Python | 📅 2026-08-01.
...
* [ontop-playback](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/ontop-playback.lua) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17 - Disables the ontop property when pausing, and enables it again when unpausing the video, if it was disabled. Change it only when the player is not in fullscreen to prevent screen flickering.
* [pause-when-minimize](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/pause-when-minimize.lua) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17 - Pauses the player video when minimizing, and unpauses it when brought up again.
* [single-instance](https://github.com/mpv-player/mpv/issues/43#issuecomment-2496083283) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17 - Reuse the existing mpv window when opening new files rather than spawning a new window.
...
* [jellyfin mpv shim](https://github.com/jellyfin/jellyfin-mpv-shim) ⭐ 2,320 | 🐛 178 | 🌐 Python | 📅 2026-08-19 - Jellyfin (Emby/Plex alternative) Client, based on Python.
...
* [dyphire](https://github.com/dyphire/mpv-config) ⭐ 1,844 | 🐛 6 | 🌐 GLSL | 📅 2026-08-17
* [Zabooby](https://github.com/Zabooby/mpv-config) ⭐ 556 | 🐛 0 | 🌐 GLSL | 📅 2026-08-13
* [noelsimbolon](https://github.com/noelsimbolon/mpv-config) ⭐ 305 | 🐛 2 | 🌐 GLSL | 📅 2026-04-30
* [Natural-Harmonia-Gropius](https://github.com/Natural-Harmonia-Gropius/mpv_config) ⭐ 105 | 🐛 0 | 🌐 GLSL | 📅 2026-08-18
...
* [KikoPlay](https://github.com/KikoPlayProject/KikoPlay) ⭐ 2,213 | 🐛 8 | 🌐 C++ | 📅 2026-07-18 - Cross-platform [Danmu](https://en.wikipedia.org/wiki/Danmu) player, based on C++/QT.
...
* [Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,266 | 🐛 123 | 🌐 Jupyter Notebook | 📅 2024-08-17 - A series of shaders designed to scale and enhance anime. Includes shaders for line sharpening, artefact removal, denoising, upscaling, and more.
...
* [ArtCNN](https://github.com/Artoriuz/ArtCNN) ⭐ 353 | 🐛 2 | 🌐 GLSL | 📅 2026-08-18 - Luma doublers trained on Manga109.
* [hdr-toys](https://github.com/natural-harmonia-gropius/hdr-toys) ⭐ 187 | 🐛 18 | 🌐 GLSL | 📅 2026-08-18 - Componentized Rec.2100 to Rec.709 conversion shader.
...
* [qimgv](https://github.com/easymodo/qimgv) ⭐ 3,107 | 🐛 307 | 🌐 C++ | 📅 2026-01-19 - Cross-platform, based on C++/QT.

# Launcher

* <https://github.com/mpv-player/mpv/blob/master/TOOLS/umpv> ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17
* <https://github.com/davatorium/rofi> ⭐ 16,333 | 🐛 117 | 🌐 C | 📅 2026-08-09
* <https://github.com/Flow-Launcher/Flow.Launcher> ⭐ 15,388 | 🐛 303 | 🌐 C# | 📅 2026-08-18
* <https://github.com/ikas-mc/ContextMenuForWindows11> ⭐ 2,864 | 🐛 20 | 🌐 C# | 📅 2026-07-25
...
* [Compiling for Windows](https://github.com/mpv-player/mpv/blob/master/DOCS/compile-windows.md) ⭐ 36,589 | 🐛 1,133 | 🌐 C | 📅 2026-08-17
* [Building mpv and libmpv using wsl2 and Ubuntu](https://github.com/mpvnet-player/mpv.net/wiki/Building-mpv-and-libmpv-using-wsl2-and-Ubuntu) ⭐ 5,334 | 🐛 156 | 🌐 C# | 📅 2026-02-09
* [Media Auto Build Suite (MABS)](https://github.com/m-ab-s/media-autobuild_suite) ⭐ 1,811 | 🐛 219 | 🌐 Shell | 📅 2026-08-18
* [Helper scripts to compile mpv on Linux](https://github.com/mpv-player/mpv-build) ⭐ 490 | 🐛 9 | 🌐 Shell | 📅 2025-11-02
...
* [easy](https://github.com/mpv-easy/mpv-easy) ⭐ 136 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-19 - TS and React GUI toolkit for mpv script.
...
* [Memento](https://github.com/ripose-jp/Memento) ⭐ 1,466 | 🐛 27 | 🌐 C++ | 📅 2026-08-05 - Cross-platform video player for studying Japanese, based on C++/QT.
...
* [mpvQC](https://github.com/mpvqc/mpvQC) ⭐ 79 | 🐛 5 | 🌐 Python | 📅 2026-08-17 - Cross-platform application for quality control of videos, based on Python/QT.
