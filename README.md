...
* [SMPlayer](https://github.com/smplayer-dev/smplayer) ⭐ 1,046 | 🐛 80 | 🌐 C++ | 📅 2026-09-09 - Based on C++/QT.
...
* [Baka-MPlayer](https://github.com/u8sand/Baka-MPlayer) ⭐ 467 | 🐛 94 | 🌐 C++ | 📅 2026-06-21 - Unmaintained, based on C++/QT.
...
* [mpv.net](https://github.com/mpvnet-player/mpv.net) ⭐ 5,384 | 🐛 156 | 🌐 C# | 📅 2026-02-09 - Based on C#/WinForms/WPF.
* [MPV-EASY Player](https://github.com/422658476/MPV-EASY-Player) ⭐ 1,430 | 🐛 1 | 🌐 Lua | 📅 2026-09-06
* [mpc-qt](https://github.com/mpc-qt/mpc-qt) ⭐ 1,081 | 🐛 111 | 🌐 C++ | 📅 2026-09-09 - Based on C++/QT.
* [mpv-hero](https://github.com/stax76/mpv-hero) ⭐ 138 | 🐛 8 | 🌐 Lua | 📅 2025-11-26 - mpv extended with GUI scripts and GUI tools.
* [MMP: Minimalist Media Player](https://github.com/BazzaCuda/MinimalistMediaPlayerX) ⭐ 57 | 🐛 3 | 🌐 Pascal | 📅 2026-08-27 - Player/Manager/Editor for audio and video, and Viewer/Manager for images/thumbnails; maintained, based on 64-bit Delphi Pascal. Official [wiki](https://minimalistmediaplayer.com).
...
* [Kawaii Player](https://github.com/kanishka-linux/kawaii-player) ⭐ 712 | 🐛 17 | 🌐 Python | 📅 2026-09-06 - Player/Library/Server, based on Python/QT.
* [xt7-player-mpv](https://github.com/kokoko3k/xt7-player-mpv) ⭐ 105 | 🐛 2 | 🌐 Lua | 📅 2026-06-12 - Based on Gambas/QT.
* [Deepin Movie](https://github.com/linuxdeepin/deepin-movie-reborn) ⭐ 88 | 🐛 5 | 🌐 C++ | 📅 2026-09-03 - Unmaintained, based on C++/QT.
...
* [android](https://github.com/mpv-android/mpv-android) ⭐ 3,535 | 🐛 163 | 🌐 Kotlin | 📅 2026-09-09 - Player for Android, based on Kotlin.
* [Kt](https://github.com/abdallahmehiz/mpvKt) ⚠️ Archived - Player for Android, based on Kotlin.

# Installation/Download

* [shinchiro GitHub](https://github.com/shinchiro/mpv-winbuild-cmake) ⭐ 1,742 | 🐛 60 | 🌐 CMake | 📅 2026-09-03 - Daily Windows builds of mpv and libmpv. This is the most popular choice on Windows.
* [zhongfly](https://github.com/zhongfly/mpv-winbuild) ⭐ 910 | 🐛 0 | 🌐 Shell | 📅 2026-09-09 - Windows builds of mpv and libmpv. This choice is very similar to `shinchiro GitHub`, so it's also a recommendation.
* [mpsm](https://github.com/mpv-easy/mpv-easy/tree/main/mpv-mpsm) ⭐ 138 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-07 - mpsm is a mpv script manager, you can install scripts provided by [mpsm-scripts](https://github.com/mpv-easy/mpsm-scripts) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-07, or install any script with added [meta info](https://github.com/mpv-easy/mpsm-scripts?tab=readme-ov-file#meta-info) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-07 via url.
* [mitzsch](https://github.com/mitzsch/mpv-winbuild) ⭐ 29 | 🐛 0 | 🌐 Shell | 📅 2026-08-08 - Windows builds of mpv and libmpv.
* [Andarwinux](https://github.com/Andarwinux/mpv-winbuild) ⭐ 23 | 🐛 3 | 🌐 Shell | 📅 2026-09-09 - Daily Windows builds of mpv and libmpv including ARM64 architecture.
...
* [Wiki](https://github.com/mpv-player/mpv/wiki) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08
...
* <https://github.com/mpv-player/mpv/issues> ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08
* <https://github.com/mpv-player/mpv/discussions> ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08
...
in the [wiki](https://github.com/mpv-player/mpv/wiki/User-Scripts) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08,
the advantage of the following list is that everything is categorized
into popular sections, like Subtitles etc.

## Menu

* [select](https://github.com/mpv-player/mpv/blob/master/player/lua/select.lua) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08 - Menu script built into mpv.
* [uosc](https://github.com/tomasklaen/uosc) ⭐ 3,379 | 🐛 35 | 🌐 Lua | 📅 2026-08-30 - Popular OSC with menu.
...
* [mpvc-tui](https://github.com/gmt4/mpvc) ⭐ 158 | 🐛 1 | 🌐 Shell | 📅 2026-09-09 - Command-line and TUI for mpv.
...
* [betterchapters](https://gist.github.com/Hakkin/4f978a5c87c31f7fe3ae) ([update](https://github.com/mpv-player/mpv/issues/4738#issuecomment-321298846) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08) - Loads the next or previous playlist entry if there are no more chapters in the seek direction.
* [autoload](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autoload.lua) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08 - Automatically load playlist entries before and after the currently playing file, by scanning the directory. **Obsolete:** mpv now has a native `--autocreate-playlist` option.
* [print-playlist](https://git.sr.ht/~jagrg/dotfiles/tree/master/item/common/.config/mpv/scripts/print-playlist.lua) - Cleans [the playlist formatting](https://github.com/mpv-player/mpv/issues/5868#issue-327675880) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08 on the terminal.
* [playlistnoplayback](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/playlistnoplayback.lua) ⭐ 1,430 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - If you enable the save play history and progress function, this lua script can solve the problem of automatically jumping to the previous playback progress when playing the next file when playing the playlist, that is, let the playlist always play the next file from the beginning every time. the limitations of this script, please see the comments section in the content.
* [pause-indicator-lite](https://github.com/Samillion/ModernZ/tree/main/extras/pause-indicator-lite) ⭐ 1,220 | 🐛 25 | 🌐 Lua | 📅 2026-06-04 - A simple script that displays an indicator on pause, with options to adjust icon, color, height, width, opacity and whether to toggle pause with a keybind or not.
...
* [seek-to](https://github.com/occivink/mpv-scripts#seek-tolua) ⭐ 490 | 🐛 43 | 🌐 Lua | 📅 2025-11-01 - Seek to an absolute timestamp specified via keyboard input.
...
* [censor](https://github.com/zenyd/mpv-scripts) ⭐ 194 | 🐛 1 | 🌐 Lua | 📅 2025-12-07 - Skip over parts of videos you don't want (others) to view
* [speed-transition](https://github.com/zenyd/mpv-scripts) ⭐ 194 | 🐛 1 | 🌐 Lua | 📅 2025-12-07 - Increases playback speed if a subtitle will not be displayed soon. Resumes normal speed just before the subtitle shows up.
...
* [chapter-make-read](https://github.com/dyphire/mpv-scripts/blob/main/chapter-make-read.lua) ⭐ 124 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Automatically read an load the namesake external chapter file with extension of CHP. Temporarily mark the current playback position as a chapter so you can seek to it later. Also allows writing current chapters as CHP or XML. Based on `createchapter`.
* [track-list](https://github.com/dyphire/mpv-scripts/blob/main/track-list.lua) ⭐ 124 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Interractive track-list menu.
* [skiptosilence dyphire](https://github.com/dyphire/mpv-scripts/blob/main/skiptosilence.lua) ⭐ 124 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Skips to the next silence in the file.
* [memo](https://github.com/po5/memo) ⭐ 122 | 🐛 11 | 🌐 Lua | 📅 2024-11-01 - A recent files/history menu for mpv with optional uosc integration.
* [btime](https://github.com/butterw/bShaders/blob/master/mpv/settings/scripts/btime.js) ⭐ 111 | 🐛 3 | 🌐 HLSL | 📅 2024-01-19 - Shows a shorter time format when seeking: 0:15 / 3:10, 08:20 / 55:00, 0:00:05 / 1:30:14.
* [countdown](https://github.com/butterw/bShaders/blob/master/mpv/settings/scripts/countdown.lua) ⭐ 111 | 🐛 3 | 🌐 HLSL | 📅 2024-01-19 - Display a countdown on OSD for the final seconds of the video (or music file).
...
* [guess-media-title](https://github.com/zenwarr/mpv-config/blob/master/scripts/guess-media-title.lua) ⭐ 35 | 🐛 3 | 🌐 Lua | 📅 2025-11-16 - Uses [guessit](https://github.com/guessit-io/guessit) ⭐ 934 | 🐛 17 | 🌐 Python | 📅 2026-09-09 to detect a media title by filename and set `force-media-title` variable. Useful for getting cleaner screenshot file names.
...
* [delete-file](https://github.com/zenyd/mpv-scripts) ⭐ 194 | 🐛 1 | 🌐 Lua | 📅 2025-12-07 - Delete files being played.
...
* [osd-bar](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/osd-bar.lua) ⭐ 1,430 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - Always show osd progress bar, with the more beautiful color matching in the [configuration file](https://github.com/422658476/MPV-EASY-Player/blob/master/mpv-easy-data/rjno1.conf) ⭐ 1,430 | 🐛 1 | 🌐 Lua | 📅 2026-09-06, you can make the osd progress bar display the current progress at the bottom of the window beautifully,this is a [preview](https://raw.githubusercontent.com/422658476/MPV-EASY-Player/master/img/mpv-easy-player-osd-bar-lua.jpg).

* [osc-style](https://github.com/422658476/MPV-EASY-Player/tree/master/mpv-easy-data/osc-style) ⭐ 1,430 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - Change the mpv OSC to a more beautiful and practical look, which is the osc theme feature, a variety of styles to choose from,this is a [tutorial and a preview](https://github.com/422658476/MPV-EASY-Player#%E7%9C%8B%E5%88%B0%E4%B8%8A%E9%9D%A2%E5%9B%BE%E4%B8%8A%E8%BF%99%E4%BA%9Bosc%E6%A0%B7%E5%BC%8F%E4%BA%86%E5%90%97%E5%AE%83%E4%BB%AC%E4%B8%8D%E4%BB%85%E5%8F%AF%E4%BB%A5%E5%AD%98%E5%9C%A8%E4%BA%8Empv-easy-player%E4%B8%AD%E4%BD%A0%E4%BD%BF%E7%94%A8%E7%9A%84mpv%E7%9A%84osc%E4%B9%9F%E5%8F%AF%E4%BB%A5%E5%8F%98%E6%88%90%E8%BF%99%E6%A0%B7) ⭐ 1,430 | 🐛 1 | 🌐 Lua | 📅 2026-09-06.

* [ModernZ](https://github.com/Samillion/ModernZ) ⭐ 1,220 | 🐛 25 | 🌐 Lua | 📅 2026-06-04 - A fork of ModernX designed to enhance functionality by adding more features, all while preserving the core standards of mpv's OSC.

* [ModernX cyl0](https://github.com/cyl0/ModernX) ⭐ 761 | 🐛 20 | 🌐 Lua | 📅 2026-02-04 - Modern OSC replacement.
...
* [osc-modern](https://github.com/maoiscat/mpv-osc-modern) ⭐ 429 | 🐛 15 | 🌐 Lua | 📅 2024-04-20 - Modern OSC replacement.
...
* [ModernX zydezu](https://github.com/zydezu/ModernX) ⭐ 295 | 🐛 4 | 🌐 Lua | 📅 2026-08-11 - A fork of ModernX with many additional features and customization.
...
* [osc-modern-f](https://github.com/FinnRaze/mpv-osc-modern-f) ⭐ 91 | 🐛 2 | 🌐 Lua | 📅 2024-09-17 - OSC script forked from [mpv-osc-modern](https://github.com/maoiscat/mpv-osc-modern) ⭐ 429 | 🐛 15 | 🌐 Lua | 📅 2024-04-20.
...
* [subselect Tk](https://github.com/zenyd/mpv-scripts) ⭐ 194 | 🐛 1 | 🌐 Lua | 📅 2025-12-07 - Download subtitles with a GUI - select the one you want and automatically load them up in mpv. Supports searching for arbitrary names and different subtitle languages. Works on Windows and Linux, possibly macOS.
...
* [sub\_export](https://github.com/dyphire/mpv-scripts/blob/main/sub_export.lua) ⭐ 124 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - fork, updated. Extract selected subtitles from .mkv file.
...
* [mpvacious](https://github.com/Ajatt-Tools/mpvacious) ⭐ 885 | 🐛 12 | 🌐 Lua | 📅 2026-09-04 - Add keybindings to create Anki flashcards for (language) learning.
...
* [acompressor](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/acompressor.lua) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08 - Dynamic range compressor using acompressor ffmpeg filter with controls to dynamically adjust parameters.
...
* [adevice-list](https://github.com/dyphire/mpv-scripts/blob/main/adevice-list.lua) ⭐ 124 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Interractive audio-device list menu.
...
* [sponsorblock](https://github.com/po5/mpv_sponsorblock) ⭐ 630 | 🐛 29 | 🌐 Lua | 📅 2024-05-01 - Script to skip sponsored segments of YouTube videos.
...
* [ytdlautoformat](https://github.com/Samillion/mpv-ytdlautoformat) ⭐ 59 | 🐛 0 | 🌐 Lua | 📅 2026-04-10 - Automatically adjusts `ytdl-format` (yt-dlp) for specified domains.
...
* [torrserver](https://github.com/kritma/mpv-torrserver) ⭐ 8 | 🐛 0 | 🌐 Lua | 📅 2024-02-05 - Allows streaming torrents using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,022 | 🐛 26 | 🌐 Go | 📅 2026-09-04. Support magnet links and .torrent files
...
* [torrserver-hook](https://github.com/eNV25/mpv-torrserver-hook) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-06-07 - Allows for playback of media from the BitTorrent network using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,022 | 🐛 26 | 🌐 Go | 📅 2026-09-04.
...
* [autocrop](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autocrop.lua) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08 - Automatically crop the video by using lavfi's cropdetect filter to detect black bars.
* [autodeint](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autodeint.lua) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08 - Automatically deinterlace the video by using lavfi's idet filter to detect interlaced content.
* [cycle-deinterlace-pullup](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/cycle-deinterlace-pullup.lua) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08 - Cycle between deinterlacing, pullup (IVTC), and both filters off.
* [use-cpu](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/use-cpu.lua) ⭐ 1,430 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - If the width of the video is greater than 3000 or the height of the video is greater than 2000, it will automatically switch back to using cpu decoding.
* [crop](https://github.com/occivink/mpv-scripts#croplua) ⭐ 490 | 🐛 43 | 🌐 Lua | 📅 2025-11-01 - Crop the video by defining the target rectangle with the cursor.
* [blur-edges](https://github.com/occivink/mpv-scripts#blur-edgeslua) ⭐ 490 | 🐛 43 | 🌐 Lua | 📅 2025-11-01 - Replace black bars with a blurry copy of the video.
...
* [hdr-mode](https://github.com/dyphire/mpv-scripts/blob/main/hdr-mode.lua) ⭐ 124 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Automatically switches the display's SDR and HDR modes for HDR passthrough based on the content of the video being played.
* [store-shaders](https://github.com/butterw/bShaders/blob/master/mpv/settings/scripts/store-shaders.js) ⭐ 111 | 🐛 3 | 🌐 HLSL | 📅 2024-01-19 - Store current glsl-shaders config on first run, this config will then be restored by subsequent calls.
* [switch-shader](https://github.com/butterw/bShaders/blob/master/mpv/settings/scripts/switch-shader.js) ⭐ 111 | 🐛 3 | 🌐 HLSL | 📅 2024-01-19 - Provides a switch to disable/restore shaders and vf filters.
* [mpv360](https://github.com/kasper93/mpv360) ⭐ 78 | 🐛 3 | 🌐 Lua | 📅 2026-01-30 - Interactive 360° Video Viewer. With full camera control through mouse and keyboard inputs.
...
* [thumbfast](https://github.com/po5/thumbfast) ⭐ 1,688 | 🐛 56 | 🌐 Lua | 📅 2026-08-12 - High-performance on-the-fly thumbnailer for mpv.
...
* [auto-mode](https://github.com/stax76/mpv-scripts) ⭐ 232 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Use mpv as video player, music player and image viewer, switch automatically between, video, audio and image mode.
* [screenshotfolder](https://github.com/zydezu/mpvconfig/blob/main/scripts/screenshotfolder.lua) ⭐ 111 | 🐛 0 | 🌐 Lua | 📅 2026-09-07 - Place screenshots into folders for each video, along with timestamping them.
...
* [gallery-dl\_hook](https://github.com/jgreco/mpv-scripts/blob/master/gallery-dl_hook.lua) ⭐ 46 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Load online image galleries (imgur, etc) as playlists using [gallery-dl](https://github.com/mikf/gallery-dl/) ⭐ 19,457 | 🐛 1,139 | 🌐 Python | 📅 2026-09-04.
...
* [image-config](https://github.com/guidocella/mpv-image-config) ⭐ 35 | 🐛 0 | 🌐 Lua | 📅 2026-03-14 - A configuration to use mpv as an image viewer.
...
* [videoclip](https://github.com/Ajatt-Tools/videoclip) ⭐ 197 | 🐛 7 | 🌐 Lua | 📅 2026-07-30 - Create video and audio clips.
...
* [cut zydezu](https://github.com/zydezu/mpvconfig/blob/main/scripts/mpvcut.lua) ⭐ 111 | 🐛 0 | 🌐 Lua | 📅 2026-09-07 - Easily clip, compress and re-encode selected clips.
...
* [clipper](https://github.com/lunagus/mpv-clipper) ⭐ 7 | 🐛 2 | 🌐 Lua | 📅 2025-08-15 - Quickly trim videos using ffmpeg within mpv.
...
* [twitch-chat](https://github.com/CrendKing/mpv-twitch-chat/) ⭐ 103 | 🐛 0 | 🌐 Lua | 📅 2026-07-02 - Show Twitch chat messages as subtitles when watching Twitch VOD with mpv.
...
* [ontop-playback](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/ontop-playback.lua) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08 - Disables the ontop property when pausing, and enables it again when unpausing the video, if it was disabled. Change it only when the player is not in fullscreen to prevent screen flickering.
* [pause-when-minimize](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/pause-when-minimize.lua) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08 - Pauses the player video when minimizing, and unpauses it when brought up again.
* [single-instance](https://github.com/mpv-player/mpv/issues/43#issuecomment-2496083283) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08 - Reuse the existing mpv window when opening new files rather than spawning a new window.
* [local-language](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/local-language.lua) ⭐ 1,430 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - Let the text displayed by osd become the language you are most familiar with, that is, language localization, such as 【volume: 100%】 becomes 【音量:100%】.
...
* [webm](https://github.com/ekisu/mpv-webm) ⭐ 676 | 🐛 69 | 🌐 MoonScript | 📅 2026-03-01 - WebM converter based on MoonScript.
* [encode](https://github.com/occivink/mpv-scripts#encodelua) ⭐ 490 | 🐛 43 | 🌐 Lua | 📅 2025-11-01 - Re-encode or remux part of the current video. Can also preserve some filters, such as "crop".
...
* [copy-paste-URL](https://github.com/zenyd/mpv-scripts) ⭐ 194 | 🐛 1 | 🌐 Lua | 📅 2025-12-07 - Paste URLs directly from clipboard into mpv
...
* [bstat](https://github.com/butterw/bShaders/blob/master/mpv/settings/scripts/bstat.js) ⭐ 111 | 🐛 3 | 🌐 HLSL | 📅 2024-01-19 - Calculates new user-data properties (req mpv v0.36) including avg-bitrate, rounded file-size, exact aspect ratio, etc. Output to terminal or OSD. Updates when a new file is loaded or on demand.
* [minesweeper](https://github.com/wiiaboo/mpv-scripts/blob/master/mines.lua) ⭐ 97 | 🐛 3 | 🌐 Lua | 📅 2020-09-19 - Minesweeper game.
* [copyTime](https://github.com/Arieleg/mpv-copyTime) ⭐ 95 | 🐛 12 | 🌐 Lua | 📅 2022-12-28 - Copies the current time to the clipboard.
...
* [anilist-updater](https://github.com/AzuredBlue/mpv-anilist-updater) ⭐ 41 | 🐛 0 | 🌐 Python | 📅 2026-09-01 - Automatically updates your AniList when reaching 80% completion based on the file name.
...
* [jellyfin mpv shim](https://github.com/jellyfin/jellyfin-mpv-shim) ⭐ 2,366 | 🐛 193 | 🌐 Python | 📅 2026-09-09 - Jellyfin (Emby/Plex alternative) Client, based on Python.
...
* [dyphire](https://github.com/dyphire/mpv-config) ⭐ 1,877 | 🐛 8 | 🌐 GLSL | 📅 2026-08-26
...
* [Natural-Harmonia-Gropius](https://github.com/Natural-Harmonia-Gropius/mpv_config) ⭐ 105 | 🐛 0 | 🌐 GLSL | 📅 2026-09-07
* [tuilakhanh](https://github.com/tuilakhanh/mpv-config) ⭐ 75 | 🐛 0 | 🌐 GLSL | 📅 2026-08-18
* [Awan](https://github.com/Awan/cfg/tree/master/mpv/.config/mpv) ⭐ 37 | 🐛 0 | 🌐 Vim Script | 📅 2026-09-09
...
* [KikoPlay](https://github.com/KikoPlayProject/KikoPlay) ⭐ 2,229 | 🐛 9 | 🌐 C++ | 📅 2026-09-06 - Cross-platform [Danmu](https://en.wikipedia.org/wiki/Danmu) player, based on C++/QT.
...
* [Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,373 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17 - A series of shaders designed to scale and enhance anime. Includes shaders for line sharpening, artefact removal, denoising, upscaling, and more.
...
* [nnedi3 and ravu](https://github.com/bjin/mpv-prescalers/tree/master) ⭐ 450 | 🐛 5 | 📅 2024-01-24 - User shaders for prescaling.
* [ArtCNN](https://github.com/Artoriuz/ArtCNN) ⭐ 363 | 🐛 1 | 🌐 GLSL | 📅 2026-08-18 - Luma doublers trained on Manga109.
* [AniSD ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/AniSD-ArtCNN) ⭐ 363 | 🐛 5 | 📅 2025-06-08 - AniSD ArtCNN shader for standard definition anime content.
* [Ani4K v2 ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/Ani4k-v2-ArtCNN) ⭐ 363 | 🐛 5 | 📅 2025-06-08 - Ani4K shader v2 targets modern anime, from high quality Bluray to crappy WEB releases, for upscaling to either 2K or 4K.
* [hdr-toys](https://github.com/natural-harmonia-gropius/hdr-toys) ⭐ 195 | 🐛 19 | 🌐 GLSL | 📅 2026-09-04 - Componentized Rec.2100 to Rec.709 conversion shader.
* [CuNNy](https://github.com/funnyplanter/CuNNy) ⭐ 168 | 🐛 3 | 🌐 GLSL | 📅 2025-08-29 - Cute and funny CNN-based upscaler optimized for anime.
* [A-Pack](https://github.com/butterw/bShaders/tree/master/A-pack) ⭐ 111 | 🐛 3 | 🌐 HLSL | 📅 2024-01-19 - Shaders pack for quick Adjustment of (web) video: brightness/contrast curves (tooDark, tooBright, bShadows, bDim, etc.) and color (vibrance, skintones, Black\&White). Runs on integrated graphics.
...
* [vidcutter](https://github.com/ozmartian/vidcutter) ⭐ 1,979 | 🐛 297 | 🌐 Python | 📅 2025-04-24 - Cross-platform video cutter/joiner, based on Python/QT.
...
* [qimgv](https://github.com/easymodo/qimgv) ⭐ 3,120 | 🐛 308 | 🌐 C++ | 📅 2026-01-19 - Cross-platform, based on C++/QT.

# Launcher

* <https://github.com/mpv-player/mpv/blob/master/TOOLS/umpv> ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08
* <https://github.com/davatorium/rofi> ⭐ 16,376 | 🐛 115 | 🌐 C | 📅 2026-09-06
* <https://github.com/Flow-Launcher/Flow.Launcher> ⭐ 15,525 | 🐛 303 | 🌐 C# | 📅 2026-09-06
* <https://github.com/ikas-mc/ContextMenuForWindows11> ⭐ 2,879 | 🐛 21 | 🌐 C# | 📅 2026-08-31
* <https://github.com/stax76/OpenWithPlusPlus> ⭐ 434 | 🐛 10 | 🌐 Visual Basic .NET | 📅 2025-11-26
...
* [mpv-mpris](https://github.com/hoyon/mpv-mpris) ⭐ 739 | 🐛 6 | 🌐 C | 📅 2026-07-22 - On Linux allows controlling mpv using standard media keys.
...
* [Compiling for Windows](https://github.com/mpv-player/mpv/blob/master/DOCS/compile-windows.md) ⭐ 36,917 | 🐛 1,146 | 🌐 C | 📅 2026-09-08
* [Building mpv and libmpv using wsl2 and Ubuntu](https://github.com/mpvnet-player/mpv.net/wiki/Building-mpv-and-libmpv-using-wsl2-and-Ubuntu) ⭐ 5,384 | 🐛 156 | 🌐 C# | 📅 2026-02-09
* [Media Auto Build Suite (MABS)](https://github.com/m-ab-s/media-autobuild_suite) ⭐ 1,820 | 🐛 220 | 🌐 Shell | 📅 2026-09-08
...
* [python](https://github.com/jaseg/python-mpv) ⭐ 632 | 🐛 30 | 🌐 Python | 📅 2025-04-25 - Python interface.
* [js](https://github.com/Kagami/mpv.js) ⭐ 446 | 🐛 20 | 🌐 C++ | 📅 2024-01-17 - Embeddable player for Electron/NW\.js (JavaScript).
* [Kit](https://github.com/mpvkit/MPVKit) ⭐ 196 | 🐛 10 | 🌐 Swift | 📅 2026-08-17 - MPVKit is a collection of tools to use mpv in iOS, macOS, tvOS applications. It includes scripts to build mpv native libraries.
* [easy](https://github.com/mpv-easy/mpv-easy) ⭐ 138 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-07 - TS and React GUI toolkit for mpv script.
* [object pascal](https://github.com/URUWorks/UW_MPVPlayer) ⭐ 29 | 🐛 2 | 🌐 Pascal | 📅 2026-07-01 - Embeddable player for Object Pascal.
...
* [Memento](https://github.com/ripose-jp/Memento) ⭐ 1,480 | 🐛 26 | 🌐 C++ | 📅 2026-08-24 - Cross-platform video player for studying Japanese, based on C++/QT.
* [gnome-shell-extension-caffeine](https://github.com/eonpatapon/gnome-shell-extension-caffeine) ⭐ 779 | 🐛 44 | 🌐 JavaScript | 📅 2026-05-20 - Prevent the display from turning off (Gnome doesn't support the idle-inhibit protocol on Wayland) and disable the 'night light' when a mpv window is in focus.
...
* [mpvQC](https://github.com/mpvqc/mpvQC) ⭐ 79 | 🐛 5 | 🌐 Python | 📅 2026-09-08 - Cross-platform application for quality control of videos, based on Python/QT.
