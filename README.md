...
* [mpv.net](https://github.com/mpvnet-player/mpv.net) ⭐ 5,375 | 🐛 156 | 🌐 C# | 📅 2026-02-09 - Based on C#/WinForms/WPF.
* [MPV-EASY Player](https://github.com/422658476/MPV-EASY-Player) ⭐ 1,430 | 🐛 1 | 🌐 Lua | 📅 2026-09-06
* [mpc-qt](https://github.com/mpc-qt/mpc-qt) ⭐ 1,076 | 🐛 109 | 🌐 C++ | 📅 2026-09-06 - Based on C++/QT.
...
* [android](https://github.com/mpv-android/mpv-android) ⭐ 3,526 | 🐛 162 | 🌐 Kotlin | 📅 2026-09-04 - Player for Android, based on Kotlin.
* [Kt](https://github.com/abdallahmehiz/mpvKt) ⚠️ Archived - Player for Android, based on Kotlin.

# Installation/Download

* [shinchiro GitHub](https://github.com/shinchiro/mpv-winbuild-cmake) ⭐ 1,737 | 🐛 60 | 🌐 CMake | 📅 2026-09-03 - Daily Windows builds of mpv and libmpv. This is the most popular choice on Windows.
* [zhongfly](https://github.com/zhongfly/mpv-winbuild) ⭐ 907 | 🐛 0 | 🌐 Shell | 📅 2026-09-06 - Windows builds of mpv and libmpv. This choice is very similar to `shinchiro GitHub`, so it's also a recommendation.
* [mpsm](https://github.com/mpv-easy/mpv-easy/tree/main/mpv-mpsm) ⭐ 138 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-05 - mpsm is a mpv script manager, you can install scripts provided by [mpsm-scripts](https://github.com/mpv-easy/mpsm-scripts) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-08-29, or install any script with added [meta info](https://github.com/mpv-easy/mpsm-scripts?tab=readme-ov-file#meta-info) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-08-29 via url.
* [mitzsch](https://github.com/mitzsch/mpv-winbuild) ⭐ 29 | 🐛 0 | 🌐 Shell | 📅 2026-08-08 - Windows builds of mpv and libmpv.
* [Andarwinux](https://github.com/Andarwinux/mpv-winbuild) ⭐ 23 | 🐛 3 | 🌐 Shell | 📅 2026-09-06 - Daily Windows builds of mpv and libmpv including ARM64 architecture.
...
* [Wiki](https://github.com/mpv-player/mpv/wiki) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06
...
* <https://github.com/mpv-player/mpv/issues> ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06
* <https://github.com/mpv-player/mpv/discussions> ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06
...
in the [wiki](https://github.com/mpv-player/mpv/wiki/User-Scripts) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06,
the advantage of the following list is that everything is categorized
into popular sections, like Subtitles etc.

## Menu

* [select](https://github.com/mpv-player/mpv/blob/master/player/lua/select.lua) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06 - Menu script built into mpv.
* [uosc](https://github.com/tomasklaen/uosc) ⭐ 3,373 | 🐛 35 | 🌐 Lua | 📅 2026-08-30 - Popular OSC with menu.
...
* [mpvc-tui](https://github.com/gmt4/mpvc) ⭐ 158 | 🐛 1 | 🌐 Shell | 📅 2026-09-06 - Command-line and TUI for mpv.
...
* [betterchapters](https://gist.github.com/Hakkin/4f978a5c87c31f7fe3ae) ([update](https://github.com/mpv-player/mpv/issues/4738#issuecomment-321298846) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06) - Loads the next or previous playlist entry if there are no more chapters in the seek direction.
* [autoload](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autoload.lua) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06 - Automatically load playlist entries before and after the currently playing file, by scanning the directory. **Obsolete:** mpv now has a native `--autocreate-playlist` option.
* [print-playlist](https://git.sr.ht/~jagrg/dotfiles/tree/master/item/common/.config/mpv/scripts/print-playlist.lua) - Cleans [the playlist formatting](https://github.com/mpv-player/mpv/issues/5868#issue-327675880) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06 on the terminal.
...
* [pause-indicator-lite](https://github.com/Samillion/ModernZ/tree/main/extras/pause-indicator-lite) ⭐ 1,212 | 🐛 25 | 🌐 Lua | 📅 2026-06-04 - A simple script that displays an indicator on pause, with options to adjust icon, color, height, width, opacity and whether to toggle pause with a keybind or not.
...
* [ModernZ](https://github.com/Samillion/ModernZ) ⭐ 1,212 | 🐛 25 | 🌐 Lua | 📅 2026-06-04 - A fork of ModernX designed to enhance functionality by adding more features, all while preserving the core standards of mpv's OSC.
...
* [acompressor](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/acompressor.lua) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06 - Dynamic range compressor using acompressor ffmpeg filter with controls to dynamically adjust parameters.
...
* [torrserver](https://github.com/kritma/mpv-torrserver) ⭐ 8 | 🐛 0 | 🌐 Lua | 📅 2024-02-05 - Allows streaming torrents using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,015 | 🐛 26 | 🌐 Go | 📅 2026-09-04. Support magnet links and .torrent files
...
* [torrserver-hook](https://github.com/eNV25/mpv-torrserver-hook) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-06-07 - Allows for playback of media from the BitTorrent network using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,015 | 🐛 26 | 🌐 Go | 📅 2026-09-04.
...
* [autocrop](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autocrop.lua) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06 - Automatically crop the video by using lavfi's cropdetect filter to detect black bars.
* [autodeint](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autodeint.lua) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06 - Automatically deinterlace the video by using lavfi's idet filter to detect interlaced content.
* [cycle-deinterlace-pullup](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/cycle-deinterlace-pullup.lua) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06 - Cycle between deinterlacing, pullup (IVTC), and both filters off.
...
* [mpv360](https://github.com/kasper93/mpv360) ⭐ 77 | 🐛 3 | 🌐 Lua | 📅 2026-01-30 - Interactive 360° Video Viewer. With full camera control through mouse and keyboard inputs.
...
* [auto-mode](https://github.com/stax76/mpv-scripts) ⭐ 232 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Use mpv as video player, music player and image viewer, switch automatically between, video, audio and image mode.
* [screenshotfolder](https://github.com/zydezu/mpvconfig/blob/main/scripts/screenshotfolder.lua) ⭐ 110 | 🐛 0 | 🌐 Lua | 📅 2026-08-25 - Place screenshots into folders for each video, along with timestamping them.
...
* [gallery-dl\_hook](https://github.com/jgreco/mpv-scripts/blob/master/gallery-dl_hook.lua) ⭐ 46 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Load online image galleries (imgur, etc) as playlists using [gallery-dl](https://github.com/mikf/gallery-dl/) ⭐ 19,434 | 🐛 1,152 | 🌐 Python | 📅 2026-09-04.
...
* [cut zydezu](https://github.com/zydezu/mpvconfig/blob/main/scripts/mpvcut.lua) ⭐ 110 | 🐛 0 | 🌐 Lua | 📅 2026-08-25 - Easily clip, compress and re-encode selected clips.
...
* [ontop-playback](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/ontop-playback.lua) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06 - Disables the ontop property when pausing, and enables it again when unpausing the video, if it was disabled. Change it only when the player is not in fullscreen to prevent screen flickering.
* [pause-when-minimize](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/pause-when-minimize.lua) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06 - Pauses the player video when minimizing, and unpauses it when brought up again.
* [single-instance](https://github.com/mpv-player/mpv/issues/43#issuecomment-2496083283) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06 - Reuse the existing mpv window when opening new files rather than spawning a new window.
...
* [jellyfin mpv shim](https://github.com/jellyfin/jellyfin-mpv-shim) ⭐ 2,354 | 🐛 192 | 🌐 Python | 📅 2026-09-06 - Jellyfin (Emby/Plex alternative) Client, based on Python.
...
* [dyphire](https://github.com/dyphire/mpv-config) ⭐ 1,869 | 🐛 7 | 🌐 GLSL | 📅 2026-08-26
* [Zabooby](https://github.com/Zabooby/mpv-config) ⭐ 566 | 🐛 0 | 🌐 GLSL | 📅 2026-08-13
* [noelsimbolon](https://github.com/noelsimbolon/mpv-config) ⭐ 308 | 🐛 2 | 🌐 GLSL | 📅 2026-04-30
* [Natural-Harmonia-Gropius](https://github.com/Natural-Harmonia-Gropius/mpv_config) ⭐ 105 | 🐛 0 | 🌐 GLSL | 📅 2026-09-04
* [tuilakhanh](https://github.com/tuilakhanh/mpv-config) ⭐ 75 | 🐛 0 | 🌐 GLSL | 📅 2026-08-18
* [Awan](https://github.com/Awan/cfg/tree/master/mpv/.config/mpv) ⭐ 37 | 🐛 0 | 🌐 Vim Script | 📅 2026-09-05
...
* [Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,361 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17 - A series of shaders designed to scale and enhance anime. Includes shaders for line sharpening, artefact removal, denoising, upscaling, and more.
* [FSRCNN](https://github.com/igv/FSRCNN-TensorFlow/releases) ⭐ 503 | 🐛 0 | 🌐 Python | 📅 2021-04-12 - Prescaler based on layered convolutional networks.
* [nnedi3 and ravu](https://github.com/bjin/mpv-prescalers/tree/master) ⭐ 450 | 🐛 5 | 📅 2024-01-24 - User shaders for prescaling.
* [ArtCNN](https://github.com/Artoriuz/ArtCNN) ⭐ 364 | 🐛 1 | 🌐 GLSL | 📅 2026-08-18 - Luma doublers trained on Manga109.
...
* [hdr-toys](https://github.com/natural-harmonia-gropius/hdr-toys) ⭐ 193 | 🐛 19 | 🌐 GLSL | 📅 2026-09-04 - Componentized Rec.2100 to Rec.709 conversion shader.
...
* [qimgv](https://github.com/easymodo/qimgv) ⭐ 3,118 | 🐛 308 | 🌐 C++ | 📅 2026-01-19 - Cross-platform, based on C++/QT.

# Launcher

* <https://github.com/mpv-player/mpv/blob/master/TOOLS/umpv> ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06
* <https://github.com/davatorium/rofi> ⭐ 16,375 | 🐛 115 | 🌐 C | 📅 2026-09-06
* <https://github.com/Flow-Launcher/Flow.Launcher> ⭐ 15,511 | 🐛 305 | 🌐 C# | 📅 2026-09-06
* <https://github.com/ikas-mc/ContextMenuForWindows11> ⭐ 2,875 | 🐛 21 | 🌐 C# | 📅 2026-08-31
...
* [Compiling for Windows](https://github.com/mpv-player/mpv/blob/master/DOCS/compile-windows.md) ⭐ 36,870 | 🐛 1,149 | 🌐 C | 📅 2026-09-06
* [Building mpv and libmpv using wsl2 and Ubuntu](https://github.com/mpvnet-player/mpv.net/wiki/Building-mpv-and-libmpv-using-wsl2-and-Ubuntu) ⭐ 5,375 | 🐛 156 | 🌐 C# | 📅 2026-02-09
...
* [python](https://github.com/jaseg/python-mpv) ⭐ 631 | 🐛 30 | 🌐 Python | 📅 2025-04-25 - Python interface.
...
* [easy](https://github.com/mpv-easy/mpv-easy) ⭐ 138 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-05 - TS and React GUI toolkit for mpv script.
...
* [install](https://github.com/rossy/mpv-install) ⭐ 468 | 🐛 7 | 🌐 Batchfile | 📅 2021-09-03 - Sets up file associations for mpv on Windows.
* [blitzloop](https://github.com/marcan/blitzloop) ⭐ 230 | 🐛 14 | 🌐 Python | 📅 2021-05-02 - Linux karaoke software, based on Python/OpenGL.
* [mpvQC](https://github.com/mpvqc/mpvQC) ⭐ 79 | 🐛 5 | 🌐 Python | 📅 2026-09-06 - Cross-platform application for quality control of videos, based on Python/QT.
