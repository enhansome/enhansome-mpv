...
* [SMPlayer](https://github.com/smplayer-dev/smplayer) ⭐ 1,042 | 🐛 84 | 🌐 C++ | 📅 2026-08-11 - Based on C++/QT.
...
* [OvoPlayer](https://github.com/varianus/ovoplayer) ⭐ 66 | 🐛 2 | 🌐 Pascal | 📅 2026-08-19 - Unmaintained, based on Pascal.
* [mpv](https://mpv.io) - Based on C/Lua.

## Windows

* [mpv.net](https://github.com/mpvnet-player/mpv.net) ⭐ 5,338 | 🐛 156 | 🌐 C# | 📅 2026-02-09 - Based on C#/WinForms/WPF.
* [MPV-EASY Player](https://github.com/422658476/MPV-EASY-Player) ⭐ 1,422 | 🐛 1 | 🌐 Lua | 📅 2026-07-12
* [mpc-qt](https://github.com/mpc-qt/mpc-qt) ⭐ 1,061 | 🐛 122 | 🌐 C++ | 📅 2026-08-21 - Based on C++/QT.
...
* [xt7-player-mpv](https://github.com/kokoko3k/xt7-player-mpv) ⭐ 106 | 🐛 2 | 🌐 Lua | 📅 2026-06-12 - Based on Gambas/QT.
* [Deepin Movie](https://github.com/linuxdeepin/deepin-movie-reborn) ⭐ 88 | 🐛 5 | 🌐 C++ | 📅 2026-08-21 - Unmaintained, based on C++/QT.
...
* [android](https://github.com/mpv-android/mpv-android) ⭐ 3,484 | 🐛 165 | 🌐 Kotlin | 📅 2026-08-19 - Player for Android, based on Kotlin.
* [Kt](https://github.com/abdallahmehiz/mpvKt) ⚠️ Archived - Player for Android, based on Kotlin.

# Installation/Download

* [shinchiro GitHub](https://github.com/shinchiro/mpv-winbuild-cmake) ⭐ 1,713 | 🐛 57 | 🌐 CMake | 📅 2026-08-14 - Daily Windows builds of mpv and libmpv. This is the most popular choice on Windows.
* [zhongfly](https://github.com/zhongfly/mpv-winbuild) ⭐ 877 | 🐛 0 | 🌐 Shell | 📅 2026-08-21 - Windows builds of mpv and libmpv. This choice is very similar to `shinchiro GitHub`, so it's also a recommendation.
* [mpsm](https://github.com/mpv-easy/mpv-easy/tree/main/mpv-mpsm) ⭐ 136 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-20 - mpsm is a mpv script manager, you can install scripts provided by [mpsm-scripts](https://github.com/mpv-easy/mpsm-scripts) ⭐ 20 | 🐛 0 | 🌐 Lua | 📅 2026-07-22, or install any script with added [meta info](https://github.com/mpv-easy/mpsm-scripts?tab=readme-ov-file#meta-info) ⭐ 20 | 🐛 0 | 🌐 Lua | 📅 2026-07-22 via url.
* [mitzsch](https://github.com/mitzsch/mpv-winbuild) ⭐ 29 | 🐛 0 | 🌐 Shell | 📅 2026-08-08 - Windows builds of mpv and libmpv.
* [Andarwinux](https://github.com/Andarwinux/mpv-winbuild) ⭐ 23 | 🐛 3 | 🌐 Shell | 📅 2026-08-20 - Daily Windows builds of mpv and libmpv including ARM64 architecture.
...
* [Wiki](https://github.com/mpv-player/mpv/wiki) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21
...
* <https://github.com/mpv-player/mpv/issues> ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21
* <https://github.com/mpv-player/mpv/discussions> ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21
...
in the [wiki](https://github.com/mpv-player/mpv/wiki/User-Scripts) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21,
the advantage of the following list is that everything is categorized
into popular sections, like Subtitles etc.

## Menu

* [select](https://github.com/mpv-player/mpv/blob/master/player/lua/select.lua) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21 - Menu script built into mpv.
* [uosc](https://github.com/tomasklaen/uosc) ⭐ 3,325 | 🐛 32 | 🌐 Lua | 📅 2026-08-03 - Popular OSC with menu.
...
* [mpvc-tui](https://github.com/gmt4/mpvc) ⭐ 156 | 🐛 1 | 🌐 Shell | 📅 2026-08-20 - Command-line and TUI for mpv.
...
* [betterchapters](https://gist.github.com/Hakkin/4f978a5c87c31f7fe3ae) ([update](https://github.com/mpv-player/mpv/issues/4738#issuecomment-321298846) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21) - Loads the next or previous playlist entry if there are no more chapters in the seek direction.
* [autoload](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autoload.lua) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21 - Automatically load playlist entries before and after the currently playing file, by scanning the directory. **Obsolete:** mpv now has a native `--autocreate-playlist` option.
* [print-playlist](https://git.sr.ht/~jagrg/dotfiles/tree/master/item/common/.config/mpv/scripts/print-playlist.lua) - Cleans [the playlist formatting](https://github.com/mpv-player/mpv/issues/5868#issue-327675880) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21 on the terminal.
* [playlistnoplayback](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/playlistnoplayback.lua) ⭐ 1,422 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - If you enable the save play history and progress function, this lua script can solve the problem of automatically jumping to the previous playback progress when playing the next file when playing the playlist, that is, let the playlist always play the next file from the beginning every time. the limitations of this script, please see the comments section in the content.
* [pause-indicator-lite](https://github.com/Samillion/ModernZ/tree/main/extras/pause-indicator-lite) ⭐ 1,173 | 🐛 24 | 🌐 Lua | 📅 2026-06-04 - A simple script that displays an indicator on pause, with options to adjust icon, color, height, width, opacity and whether to toggle pause with a keybind or not.
...
* [memo](https://github.com/po5/memo) ⭐ 120 | 🐛 11 | 🌐 Lua | 📅 2024-11-01 - A recent files/history menu for mpv with optional uosc integration.
...
* [interactive-video](https://github.com/mosquito-byte/mpv-interactive-video) ⭐ 42 | 🐛 3 | 🌐 Lua | 📅 2019-09-20 - Script for watching interactive videos (such as Netflix's *Black Mirror: Bandersnatch*).
...
* [guess-media-title](https://github.com/zenwarr/mpv-config/blob/master/scripts/guess-media-title.lua) ⭐ 35 | 🐛 3 | 🌐 Lua | 📅 2025-11-16 - Uses [guessit](https://github.com/guessit-io/guessit) ⭐ 930 | 🐛 16 | 🌐 Python | 📅 2026-08-09 to detect a media title by filename and set `force-media-title` variable. Useful for getting cleaner screenshot file names.
...
* [open-file-dialog](https://github.com/rossy/mpv-open-file-dialog) ⭐ 44 | 🐛 3 | 🌐 Lua | 📅 2020-04-15 - Launch a Windows open file dialog.
...
* [osd-bar](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/osd-bar.lua) ⭐ 1,422 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - Always show osd progress bar, with the more beautiful color matching in the [configuration file](https://github.com/422658476/MPV-EASY-Player/blob/master/mpv-easy-data/rjno1.conf) ⭐ 1,422 | 🐛 1 | 🌐 Lua | 📅 2026-07-12, you can make the osd progress bar display the current progress at the bottom of the window beautifully,this is a [preview](https://raw.githubusercontent.com/422658476/MPV-EASY-Player/master/img/mpv-easy-player-osd-bar-lua.jpg).

* [osc-style](https://github.com/422658476/MPV-EASY-Player/tree/master/mpv-easy-data/osc-style) ⭐ 1,422 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - Change the mpv OSC to a more beautiful and practical look, which is the osc theme feature, a variety of styles to choose from,this is a [tutorial and a preview](https://github.com/422658476/MPV-EASY-Player#%E7%9C%8B%E5%88%B0%E4%B8%8A%E9%9D%A2%E5%9B%BE%E4%B8%8A%E8%BF%99%E4%BA%9Bosc%E6%A0%B7%E5%BC%8F%E4%BA%86%E5%90%97%E5%AE%83%E4%BB%AC%E4%B8%8D%E4%BB%85%E5%8F%AF%E4%BB%A5%E5%AD%98%E5%9C%A8%E4%BA%8Empv-easy-player%E4%B8%AD%E4%BD%A0%E4%BD%BF%E7%94%A8%E7%9A%84mpv%E7%9A%84osc%E4%B9%9F%E5%8F%AF%E4%BB%A5%E5%8F%98%E6%88%90%E8%BF%99%E6%A0%B7) ⭐ 1,422 | 🐛 1 | 🌐 Lua | 📅 2026-07-12.

* [ModernZ](https://github.com/Samillion/ModernZ) ⭐ 1,173 | 🐛 24 | 🌐 Lua | 📅 2026-06-04 - A fork of ModernX designed to enhance functionality by adding more features, all while preserving the core standards of mpv's OSC.

* [ModernX cyl0](https://github.com/cyl0/ModernX) ⭐ 751 | 🐛 20 | 🌐 Lua | 📅 2026-02-04 - Modern OSC replacement.
...
* [ModernX zydezu](https://github.com/zydezu/ModernX) ⭐ 287 | 🐛 3 | 🌐 Lua | 📅 2026-08-11 - A fork of ModernX with many additional features and customization.
...
* [uosc\_history\_menu](https://github.com/Koopex/uosc_history_menu) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-08-20 - A history and bookmark management menu integrated with uosc.
...
* [cycle-commands](https://github.com/CogentRedTester/mpv-scripts/blob/master/cycle-commands.lua) ⭐ 299 | 🐛 4 | 🌐 Lua | 📅 2026-01-11 - Allows input.conf commands to be cycled through with keybinds.
...
* [mpvacious](https://github.com/Ajatt-Tools/mpvacious) ⭐ 877 | 🐛 12 | 🌐 Lua | 📅 2026-08-16 - Add keybindings to create Anki flashcards for (language) learning.
...
* [acompressor](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/acompressor.lua) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21 - Dynamic range compressor using acompressor ffmpeg filter with controls to dynamically adjust parameters.
...
* [youtube-search](https://github.com/CogentRedTester/mpv-scripts/blob/master/youtube-search.lua) ⭐ 299 | 🐛 4 | 🌐 Lua | 📅 2026-01-11 - A script that allows users to search youtube and open results from within mpv. Requires a couple of extra API scripts, along with curl and a personal youtube API key.
...
* [selectformat](https://github.com/ghesy/mpv-selectformat) ⭐ 37 | 🐛 0 | 🌐 Lua | 📅 2025-12-11 - Select the format (quality) of internet videos.
...
* [ytdl-preload](https://github.com/bitingsock/ytdl-preload) ⭐ 19 | 🐛 6 | 🌐 Lua | 📅 2026-08-20 - Precache the next entry in your playlist if it is a network source by downloading it to a temp file ahead of time. Updated to download all streams in parallel so you can watch it while it downloads.
...
* [torrserver](https://github.com/kritma/mpv-torrserver) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2024-02-05 - Allows streaming torrents using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 2,957 | 🐛 29 | 🌐 Go | 📅 2026-08-17. Support magnet links and .torrent files
* [torrserver-hook](https://github.com/eNV25/mpv-torrserver-hook) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-06-07 - Allows for playback of media from the BitTorrent network using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 2,957 | 🐛 29 | 🌐 Go | 📅 2026-08-17.
...
* [autocrop](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autocrop.lua) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21 - Automatically crop the video by using lavfi's cropdetect filter to detect black bars.
* [autodeint](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autodeint.lua) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21 - Automatically deinterlace the video by using lavfi's idet filter to detect interlaced content.
* [cycle-deinterlace-pullup](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/cycle-deinterlace-pullup.lua) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21 - Cycle between deinterlacing, pullup (IVTC), and both filters off.
* [use-cpu](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/use-cpu.lua) ⭐ 1,422 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - If the width of the video is greater than 3000 or the height of the video is greater than 2000, it will automatically switch back to using cpu decoding.
...
* [dynamic-crop](https://github.com/Ashyni/mpv-scripts#dynamic-croplua) ⭐ 131 | 🐛 5 | 🌐 Lua | 📅 2024-09-14 - Dynamically crop the video by using lavfi's cropdetect filter to detect hard-coded black bars for Ultra Wide Screen (21:9) or any screen different from 16:9 (phone/old TV).
...
* [thumbfast](https://github.com/po5/thumbfast) ⭐ 1,666 | 🐛 55 | 🌐 Lua | 📅 2026-08-12 - High-performance on-the-fly thumbnailer for mpv.
* [image-viewer](https://github.com/occivink/mpv-image-viewer) ⭐ 360 | 🐛 18 | 🌐 Lua | 📅 2024-11-23 - Configuration, scripts and tips for using mpv as an image viewer.
...
* [gallery-dl\_hook](https://github.com/jgreco/mpv-scripts/blob/master/gallery-dl_hook.lua) ⭐ 47 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Load online image galleries (imgur, etc) as playlists using [gallery-dl](https://github.com/mikf/gallery-dl/) ⭐ 19,278 | 🐛 1,156 | 🌐 Python | 📅 2026-08-01.
...
* [ontop-playback](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/ontop-playback.lua) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21 - Disables the ontop property when pausing, and enables it again when unpausing the video, if it was disabled. Change it only when the player is not in fullscreen to prevent screen flickering.
* [pause-when-minimize](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/pause-when-minimize.lua) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21 - Pauses the player video when minimizing, and unpauses it when brought up again.
* [single-instance](https://github.com/mpv-player/mpv/issues/43#issuecomment-2496083283) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21 - Reuse the existing mpv window when opening new files rather than spawning a new window.
* [local-language](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/local-language.lua) ⭐ 1,422 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - Let the text displayed by osd become the language you are most familiar with, that is, language localization, such as 【volume: 100%】 becomes 【音量:100%】.
...
* [vr-reversal](https://github.com/dfaker/VR-reversal) ⭐ 397 | 🐛 11 | 🌐 Lua | 📅 2024-05-21 - View 3D side-by-side video as a 2D video, allows you to look around and zoom within the video, logs the head motions to a file for later rendering out to a 2D video with ffmpeg.
...
* [jellyfin mpv shim](https://github.com/jellyfin/jellyfin-mpv-shim) ⭐ 2,324 | 🐛 178 | 🌐 Python | 📅 2026-08-21 - Jellyfin (Emby/Plex alternative) Client, based on Python.
...
* [webtorrent-mpv-hook](https://github.com/mrxdst/webtorrent-mpv-hook) ⭐ 196 | 🐛 10 | 🌐 TypeScript | 📅 2026-05-06 - Adds a hook that allows mpv to stream torrents using webtorrent.
...
* [dyphire](https://github.com/dyphire/mpv-config) ⭐ 1,847 | 🐛 8 | 🌐 GLSL | 📅 2026-08-17
* [Zabooby](https://github.com/Zabooby/mpv-config) ⭐ 559 | 🐛 0 | 🌐 GLSL | 📅 2026-08-13
...
* [KikoPlay](https://github.com/KikoPlayProject/KikoPlay) ⭐ 2,216 | 🐛 7 | 🌐 C++ | 📅 2026-07-18 - Cross-platform [Danmu](https://en.wikipedia.org/wiki/Danmu) player, based on C++/QT.
...
* [Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,273 | 🐛 123 | 🌐 Jupyter Notebook | 📅 2024-08-17 - A series of shaders designed to scale and enhance anime. Includes shaders for line sharpening, artefact removal, denoising, upscaling, and more.
...
* [AniSD ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/AniSD-ArtCNN) ⭐ 360 | 🐛 5 | 📅 2025-06-08 - AniSD ArtCNN shader for standard definition anime content.
* [Ani4K v2 ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/Ani4k-v2-ArtCNN) ⭐ 360 | 🐛 5 | 📅 2025-06-08 - Ani4K shader v2 targets modern anime, from high quality Bluray to crappy WEB releases, for upscaling to either 2K or 4K.
* [ArtCNN](https://github.com/Artoriuz/ArtCNN) ⭐ 354 | 🐛 1 | 🌐 GLSL | 📅 2026-08-18 - Luma doublers trained on Manga109.
* [hdr-toys](https://github.com/natural-harmonia-gropius/hdr-toys) ⭐ 188 | 🐛 18 | 🌐 GLSL | 📅 2026-08-20 - Componentized Rec.2100 to Rec.709 conversion shader.
...
* [qimgv](https://github.com/easymodo/qimgv) ⭐ 3,110 | 🐛 307 | 🌐 C++ | 📅 2026-01-19 - Cross-platform, based on C++/QT.

# Launcher

* <https://github.com/mpv-player/mpv/blob/master/TOOLS/umpv> ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21
* <https://github.com/davatorium/rofi> ⭐ 16,342 | 🐛 116 | 🌐 C | 📅 2026-08-09
* <https://github.com/Flow-Launcher/Flow.Launcher> ⭐ 15,399 | 🐛 302 | 🌐 C# | 📅 2026-08-21
* <https://github.com/ikas-mc/ContextMenuForWindows11> ⭐ 2,865 | 🐛 20 | 🌐 C# | 📅 2026-07-25
...
* [Compiling for Windows](https://github.com/mpv-player/mpv/blob/master/DOCS/compile-windows.md) ⭐ 36,614 | 🐛 1,137 | 🌐 C | 📅 2026-08-21
* [Building mpv and libmpv using wsl2 and Ubuntu](https://github.com/mpvnet-player/mpv.net/wiki/Building-mpv-and-libmpv-using-wsl2-and-Ubuntu) ⭐ 5,338 | 🐛 156 | 🌐 C# | 📅 2026-02-09
* [Media Auto Build Suite (MABS)](https://github.com/m-ab-s/media-autobuild_suite) ⭐ 1,811 | 🐛 219 | 🌐 Shell | 📅 2026-08-18
...
* [easy](https://github.com/mpv-easy/mpv-easy) ⭐ 136 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-20 - TS and React GUI toolkit for mpv script.
...
* [Memento](https://github.com/ripose-jp/Memento) ⭐ 1,468 | 🐛 27 | 🌐 C++ | 📅 2026-08-05 - Cross-platform video player for studying Japanese, based on C++/QT.
* [gnome-shell-extension-caffeine](https://github.com/eonpatapon/gnome-shell-extension-caffeine) ⭐ 772 | 🐛 41 | 🌐 JavaScript | 📅 2026-05-20 - Prevent the display from turning off (Gnome doesn't support the idle-inhibit protocol on Wayland) and disable the 'night light' when a mpv window is in focus.
* [install](https://github.com/rossy/mpv-install) ⭐ 470 | 🐛 7 | 🌐 Batchfile | 📅 2021-09-03 - Sets up file associations for mpv on Windows.
* [blitzloop](https://github.com/marcan/blitzloop) ⭐ 229 | 🐛 14 | 🌐 Python | 📅 2021-05-02 - Linux karaoke software, based on Python/OpenGL.
* [mpvQC](https://github.com/mpvqc/mpvQC) ⭐ 79 | 🐛 5 | 🌐 Python | 📅 2026-08-20 - Cross-platform application for quality control of videos, based on Python/QT.
