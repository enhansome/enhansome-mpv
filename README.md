...
* [SMPlayer](https://github.com/smplayer-dev/smplayer) ⭐ 1,038 | 🐛 78 | 🌐 C++ | 📅 2026-08-11 - Based on C++/QT.
...
* [OvoPlayer](https://github.com/varianus/ovoplayer) ⭐ 66 | 🐛 2 | 🌐 Pascal | 📅 2026-08-17 - Unmaintained, based on Pascal.
* [mpv](https://mpv.io) - Based on C/Lua.

## Windows

* [mpv.net](https://github.com/mpvnet-player/mpv.net) ⭐ 5,329 | 🐛 155 | 🌐 C# | 📅 2026-02-09 - Based on C#/WinForms/WPF.
* [MPV-EASY Player](https://github.com/422658476/MPV-EASY-Player) ⭐ 1,421 | 🐛 1 | 🌐 Lua | 📅 2026-07-12
* [mpc-qt](https://github.com/mpc-qt/mpc-qt) ⭐ 1,055 | 🐛 120 | 🌐 C++ | 📅 2026-08-16 - Based on C++/QT.
* [mpv-hero](https://github.com/stax76/mpv-hero) ⭐ 136 | 🐛 8 | 🌐 Lua | 📅 2025-11-26 - mpv extended with GUI scripts and GUI tools.
* [MMP: Minimalist Media Player](https://github.com/BazzaCuda/MinimalistMediaPlayerX) ⭐ 56 | 🐛 3 | 🌐 Pascal | 📅 2026-07-31 - Player/Manager/Editor for audio and video, and Viewer/Manager for images/thumbnails; maintained, based on 64-bit Delphi Pascal. Official [wiki](https://minimalistmediaplayer.com).
...
* [Kawaii Player](https://github.com/kanishka-linux/kawaii-player) ⭐ 710 | 🐛 17 | 🌐 Python | 📅 2026-06-13 - Player/Library/Server, based on Python/QT.
* [xt7-player-mpv](https://github.com/kokoko3k/xt7-player-mpv) ⭐ 107 | 🐛 2 | 🌐 Lua | 📅 2026-06-12 - Based on Gambas/QT.
* [Deepin Movie](https://github.com/linuxdeepin/deepin-movie-reborn) ⭐ 88 | 🐛 6 | 🌐 C++ | 📅 2026-07-31 - Unmaintained, based on C++/QT.
...
* [android](https://github.com/mpv-android/mpv-android) ⭐ 3,476 | 🐛 164 | 🌐 Kotlin | 📅 2026-08-16 - Player for Android, based on Kotlin.
* [Kt](https://github.com/abdallahmehiz/mpvKt) ⚠️ Archived - Player for Android, based on Kotlin.

# Installation/Download

* [shinchiro GitHub](https://github.com/shinchiro/mpv-winbuild-cmake) ⭐ 1,710 | 🐛 57 | 🌐 CMake | 📅 2026-08-14 - Daily Windows builds of mpv and libmpv. This is the most popular choice on Windows.
* [zhongfly](https://github.com/zhongfly/mpv-winbuild) ⭐ 872 | 🐛 0 | 🌐 Shell | 📅 2026-08-17 - Windows builds of mpv and libmpv. This choice is very similar to `shinchiro GitHub`, so it's also a recommendation.
* [mpsm](https://github.com/mpv-easy/mpv-easy/tree/main/mpv-mpsm) ⭐ 136 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-17 - mpsm is a mpv script manager, you can install scripts provided by [mpsm-scripts](https://github.com/mpv-easy/mpsm-scripts) ⭐ 20 | 🐛 0 | 🌐 Lua | 📅 2026-07-22, or install any script with added [meta info](https://github.com/mpv-easy/mpsm-scripts?tab=readme-ov-file#meta-info) ⭐ 20 | 🐛 0 | 🌐 Lua | 📅 2026-07-22 via url.
* [mitzsch](https://github.com/mitzsch/mpv-winbuild) ⭐ 29 | 🐛 0 | 🌐 Shell | 📅 2026-08-08 - Windows builds of mpv and libmpv.
* [Andarwinux](https://github.com/Andarwinux/mpv-winbuild) ⭐ 23 | 🐛 3 | 🌐 Shell | 📅 2026-08-17 - Daily Windows builds of mpv and libmpv including ARM64 architecture.
...
* [Wiki](https://github.com/mpv-player/mpv/wiki) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16
...
* <https://github.com/mpv-player/mpv/issues> ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16
* <https://github.com/mpv-player/mpv/discussions> ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16
...
in the [wiki](https://github.com/mpv-player/mpv/wiki/User-Scripts) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16,
the advantage of the following list is that everything is categorized
into popular sections, like Subtitles etc.

## Menu

* [select](https://github.com/mpv-player/mpv/blob/master/player/lua/select.lua) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16 - Menu script built into mpv.
* [uosc](https://github.com/tomasklaen/uosc) ⭐ 3,321 | 🐛 32 | 🌐 Lua | 📅 2026-08-03 - Popular OSC with menu.
...
* [betterchapters](https://gist.github.com/Hakkin/4f978a5c87c31f7fe3ae) ([update](https://github.com/mpv-player/mpv/issues/4738#issuecomment-321298846) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16) - Loads the next or previous playlist entry if there are no more chapters in the seek direction.
* [autoload](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autoload.lua) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16 - Automatically load playlist entries before and after the currently playing file, by scanning the directory. **Obsolete:** mpv now has a native `--autocreate-playlist` option.
* [print-playlist](https://git.sr.ht/~jagrg/dotfiles/tree/master/item/common/.config/mpv/scripts/print-playlist.lua) - Cleans [the playlist formatting](https://github.com/mpv-player/mpv/issues/5868#issue-327675880) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16 on the terminal.
* [playlistnoplayback](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/playlistnoplayback.lua) ⭐ 1,421 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - If you enable the save play history and progress function, this lua script can solve the problem of automatically jumping to the previous playback progress when playing the next file when playing the playlist, that is, let the playlist always play the next file from the beginning every time. the limitations of this script, please see the comments section in the content.
* [pause-indicator-lite](https://github.com/Samillion/ModernZ/tree/main/extras/pause-indicator-lite) ⭐ 1,162 | 🐛 23 | 🌐 Lua | 📅 2026-06-04 - A simple script that displays an indicator on pause, with options to adjust icon, color, height, width, opacity and whether to toggle pause with a keybind or not.
...
* [SimpleUndo-3.2](https://github.com/Eisa01/mpv-scripts#simpleundo) ⭐ 837 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Simple undo feature. If you accidentally seek/jump to a different time in the video, press undo \[ctrl]+\[z] to return to your previous time and vice-versa. More details in the link above.
* [SmartSkip](https://github.com/Eisa01/mpv-scripts/#smartskip) ⭐ 837 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Automatically or manually skip opening, intro, outro, and preview, like never before. Jump to next file, previous file, and save your chapter changes! Much more explained in the link above.
* [playlist-manager](https://github.com/jonniek/mpv-playlistmanager) ⭐ 695 | 🐛 12 | 🌐 Lua | 📅 2026-03-16 - Create and manage playlists.
* [seek-to](https://github.com/occivink/mpv-scripts#seek-tolua) ⭐ 491 | 🐛 42 | 🌐 Lua | 📅 2025-11-01 - Seek to an absolute timestamp specified via keyboard input.
* [playlist-view](https://github.com/occivink/mpv-gallery-view) ⭐ 256 | 🐛 26 | 🌐 Lua | 📅 2024-09-27 - Display and navigate the playlist in a grid view of thumbnails.
...
* [chapter-make-read](https://github.com/dyphire/mpv-scripts/blob/main/chapter-make-read.lua) ⭐ 122 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Automatically read an load the namesake external chapter file with extension of CHP. Temporarily mark the current playback position as a chapter so you can seek to it later. Also allows writing current chapters as CHP or XML. Based on `createchapter`.
* [track-list](https://github.com/dyphire/mpv-scripts/blob/main/track-list.lua) ⭐ 122 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Interractive track-list menu.
* [skiptosilence dyphire](https://github.com/dyphire/mpv-scripts/blob/main/skiptosilence.lua) ⭐ 122 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Skips to the next silence in the file.
* [memo](https://github.com/po5/memo) ⭐ 119 | 🐛 11 | 🌐 Lua | 📅 2024-11-01 - A recent files/history menu for mpv with optional uosc integration.
...
* [chapters-menu](https://github.com/Seme4eg/mpv-scripts/tree/master#chapters-menu) ⭐ 73 | 🐛 1 | 🌐 Lua | 📅 2026-02-24 - List all chapters of current video, search and choose any.
* [skipsilence](https://github.com/ferreum/mpv-skipsilence) ⭐ 73 | 🐛 2 | 🌐 Lua | 📅 2025-09-06 - Increase playback speed during quiet parts of the file.
...
* [file-browser](https://github.com/CogentRedTester/mpv-file-browser) ⭐ 328 | 🐛 3 | 🌐 Lua | 📅 2026-03-27 - On screen file browser.
...
* [open-file-dialog](https://github.com/rossy/mpv-open-file-dialog) ⭐ 45 | 🐛 3 | 🌐 Lua | 📅 2020-04-15 - Launch a Windows open file dialog.
...
* [osd-bar](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/osd-bar.lua) ⭐ 1,421 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - Always show osd progress bar, with the more beautiful color matching in the [configuration file](https://github.com/422658476/MPV-EASY-Player/blob/master/mpv-easy-data/rjno1.conf) ⭐ 1,421 | 🐛 1 | 🌐 Lua | 📅 2026-07-12, you can make the osd progress bar display the current progress at the bottom of the window beautifully,this is a [preview](https://raw.githubusercontent.com/422658476/MPV-EASY-Player/master/img/mpv-easy-player-osd-bar-lua.jpg).

* [osc-style](https://github.com/422658476/MPV-EASY-Player/tree/master/mpv-easy-data/osc-style) ⭐ 1,421 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - Change the mpv OSC to a more beautiful and practical look, which is the osc theme feature, a variety of styles to choose from,this is a [tutorial and a preview](https://github.com/422658476/MPV-EASY-Player#%E7%9C%8B%E5%88%B0%E4%B8%8A%E9%9D%A2%E5%9B%BE%E4%B8%8A%E8%BF%99%E4%BA%9Bosc%E6%A0%B7%E5%BC%8F%E4%BA%86%E5%90%97%E5%AE%83%E4%BB%AC%E4%B8%8D%E4%BB%85%E5%8F%AF%E4%BB%A5%E5%AD%98%E5%9C%A8%E4%BA%8Empv-easy-player%E4%B8%AD%E4%BD%A0%E4%BD%BF%E7%94%A8%E7%9A%84mpv%E7%9A%84osc%E4%B9%9F%E5%8F%AF%E4%BB%A5%E5%8F%98%E6%88%90%E8%BF%99%E6%A0%B7) ⭐ 1,421 | 🐛 1 | 🌐 Lua | 📅 2026-07-12.

* [ModernZ](https://github.com/Samillion/ModernZ) ⭐ 1,162 | 🐛 23 | 🌐 Lua | 📅 2026-06-04 - A fork of ModernX designed to enhance functionality by adding more features, all while preserving the core standards of mpv's OSC.

* [ModernX cyl0](https://github.com/cyl0/ModernX) ⭐ 750 | 🐛 20 | 🌐 Lua | 📅 2026-02-04 - Modern OSC replacement.
...
* [osc-modern](https://github.com/maoiscat/mpv-osc-modern) ⭐ 426 | 🐛 15 | 🌐 Lua | 📅 2024-04-20 - Modern OSC replacement.
...
* [modern-x-compact](https://github.com/1-minute-to-midnight/mpv-modern-x-compact) ⭐ 97 | 🐛 5 | 🌐 Lua | 📅 2024-08-10 - Compact version of modern-x.

* [osc-modern-f](https://github.com/FinnRaze/mpv-osc-modern-f) ⭐ 92 | 🐛 2 | 🌐 Lua | 📅 2024-09-17 - OSC script forked from [mpv-osc-modern](https://github.com/maoiscat/mpv-osc-modern) ⭐ 426 | 🐛 15 | 🌐 Lua | 📅 2024-04-20.
...
* [uosc\_history\_menu](https://github.com/Koopex/uosc_history_menu) ⭐ 13 | 🐛 2 | 🌐 Lua | 📅 2026-08-14 - A history and bookmark management menu integrated with uosc.
...
* [sosc](https://github.com/christoph-heinrich/sosc) ⭐ 5 | 🐛 1 | 🌐 Lua | 📅 2023-12-09 - An OSC supplement for OSC replacements. Provides the idle message and script messages from the original OSC.

* [mfpbar-drag](https://github.com/layercak3/mfpbar-drag) ⭐ 4 | 🐛 0 | 🌐 Lua | 📅 2025-07-02 - mfpbar with support for dragging the bar.
...
* [InputEvent](https://github.com/Natural-Harmonia-Gropius/InputEvent) ⭐ 93 | 🐛 0 | 🌐 Lua | 📅 2026-05-14 - Enhanced input.conf with better, conflict-free, low-latency event mechanism.
* [repl](https://github.com/rossy/mpv-repl) ⭐ 83 | 🐛 2 | 🌐 Lua | 📅 2019-12-07 - A REPL for input commands that is displayed on the video window.
...
* [leader key](https://github.com/Seme4eg/mpv-scripts/tree/master#leader) ⭐ 73 | 🐛 1 | 🌐 Lua | 📅 2026-02-24 - Adds *leader* key to your mpv. With prefixes and [which-key](https://github.com/justbur/emacs-which-key) ⚠️ Archived functionality. [demo](https://i.imgur.com/dUWFu3u.gif)
...
* [assrt by AssrtOSS](https://github.com/AssrtOSS/mpv-assrt) ⭐ 136 | 🐛 7 | 🌐 Lua | 📅 2023-10-03 - Download subtitles from assrt.net.
...
* [sub\_export](https://github.com/dyphire/mpv-scripts/blob/main/sub_export.lua) ⭐ 122 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - fork, updated. Extract selected subtitles from .mkv file.
...
* [auto-load-fonts](https://github.com/Hill-98/mpv-config/blob/main/scripts/auto-load-fonts.js) ⭐ 83 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-01 - Auto load the font files in the fonts folder under the play file path.
...
* [autosubsync](https://github.com/Ajatt-Tools/autosubsync-mpv) ⭐ 42 | 🐛 1 | 🌐 Lua | 📅 2026-05-17 - Automatic subtitle synchronization script.
...
* [sub-fastwhisper](https://github.com/dyphire/mpv-sub-fastwhisper) ⭐ 40 | 🐛 2 | 🌐 Lua | 📅 2026-05-30 - Generate SRT subtitles through voice transcription using faster-whisper.
...
* [ytsub](https://github.com/Idlusen/mpv-ytsub/) ⭐ 11 | 🐛 2 | 🌐 Lua | 📅 2026-08-12 - Load automatic captions from Youtube, can select language interactively or automatically.
* [sub-assrt by dyphire](https://github.com/dyphire/mpv-sub-assrt) ⭐ 10 | 🐛 1 | 🌐 Lua | 📅 2026-04-30 - Download Chinese subtitles from assrt.
...
* [mpvacious](https://github.com/Ajatt-Tools/mpvacious) ⭐ 874 | 🐛 12 | 🌐 Lua | 📅 2026-08-16 - Add keybindings to create Anki flashcards for (language) learning.
* [interSubs](https://github.com/oltodosel/interSubs) ⭐ 263 | 🐛 3 | 🌐 Python | 📅 2025-03-18 - Interactive subtitles, instantly translate selected word/sentence.
...
* [lrc](https://github.com/guidocella/mpv-lrc) ⭐ 39 | 🐛 0 | 🌐 Lua | 📅 2026-04-16 - Download synchronized lyrics of the currently playing song.
...
* [coverart](https://github.com/CogentRedTester/mpv-coverart) ⭐ 20 | 🐛 4 | 🌐 Lua | 📅 2023-08-08 - Automatically loads external cover art for music files.

## Audio

* [acompressor](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/acompressor.lua) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16 - Dynamic range compressor using acompressor ffmpeg filter with controls to dynamically adjust parameters.
...
* [adevice-list](https://github.com/dyphire/mpv-scripts/blob/main/adevice-list.lua) ⭐ 122 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Interractive audio-device list menu.
...
* [jellyfin](https://github.com/EmperorPenguin18/mpv-jellyfin) ⭐ 74 | 🐛 5 | 🌐 Lua | 📅 2026-03-22 - Turns mpv into a Jellyfin client.
...
* [torrserver](https://github.com/kritma/mpv-torrserver) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2024-02-05 - Allows streaming torrents using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 2,942 | 🐛 28 | 🌐 Go | 📅 2026-08-17. Support magnet links and .torrent files
* [torrserver-hook](https://github.com/eNV25/mpv-torrserver-hook) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-06-07 - Allows for playback of media from the BitTorrent network using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 2,942 | 🐛 28 | 🌐 Go | 📅 2026-08-17.
...
* [autocrop](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autocrop.lua) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16 - Automatically crop the video by using lavfi's cropdetect filter to detect black bars.
* [autodeint](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autodeint.lua) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16 - Automatically deinterlace the video by using lavfi's idet filter to detect interlaced content.
* [cycle-deinterlace-pullup](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/cycle-deinterlace-pullup.lua) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16 - Cycle between deinterlacing, pullup (IVTC), and both filters off.
* [use-cpu](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/use-cpu.lua) ⭐ 1,421 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - If the width of the video is greater than 3000 or the height of the video is greater than 2000, it will automatically switch back to using cpu decoding.
...
* [dynamic-crop](https://github.com/Ashyni/mpv-scripts#dynamic-croplua) ⭐ 130 | 🐛 5 | 🌐 Lua | 📅 2024-09-14 - Dynamically crop the video by using lavfi's cropdetect filter to detect hard-coded black bars for Ultra Wide Screen (21:9) or any screen different from 16:9 (phone/old TV).
* [hdr-mode](https://github.com/dyphire/mpv-scripts/blob/main/hdr-mode.lua) ⭐ 122 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Automatically switches the display's SDR and HDR modes for HDR passthrough based on the content of the video being played.
...
* [mpv360](https://github.com/kasper93/mpv360) ⭐ 74 | 🐛 3 | 🌐 Lua | 📅 2026-01-30 - Interactive 360° Video Viewer. With full camera control through mouse and keyboard inputs.
...
* [vlcaspectratio](https://github.com/kism/mpvscripts/blob/main/scripts/vlcaspectratio.lua) ⭐ 27 | 🐛 0 | 🌐 Lua | 📅 2025-09-09 - Implements a VLC style aspect ratio hotkey 'a' that stretches the video to different aspect ratios.
* [vlccrop](https://github.com/kism/mpvscripts/blob/main/scripts/vlccrop.lua) ⭐ 27 | 🐛 0 | 🌐 Lua | 📅 2025-09-09 - Implements a VLC style crop hotkey 'c' that cycles through crop settings, useful for cropping letter-boxed or pillar-boxed content.
...
* [BoxToWide](https://github.com/Samillion/mpv-boxtowide) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2026-02-25 - A simple mpv script to change 4:3 aspect-ratio of video files/streams to 16:9 automatically.
...
* [thumbfast](https://github.com/po5/thumbfast) ⭐ 1,660 | 🐛 55 | 🌐 Lua | 📅 2026-08-12 - High-performance on-the-fly thumbnailer for mpv.
...
* [contact-sheet](https://github.com/occivink/mpv-gallery-view) ⭐ 256 | 🐛 26 | 🌐 Lua | 📅 2024-09-27 - Display thumbnails of the current file in the style of a contact sheet.
* [auto-mode](https://github.com/stax76/mpv-scripts) ⭐ 232 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Use mpv as video player, music player and image viewer, switch automatically between, video, audio and image mode.
* [screenshotfolder](https://github.com/zydezu/mpvconfig/blob/main/scripts/screenshotfolder.lua) ⭐ 105 | 🐛 0 | 🌐 Lua | 📅 2026-08-11 - Place screenshots into folders for each video, along with timestamping them.
...
* [gallery-dl\_hook](https://github.com/jgreco/mpv-scripts/blob/master/gallery-dl_hook.lua) ⭐ 47 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Load online image galleries (imgur, etc) as playlists using [gallery-dl](https://github.com/mikf/gallery-dl/) ⭐ 19,243 | 🐛 1,159 | 🌐 Python | 📅 2026-08-01.
...
* [cut zydezu](https://github.com/zydezu/mpvconfig/blob/main/scripts/mpvcut.lua) ⭐ 105 | 🐛 0 | 🌐 Lua | 📅 2026-08-11 - Easily clip, compress and re-encode selected clips.
...
* [Pure](https://github.com/4ndrs/PureMPV) ⭐ 46 | 🐛 1 | 🌐 TypeScript | 📅 2024-08-17 - Get the file path, timestamps, and cropping coordinates for ffmpeg.
...
* [cut b1scoito](https://github.com/b1scoito/mpv-cut) ⭐ 16 | 🐛 8 | 🌐 Lua | 📅 2022-09-15 - Video cutting/clipping/slicing script.
...
* [extended-menu](https://github.com/Seme4eg/mpv-scripts/tree/master/script-modules) ⭐ 73 | 🐛 1 | 🌐 Lua | 📅 2026-02-24 - API to create a searchable menu (command palette).
* [osc-framework](https://github.com/maoiscat/mpv-osc-framework) ⭐ 59 | 🐛 1 | 🌐 Lua | 📅 2023-11-26 - OSC framework to help build your custom OSC.
...
* [ontop-playback](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/ontop-playback.lua) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16 - Disables the ontop property when pausing, and enables it again when unpausing the video, if it was disabled. Change it only when the player is not in fullscreen to prevent screen flickering.
* [pause-when-minimize](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/pause-when-minimize.lua) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16 - Pauses the player video when minimizing, and unpauses it when brought up again.
* [single-instance](https://github.com/mpv-player/mpv/issues/43#issuecomment-2496083283) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16 - Reuse the existing mpv window when opening new files rather than spawning a new window.
* [local-language](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/local-language.lua) ⭐ 1,421 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - Let the text displayed by osd become the language you are most familiar with, that is, language localization, such as 【volume: 100%】 becomes 【音量:100%】.
...
* [vr-reversal](https://github.com/dfaker/VR-reversal) ⭐ 396 | 🐛 11 | 🌐 Lua | 📅 2024-05-21 - View 3D side-by-side video as a 2D video, allows you to look around and zoom within the video, logs the head motions to a file for later rendering out to a 2D video with ffmpeg.
...
* [anilist-updater](https://github.com/AzuredBlue/mpv-anilist-updater) ⭐ 41 | 🐛 0 | 🌐 Python | 📅 2026-08-01 - Automatically updates your AniList when reaching 80% completion based on the file name.
...
* [txt](https://github.com/jgreco/mpv-txt) ⭐ 27 | 🐛 1 | 🌐 Python | 📅 2018-10-30 - Play text files using text-to-speech (TTS). (Works on Linux, MacOS).
...
* [pdf](https://github.com/jgreco/mpv-pdf) ⭐ 13 | 🐛 2 | 🌐 Lua | 📅 2018-11-18 - View PDFs in mpv using ImageMagick. (for Linux, MacOS)
...
* [trakt-scrobble](https://github.com/dyphire/trakt-scrobble) ⭐ 11 | 🐛 0 | 🌐 Lua | 📅 2026-04-30 - Connects trakt.tv with mpv and automatically scrobbles movies/shows.
...
* [jellyfin mpv shim](https://github.com/jellyfin/jellyfin-mpv-shim) ⭐ 2,317 | 🐛 178 | 🌐 Python | 📅 2026-08-17 - Jellyfin (Emby/Plex alternative) Client, based on Python.
...
* [webtorrent-mpv-hook](https://github.com/mrxdst/webtorrent-mpv-hook) ⭐ 197 | 🐛 10 | 🌐 TypeScript | 📅 2026-05-06 - Adds a hook that allows mpv to stream torrents using webtorrent.
...
* [DLNAmpvRenderer](https://github.com/PCigales/DLNAmpvRenderer) ⭐ 30 | 🐛 1 | 🌐 Python | 📅 2024-09-26 - Windows DLNA/UPnP renderer based on Python.
...
* [dyphire](https://github.com/dyphire/mpv-config) ⭐ 1,840 | 🐛 6 | 🌐 GLSL | 📅 2026-08-17
* [Zabooby](https://github.com/Zabooby/mpv-config) ⭐ 553 | 🐛 0 | 🌐 GLSL | 📅 2026-08-13
* [noelsimbolon](https://github.com/noelsimbolon/mpv-config) ⭐ 305 | 🐛 2 | 🌐 GLSL | 📅 2026-04-30
* [Natural-Harmonia-Gropius](https://github.com/Natural-Harmonia-Gropius/mpv_config) ⭐ 105 | 🐛 0 | 🌐 GLSL | 📅 2026-08-16
...
* [KikoPlay](https://github.com/KikoPlayProject/KikoPlay) ⭐ 2,211 | 🐛 8 | 🌐 C++ | 📅 2026-07-18 - Cross-platform [Danmu](https://en.wikipedia.org/wiki/Danmu) player, based on C++/QT.

# Video Conversion

* [boram](https://github.com/Kagami/boram) ⭐ 465 | 🐛 27 | 🌐 JavaScript | 📅 2023-01-28 - Unmaintained cross-platform WebM converter, based on JavaScript/Web/Electron.
...
* [Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,259 | 🐛 123 | 🌐 Jupyter Notebook | 📅 2024-08-17 - A series of shaders designed to scale and enhance anime. Includes shaders for line sharpening, artefact removal, denoising, upscaling, and more.
...
* [AniSD ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/AniSD-ArtCNN) ⭐ 359 | 🐛 5 | 📅 2025-06-08 - AniSD ArtCNN shader for standard definition anime content.
* [Ani4K v2 ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/Ani4k-v2-ArtCNN) ⭐ 359 | 🐛 5 | 📅 2025-06-08 - Ani4K shader v2 targets modern anime, from high quality Bluray to crappy WEB releases, for upscaling to either 2K or 4K.
* [ArtCNN](https://github.com/Artoriuz/ArtCNN) ⭐ 353 | 🐛 1 | 🌐 GLSL | 📅 2026-08-16 - Luma doublers trained on Manga109.
* [hdr-toys](https://github.com/natural-harmonia-gropius/hdr-toys) ⭐ 187 | 🐛 18 | 🌐 GLSL | 📅 2026-08-17 - Componentized Rec.2100 to Rec.709 conversion shader.
* [CuNNy](https://github.com/funnyplanter/CuNNy) ⭐ 165 | 🐛 3 | 🌐 GLSL | 📅 2025-08-29 - Cute and funny CNN-based upscaler optimized for anime.
...
* [JointBilateral & FastBilateral](https://github.com/Artoriuz/glsl-joint-bilateral) ⭐ 28 | 🐛 0 | 🌐 GLSL | 📅 2024-11-08 - Chroma upsamplers that use the luma plane as a guide to achieve sharper transitions without introducing any ringing.
...
* [vidcutter](https://github.com/ozmartian/vidcutter) ⭐ 1,975 | 🐛 297 | 🌐 Python | 📅 2025-04-24 - Cross-platform video cutter/joiner, based on Python/QT.
* [tsv\_edl.vim](https://github.com/scateu/tsv_edl.vim) ⭐ 101 | 🐛 1 | 🌐 Python | 📅 2026-07-27 - Linux video editing with vim/spreadsheet/sed/python.

# Image Viewer

* [qimgv](https://github.com/easymodo/qimgv) ⭐ 3,105 | 🐛 307 | 🌐 C++ | 📅 2026-01-19 - Cross-platform, based on C++/QT.

# Launcher

* <https://github.com/mpv-player/mpv/blob/master/TOOLS/umpv> ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16
* <https://github.com/davatorium/rofi> ⭐ 16,323 | 🐛 116 | 🌐 C | 📅 2026-08-09
* <https://github.com/Flow-Launcher/Flow.Launcher> ⭐ 15,378 | 🐛 301 | 🌐 C# | 📅 2026-08-16
* <https://github.com/ikas-mc/ContextMenuForWindows11> ⭐ 2,862 | 🐛 20 | 🌐 C# | 📅 2026-07-25
...
* [mpv-mpris](https://github.com/hoyon/mpv-mpris) ⭐ 738 | 🐛 4 | 🌐 C | 📅 2026-07-22 - On Linux allows controlling mpv using standard media keys.
...
* [Compiling for Windows](https://github.com/mpv-player/mpv/blob/master/DOCS/compile-windows.md) ⭐ 36,565 | 🐛 1,132 | 🌐 C | 📅 2026-08-16
* [Building mpv and libmpv using wsl2 and Ubuntu](https://github.com/mpvnet-player/mpv.net/wiki/Building-mpv-and-libmpv-using-wsl2-and-Ubuntu) ⭐ 5,329 | 🐛 155 | 🌐 C# | 📅 2026-02-09
* [Media Auto Build Suite (MABS)](https://github.com/m-ab-s/media-autobuild_suite) ⭐ 1,811 | 🐛 219 | 🌐 Shell | 📅 2026-08-11
* [Helper scripts to compile mpv on Linux](https://github.com/mpv-player/mpv-build) ⭐ 488 | 🐛 9 | 🌐 Shell | 📅 2025-11-02
...
* [js](https://github.com/Kagami/mpv.js) ⭐ 445 | 🐛 20 | 🌐 C++ | 📅 2024-01-17 - Embeddable player for Electron/NW\.js (JavaScript).
...
* [easy](https://github.com/mpv-easy/mpv-easy) ⭐ 136 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-17 - TS and React GUI toolkit for mpv script.
...
* [gnome-shell-extension-caffeine](https://github.com/eonpatapon/gnome-shell-extension-caffeine) ⭐ 771 | 🐛 41 | 🌐 JavaScript | 📅 2026-05-20 - Prevent the display from turning off (Gnome doesn't support the idle-inhibit protocol on Wayland) and disable the 'night light' when a mpv window is in focus.
...
* [mpvQC](https://github.com/mpvqc/mpvQC) ⭐ 79 | 🐛 5 | 🌐 Python | 📅 2026-08-16 - Cross-platform application for quality control of videos, based on Python/QT.
