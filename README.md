...
* [SMPlayer](https://github.com/smplayer-dev/smplayer) ⭐ 1,037 | 🐛 77 | 🌐 C++ | 📅 2026-08-11 - Based on C++/QT.
...
* [OvoPlayer](https://github.com/varianus/ovoplayer) ⭐ 66 | 🐛 2 | 🌐 Pascal | 📅 2026-08-16 - Unmaintained, based on Pascal.
...
* [mpc-qt](https://github.com/mpc-qt/mpc-qt) ⭐ 1,055 | 🐛 121 | 🌐 C++ | 📅 2026-08-16 - Based on C++/QT.
...
* [Deepin Movie](https://github.com/linuxdeepin/deepin-movie-reborn) ⭐ 88 | 🐛 1 | 🌐 C++ | 📅 2026-07-31 - Unmaintained, based on C++/QT.
...
* [android](https://github.com/mpv-android/mpv-android) ⭐ 3,470 | 🐛 164 | 🌐 Kotlin | 📅 2026-08-16 - Player for Android, based on Kotlin.
* [Kt](https://github.com/abdallahmehiz/mpvKt) ⚠️ Archived - Player for Android, based on Kotlin.

# Installation/Download

* [shinchiro GitHub](https://github.com/shinchiro/mpv-winbuild-cmake) ⭐ 1,708 | 🐛 57 | 🌐 CMake | 📅 2026-08-14 - Daily Windows builds of mpv and libmpv. This is the most popular choice on Windows.
* [zhongfly](https://github.com/zhongfly/mpv-winbuild) ⭐ 870 | 🐛 0 | 🌐 Shell | 📅 2026-08-16 - Windows builds of mpv and libmpv. This choice is very similar to `shinchiro GitHub`, so it's also a recommendation.
...
* [Andarwinux](https://github.com/Andarwinux/mpv-winbuild) ⭐ 23 | 🐛 3 | 🌐 Shell | 📅 2026-08-16 - Daily Windows builds of mpv and libmpv including ARM64 architecture.
...
* [Wiki](https://github.com/mpv-player/mpv/wiki) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16
...
* <https://github.com/mpv-player/mpv/issues> ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16
* <https://github.com/mpv-player/mpv/discussions> ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16
...
in the [wiki](https://github.com/mpv-player/mpv/wiki/User-Scripts) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16,
the advantage of the following list is that everything is categorized
into popular sections, like Subtitles etc.

## Menu

* [select](https://github.com/mpv-player/mpv/blob/master/player/lua/select.lua) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16 - Menu script built into mpv.
* [uosc](https://github.com/tomasklaen/uosc) ⭐ 3,320 | 🐛 32 | 🌐 Lua | 📅 2026-08-03 - Popular OSC with menu.
...
* [betterchapters](https://gist.github.com/Hakkin/4f978a5c87c31f7fe3ae) ([update](https://github.com/mpv-player/mpv/issues/4738#issuecomment-321298846) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16) - Loads the next or previous playlist entry if there are no more chapters in the seek direction.
* [autoload](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autoload.lua) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16 - Automatically load playlist entries before and after the currently playing file, by scanning the directory. **Obsolete:** mpv now has a native `--autocreate-playlist` option.
* [print-playlist](https://git.sr.ht/~jagrg/dotfiles/tree/master/item/common/.config/mpv/scripts/print-playlist.lua) - Cleans [the playlist formatting](https://github.com/mpv-player/mpv/issues/5868#issue-327675880) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16 on the terminal.
...
* [pause-indicator-lite](https://github.com/Samillion/ModernZ/tree/main/extras/pause-indicator-lite) ⭐ 1,157 | 🐛 23 | 🌐 Lua | 📅 2026-06-04 - A simple script that displays an indicator on pause, with options to adjust icon, color, height, width, opacity and whether to toggle pause with a keybind or not.
...
* [chapter-make-read](https://github.com/dyphire/mpv-scripts/blob/main/chapter-make-read.lua) ⭐ 122 | 🐛 2 | 🌐 Lua | 📅 2026-05-20 - Automatically read an load the namesake external chapter file with extension of CHP. Temporarily mark the current playback position as a chapter so you can seek to it later. Also allows writing current chapters as CHP or XML. Based on `createchapter`.
* [track-list](https://github.com/dyphire/mpv-scripts/blob/main/track-list.lua) ⭐ 122 | 🐛 2 | 🌐 Lua | 📅 2026-05-20 - Interractive track-list menu.
* [skiptosilence dyphire](https://github.com/dyphire/mpv-scripts/blob/main/skiptosilence.lua) ⭐ 122 | 🐛 2 | 🌐 Lua | 📅 2026-05-20 - Skips to the next silence in the file.
...
* [ModernZ](https://github.com/Samillion/ModernZ) ⭐ 1,157 | 🐛 23 | 🌐 Lua | 📅 2026-06-04 - A fork of ModernX designed to enhance functionality by adding more features, all while preserving the core standards of mpv's OSC.
...
* [sub\_export](https://github.com/dyphire/mpv-scripts/blob/main/sub_export.lua) ⭐ 122 | 🐛 2 | 🌐 Lua | 📅 2026-05-20 - fork, updated. Extract selected subtitles from .mkv file.
...
* [mpvacious](https://github.com/Ajatt-Tools/mpvacious) ⭐ 873 | 🐛 13 | 🌐 Lua | 📅 2026-08-13 - Add keybindings to create Anki flashcards for (language) learning.
...
* [acompressor](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/acompressor.lua) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16 - Dynamic range compressor using acompressor ffmpeg filter with controls to dynamically adjust parameters.
...
* [adevice-list](https://github.com/dyphire/mpv-scripts/blob/main/adevice-list.lua) ⭐ 122 | 🐛 2 | 🌐 Lua | 📅 2026-05-20 - Interractive audio-device list menu.
...
* [torrserver](https://github.com/kritma/mpv-torrserver) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2024-02-05 - Allows streaming torrents using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 2,940 | 🐛 42 | 🌐 Go | 📅 2026-08-11. Support magnet links and .torrent files
* [torrserver-hook](https://github.com/eNV25/mpv-torrserver-hook) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-06-07 - Allows for playback of media from the BitTorrent network using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 2,940 | 🐛 42 | 🌐 Go | 📅 2026-08-11.
...
* [autocrop](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autocrop.lua) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16 - Automatically crop the video by using lavfi's cropdetect filter to detect black bars.
* [autodeint](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autodeint.lua) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16 - Automatically deinterlace the video by using lavfi's idet filter to detect interlaced content.
* [cycle-deinterlace-pullup](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/cycle-deinterlace-pullup.lua) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16 - Cycle between deinterlacing, pullup (IVTC), and both filters off.
...
* [hdr-mode](https://github.com/dyphire/mpv-scripts/blob/main/hdr-mode.lua) ⭐ 122 | 🐛 2 | 🌐 Lua | 📅 2026-05-20 - Automatically switches the display's SDR and HDR modes for HDR passthrough based on the content of the video being played.
...
* [thumbfast](https://github.com/po5/thumbfast) ⭐ 1,658 | 🐛 55 | 🌐 Lua | 📅 2026-08-12 - High-performance on-the-fly thumbnailer for mpv.
...
* [gallery-dl\_hook](https://github.com/jgreco/mpv-scripts/blob/master/gallery-dl_hook.lua) ⭐ 47 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Load online image galleries (imgur, etc) as playlists using [gallery-dl](https://github.com/mikf/gallery-dl/) ⭐ 19,234 | 🐛 1,155 | 🌐 Python | 📅 2026-08-01.
...
* [ontop-playback](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/ontop-playback.lua) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16 - Disables the ontop property when pausing, and enables it again when unpausing the video, if it was disabled. Change it only when the player is not in fullscreen to prevent screen flickering.
* [pause-when-minimize](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/pause-when-minimize.lua) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16 - Pauses the player video when minimizing, and unpauses it when brought up again.
* [single-instance](https://github.com/mpv-player/mpv/issues/43#issuecomment-2496083283) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16 - Reuse the existing mpv window when opening new files rather than spawning a new window.
...
* [jellyfin mpv shim](https://github.com/jellyfin/jellyfin-mpv-shim) ⭐ 2,315 | 🐛 177 | 🌐 Python | 📅 2026-08-16 - Jellyfin (Emby/Plex alternative) Client, based on Python.
...
* [dyphire](https://github.com/dyphire/mpv-config) ⭐ 1,840 | 🐛 10 | 🌐 GLSL | 📅 2026-08-12
...
* [Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,258 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17 - A series of shaders designed to scale and enhance anime. Includes shaders for line sharpening, artefact removal, denoising, upscaling, and more.
...
* [AniSD ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/AniSD-ArtCNN) ⭐ 358 | 🐛 5 | 📅 2025-06-08 - AniSD ArtCNN shader for standard definition anime content.
* [Ani4K v2 ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/Ani4k-v2-ArtCNN) ⭐ 358 | 🐛 5 | 📅 2025-06-08 - Ani4K shader v2 targets modern anime, from high quality Bluray to crappy WEB releases, for upscaling to either 2K or 4K.
* [ArtCNN](https://github.com/Artoriuz/ArtCNN) ⭐ 351 | 🐛 1 | 🌐 GLSL | 📅 2026-08-16 - Luma doublers trained on Manga109.
* [hdr-toys](https://github.com/natural-harmonia-gropius/hdr-toys) ⭐ 187 | 🐛 18 | 🌐 GLSL | 📅 2026-08-16 - Componentized Rec.2100 to Rec.709 conversion shader.
...
* [vidcutter](https://github.com/ozmartian/vidcutter) ⭐ 1,974 | 🐛 297 | 🌐 Python | 📅 2025-04-24 - Cross-platform video cutter/joiner, based on Python/QT.
...
* <https://github.com/mpv-player/mpv/blob/master/TOOLS/umpv> ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16
* <https://github.com/davatorium/rofi> ⭐ 16,324 | 🐛 116 | 🌐 C | 📅 2026-08-09
* <https://github.com/Flow-Launcher/Flow.Launcher> ⭐ 15,373 | 🐛 301 | 🌐 C# | 📅 2026-08-16
* <https://github.com/ikas-mc/ContextMenuForWindows11> ⭐ 2,858 | 🐛 20 | 🌐 C# | 📅 2026-07-25
...
* [Compiling for Windows](https://github.com/mpv-player/mpv/blob/master/DOCS/compile-windows.md) ⭐ 36,557 | 🐛 1,130 | 🌐 C | 📅 2026-08-16
...
* [Kit](https://github.com/mpvkit/MPVKit) ⭐ 195 | 🐛 10 | 🌐 Swift | 📅 2026-08-04 - MPVKit is a collection of tools to use mpv in iOS, macOS, tvOS applications. It includes scripts to build mpv native libraries.
* [easy](https://github.com/mpv-easy/mpv-easy) ⭐ 136 | 🐛 74 | 🌐 TypeScript | 📅 2026-07-23 - TS and React GUI toolkit for mpv script.
