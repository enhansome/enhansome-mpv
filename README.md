...
* [SMPlayer](https://github.com/smplayer-dev/smplayer) ⭐ 1,041 | 🐛 84 | 🌐 C++ | 📅 2026-08-11 - Based on C++/QT.
...
* [mpv.net](https://github.com/mpvnet-player/mpv.net) ⭐ 5,347 | 🐛 156 | 🌐 C# | 📅 2026-02-09 - Based on C#/WinForms/WPF.
* [MPV-EASY Player](https://github.com/422658476/MPV-EASY-Player) ⭐ 1,423 | 🐛 1 | 🌐 Lua | 📅 2026-07-12
* [mpc-qt](https://github.com/mpc-qt/mpc-qt) ⭐ 1,063 | 🐛 124 | 🌐 C++ | 📅 2026-08-23 - Based on C++/QT.
* [mpv-hero](https://github.com/stax76/mpv-hero) ⭐ 137 | 🐛 8 | 🌐 Lua | 📅 2025-11-26 - mpv extended with GUI scripts and GUI tools.
...
* [Deepin Movie](https://github.com/linuxdeepin/deepin-movie-reborn) ⭐ 88 | 🐛 8 | 🌐 C++ | 📅 2026-08-22 - Unmaintained, based on C++/QT.
...
* [android](https://github.com/mpv-android/mpv-android) ⭐ 3,485 | 🐛 163 | 🌐 Kotlin | 📅 2026-08-22 - Player for Android, based on Kotlin.
* [Kt](https://github.com/abdallahmehiz/mpvKt) ⚠️ Archived - Player for Android, based on Kotlin.

# Installation/Download

* [shinchiro GitHub](https://github.com/shinchiro/mpv-winbuild-cmake) ⭐ 1,714 | 🐛 58 | 🌐 CMake | 📅 2026-08-14 - Daily Windows builds of mpv and libmpv. This is the most popular choice on Windows.
* [zhongfly](https://github.com/zhongfly/mpv-winbuild) ⭐ 879 | 🐛 0 | 🌐 Shell | 📅 2026-08-23 - Windows builds of mpv and libmpv. This choice is very similar to `shinchiro GitHub`, so it's also a recommendation.
* [mpsm](https://github.com/mpv-easy/mpv-easy/tree/main/mpv-mpsm) ⭐ 138 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-20 - mpsm is a mpv script manager, you can install scripts provided by [mpsm-scripts](https://github.com/mpv-easy/mpsm-scripts) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-07-22, or install any script with added [meta info](https://github.com/mpv-easy/mpsm-scripts?tab=readme-ov-file#meta-info) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-07-22 via url.
* [mitzsch](https://github.com/mitzsch/mpv-winbuild) ⭐ 29 | 🐛 0 | 🌐 Shell | 📅 2026-08-08 - Windows builds of mpv and libmpv.
* [Andarwinux](https://github.com/Andarwinux/mpv-winbuild) ⭐ 23 | 🐛 3 | 🌐 Shell | 📅 2026-08-23 - Daily Windows builds of mpv and libmpv including ARM64 architecture.
...
* [Wiki](https://github.com/mpv-player/mpv/wiki) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23
...
* <https://github.com/mpv-player/mpv/issues> ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23
* <https://github.com/mpv-player/mpv/discussions> ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23
...
in the [wiki](https://github.com/mpv-player/mpv/wiki/User-Scripts) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23,
the advantage of the following list is that everything is categorized
into popular sections, like Subtitles etc.

## Menu

* [select](https://github.com/mpv-player/mpv/blob/master/player/lua/select.lua) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23 - Menu script built into mpv.
* [uosc](https://github.com/tomasklaen/uosc) ⭐ 3,333 | 🐛 32 | 🌐 Lua | 📅 2026-08-03 - Popular OSC with menu.
* [command\_palette](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Searchable menu for
...
* [search-menu](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Searchable and configurable menu to quickly find key bindings, commands, properties, audio/subtitle tracks and playlist entries.
* [osm](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Configurable on screen menu to run custom commands.
...
* [betterchapters](https://gist.github.com/Hakkin/4f978a5c87c31f7fe3ae) ([update](https://github.com/mpv-player/mpv/issues/4738#issuecomment-321298846) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23) - Loads the next or previous playlist entry if there are no more chapters in the seek direction.
* [autoload](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autoload.lua) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23 - Automatically load playlist entries before and after the currently playing file, by scanning the directory. **Obsolete:** mpv now has a native `--autocreate-playlist` option.
* [print-playlist](https://git.sr.ht/~jagrg/dotfiles/tree/master/item/common/.config/mpv/scripts/print-playlist.lua) - Cleans [the playlist formatting](https://github.com/mpv-player/mpv/issues/5868#issue-327675880) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23 on the terminal.
* [playlistnoplayback](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/playlistnoplayback.lua) ⭐ 1,423 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - If you enable the save play history and progress function, this lua script can solve the problem of automatically jumping to the previous playback progress when playing the next file when playing the playlist, that is, let the playlist always play the next file from the beginning every time. the limitations of this script, please see the comments section in the content.
* [pause-indicator-lite](https://github.com/Samillion/ModernZ/tree/main/extras/pause-indicator-lite) ⭐ 1,177 | 🐛 25 | 🌐 Lua | 📅 2026-06-04 - A simple script that displays an indicator on pause, with options to adjust icon, color, height, width, opacity and whether to toggle pause with a keybind or not.
...
* [history](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Writes date, time, playtime and filename to a log file: `10.09.2022 19:50  3 D:\Samples\Big Buck Bunny.mkv`
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - When seeking display position and duration like so: 70:00 / 80:00
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Navigate in playlist to next/previous/first/last file.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Jump to a random position in the playlist.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Load or append files/URLs from clipboard.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Cycle audio and subtitle tracks, include only languages you know.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Show detailed media info on screen.
...
* [delete-current-file](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Moves the current file instantly to the recycle bin.
* [file-rating](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Writes a star rating to the filename of the current file.
...
* [osd-bar](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/osd-bar.lua) ⭐ 1,423 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - Always show osd progress bar, with the more beautiful color matching in the [configuration file](https://github.com/422658476/MPV-EASY-Player/blob/master/mpv-easy-data/rjno1.conf) ⭐ 1,423 | 🐛 1 | 🌐 Lua | 📅 2026-07-12, you can make the osd progress bar display the current progress at the bottom of the window beautifully,this is a [preview](https://raw.githubusercontent.com/422658476/MPV-EASY-Player/master/img/mpv-easy-player-osd-bar-lua.jpg).

* [osc-style](https://github.com/422658476/MPV-EASY-Player/tree/master/mpv-easy-data/osc-style) ⭐ 1,423 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - Change the mpv OSC to a more beautiful and practical look, which is the osc theme feature, a variety of styles to choose from,this is a [tutorial and a preview](https://github.com/422658476/MPV-EASY-Player#%E7%9C%8B%E5%88%B0%E4%B8%8A%E9%9D%A2%E5%9B%BE%E4%B8%8A%E8%BF%99%E4%BA%9Bosc%E6%A0%B7%E5%BC%8F%E4%BA%86%E5%90%97%E5%AE%83%E4%BB%AC%E4%B8%8D%E4%BB%85%E5%8F%AF%E4%BB%A5%E5%AD%98%E5%9C%A8%E4%BA%8Empv-easy-player%E4%B8%AD%E4%BD%A0%E4%BD%BF%E7%94%A8%E7%9A%84mpv%E7%9A%84osc%E4%B9%9F%E5%8F%AF%E4%BB%A5%E5%8F%98%E6%88%90%E8%BF%99%E6%A0%B7) ⭐ 1,423 | 🐛 1 | 🌐 Lua | 📅 2026-07-12.

* [ModernZ](https://github.com/Samillion/ModernZ) ⭐ 1,177 | 🐛 25 | 🌐 Lua | 📅 2026-06-04 - A fork of ModernX designed to enhance functionality by adding more features, all while preserving the core standards of mpv's OSC.

* [ModernX cyl0](https://github.com/cyl0/ModernX) ⭐ 753 | 🐛 20 | 🌐 Lua | 📅 2026-02-04 - Modern OSC replacement.
...
* [ModernX zydezu](https://github.com/zydezu/ModernX) ⭐ 288 | 🐛 3 | 🌐 Lua | 📅 2026-08-11 - A fork of ModernX with many additional features and customization.
...
* [auto-mode](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Use mpv as video player, music player and image viewer, switch automatically between, video, audio and image mode.
...
* [acompressor](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/acompressor.lua) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23 - Dynamic range compressor using acompressor ffmpeg filter with controls to dynamically adjust parameters.
* [smart-volume](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Replay gain alternative.
...
* [torrserver](https://github.com/kritma/mpv-torrserver) ⭐ 8 | 🐛 0 | 🌐 Lua | 📅 2024-02-05 - Allows streaming torrents using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 2,962 | 🐛 30 | 🌐 Go | 📅 2026-08-17. Support magnet links and .torrent files
...
* [torrserver-hook](https://github.com/eNV25/mpv-torrserver-hook) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-06-07 - Allows for playback of media from the BitTorrent network using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 2,962 | 🐛 30 | 🌐 Go | 📅 2026-08-17.
...
* [autocrop](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autocrop.lua) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23 - Automatically crop the video by using lavfi's cropdetect filter to detect black bars.
* [autodeint](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autodeint.lua) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23 - Automatically deinterlace the video by using lavfi's idet filter to detect interlaced content.
* [cycle-deinterlace-pullup](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/cycle-deinterlace-pullup.lua) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23 - Cycle between deinterlacing, pullup (IVTC), and both filters off.
* [use-cpu](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/use-cpu.lua) ⭐ 1,423 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - If the width of the video is greater than 3000 or the height of the video is greater than 2000, it will automatically switch back to using cpu decoding.
...
* [thumbfast](https://github.com/po5/thumbfast) ⭐ 1,670 | 🐛 55 | 🌐 Lua | 📅 2026-08-12 - High-performance on-the-fly thumbnailer for mpv.
...
* [auto-mode](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Use mpv as video player, music player and image viewer, switch automatically between, video, audio and image mode.
* [screenshotfolder](https://github.com/zydezu/mpvconfig/blob/main/scripts/screenshotfolder.lua) ⭐ 107 | 🐛 0 | 🌐 Lua | 📅 2026-08-11 - Place screenshots into folders for each video, along with timestamping them.
...
* [gallery-dl\_hook](https://github.com/jgreco/mpv-scripts/blob/master/gallery-dl_hook.lua) ⭐ 47 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Load online image galleries (imgur, etc) as playlists using [gallery-dl](https://github.com/mikf/gallery-dl/) ⭐ 19,297 | 🐛 1,152 | 🌐 Python | 📅 2026-08-01.
...
* [cut zydezu](https://github.com/zydezu/mpvconfig/blob/main/scripts/mpvcut.lua) ⭐ 107 | 🐛 0 | 🌐 Lua | 📅 2026-08-11 - Easily clip, compress and re-encode selected clips.
...
* [ontop-playback](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/ontop-playback.lua) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23 - Disables the ontop property when pausing, and enables it again when unpausing the video, if it was disabled. Change it only when the player is not in fullscreen to prevent screen flickering.
* [pause-when-minimize](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/pause-when-minimize.lua) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23 - Pauses the player video when minimizing, and unpauses it when brought up again.
* [single-instance](https://github.com/mpv-player/mpv/issues/43#issuecomment-2496083283) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23 - Reuse the existing mpv window when opening new files rather than spawning a new window.
* [local-language](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/local-language.lua) ⭐ 1,423 | 🐛 1 | 🌐 Lua | 📅 2026-07-12 - Let the text displayed by osd become the language you are most familiar with, that is, language localization, such as 【volume: 100%】 becomes 【音量:100%】.
...
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Execute Lua code from input.conf.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 233 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Restart mpv restoring the properties path, time-pos, pause and volume.
...
* [jellyfin mpv shim](https://github.com/jellyfin/jellyfin-mpv-shim) ⭐ 2,330 | 🐛 179 | 🌐 Python | 📅 2026-08-23 - Jellyfin (Emby/Plex alternative) Client, based on Python.
...
* [dyphire](https://github.com/dyphire/mpv-config) ⭐ 1,850 | 🐛 6 | 🌐 GLSL | 📅 2026-08-23
...
* [KikoPlay](https://github.com/KikoPlayProject/KikoPlay) ⭐ 2,218 | 🐛 7 | 🌐 C++ | 📅 2026-07-18 - Cross-platform [Danmu](https://en.wikipedia.org/wiki/Danmu) player, based on C++/QT.

# Video Conversion

* [boram](https://github.com/Kagami/boram) ⭐ 464 | 🐛 27 | 🌐 JavaScript | 📅 2023-01-28 - Unmaintained cross-platform WebM converter, based on JavaScript/Web/Electron.
...
* [Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,280 | 🐛 123 | 🌐 Jupyter Notebook | 📅 2024-08-17 - A series of shaders designed to scale and enhance anime. Includes shaders for line sharpening, artefact removal, denoising, upscaling, and more.
...
* [ArtCNN](https://github.com/Artoriuz/ArtCNN) ⭐ 358 | 🐛 1 | 🌐 GLSL | 📅 2026-08-18 - Luma doublers trained on Manga109.
...
* [qimgv](https://github.com/easymodo/qimgv) ⭐ 3,113 | 🐛 307 | 🌐 C++ | 📅 2026-01-19 - Cross-platform, based on C++/QT.

# Launcher

* <https://github.com/mpv-player/mpv/blob/master/TOOLS/umpv> ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23
* <https://github.com/davatorium/rofi> ⭐ 16,349 | 🐛 116 | 🌐 C | 📅 2026-08-09
* <https://github.com/Flow-Launcher/Flow.Launcher> ⭐ 15,406 | 🐛 299 | 🌐 C# | 📅 2026-08-23
...
* [Compiling for Windows](https://github.com/mpv-player/mpv/blob/master/DOCS/compile-windows.md) ⭐ 36,644 | 🐛 1,133 | 🌐 C | 📅 2026-08-23
* [Building mpv and libmpv using wsl2 and Ubuntu](https://github.com/mpvnet-player/mpv.net/wiki/Building-mpv-and-libmpv-using-wsl2-and-Ubuntu) ⭐ 5,347 | 🐛 156 | 🌐 C# | 📅 2026-02-09
...
* [easy](https://github.com/mpv-easy/mpv-easy) ⭐ 138 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-20 - TS and React GUI toolkit for mpv script.
...
* [Memento](https://github.com/ripose-jp/Memento) ⭐ 1,469 | 🐛 27 | 🌐 C++ | 📅 2026-08-05 - Cross-platform video player for studying Japanese, based on C++/QT.
...
* [mpvQC](https://github.com/mpvqc/mpvQC) ⭐ 79 | 🐛 5 | 🌐 Python | 📅 2026-08-23 - Cross-platform application for quality control of videos, based on Python/QT.
