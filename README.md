...
* [SMPlayer](https://github.com/smplayer-dev/smplayer) ⭐ 1,058 | 🐛 76 | 🌐 C++ | 📅 2026-09-16 - Based on C++/QT.
...
* [mpv.net](https://github.com/mpvnet-player/mpv.net) ⭐ 5,414 | 🐛 156 | 🌐 C# | 📅 2026-02-09 - Based on C#/WinForms/WPF.
* [MPV-EASY Player](https://github.com/422658476/MPV-EASY-Player) ⭐ 1,433 | 🐛 1 | 🌐 Lua | 📅 2026-09-06
* [mpc-qt](https://github.com/mpc-qt/mpc-qt) ⭐ 1,098 | 🐛 114 | 🌐 C++ | 📅 2026-09-22 - Based on C++/QT.
...
* [android](https://github.com/mpv-android/mpv-android) ⭐ 3,583 | 🐛 163 | 🌐 Kotlin | 📅 2026-09-17 - Player for Android, based on Kotlin.
* [Kt](https://github.com/abdallahmehiz/mpvKt) ⚠️ Archived - Player for Android, based on Kotlin.

# Installation/Download

* [shinchiro GitHub](https://github.com/shinchiro/mpv-winbuild-cmake) ⭐ 1,763 | 🐛 61 | 🌐 CMake | 📅 2026-09-23 - Daily Windows builds of mpv and libmpv. This is the most popular choice on Windows.
* [zhongfly](https://github.com/zhongfly/mpv-winbuild) ⭐ 927 | 🐛 0 | 🌐 Shell | 📅 2026-09-23 - Windows builds of mpv and libmpv. This choice is very similar to `shinchiro GitHub`, so it's also a recommendation.
* [mpsm](https://github.com/mpv-easy/mpv-easy/tree/main/mpv-mpsm) ⭐ 137 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-23 - mpsm is a mpv script manager, you can install scripts provided by [mpsm-scripts](https://github.com/mpv-easy/mpsm-scripts) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-23, or install any script with added [meta info](https://github.com/mpv-easy/mpsm-scripts?tab=readme-ov-file#meta-info) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-23 via url.
...
* [Wiki](https://github.com/mpv-player/mpv/wiki) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23
...
* <https://github.com/mpv-player/mpv/issues> ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23
* <https://github.com/mpv-player/mpv/discussions> ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23
...
in the [wiki](https://github.com/mpv-player/mpv/wiki/User-Scripts) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23,
the advantage of the following list is that everything is categorized
into popular sections, like Subtitles etc.

## Menu

* [select](https://github.com/mpv-player/mpv/blob/master/player/lua/select.lua) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23 - Menu script built into mpv.
* [uosc](https://github.com/tomasklaen/uosc) ⭐ 3,413 | 🐛 34 | 🌐 Lua | 📅 2026-08-30 - Popular OSC with menu.
...
* [mpvc-tui](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-23 - Command-line and TUI for mpv.
...
* [betterchapters](https://gist.github.com/Hakkin/4f978a5c87c31f7fe3ae) ([update](https://github.com/mpv-player/mpv/issues/4738#issuecomment-321298846) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23) - Loads the next or previous playlist entry if there are no more chapters in the seek direction.
* [autoload](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autoload.lua) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23 - Automatically load playlist entries before and after the currently playing file, by scanning the directory. **Obsolete:** mpv now has a native `--autocreate-playlist` option.
* [print-playlist](https://git.sr.ht/~jagrg/dotfiles/tree/master/item/common/.config/mpv/scripts/print-playlist.lua) - Cleans [the playlist formatting](https://github.com/mpv-player/mpv/issues/5868#issue-327675880) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23 on the terminal.
* [playlistnoplayback](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/playlistnoplayback.lua) ⭐ 1,433 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - If you enable the save play history and progress function, this lua script can solve the problem of automatically jumping to the previous playback progress when playing the next file when playing the playlist, that is, let the playlist always play the next file from the beginning every time. the limitations of this script, please see the comments section in the content.
* [pause-indicator-lite](https://github.com/Samillion/ModernZ/tree/main/extras/pause-indicator-lite) ⭐ 1,242 | 🐛 27 | 🌐 Lua | 📅 2026-06-04 - A simple script that displays an indicator on pause, with options to adjust icon, color, height, width, opacity and whether to toggle pause with a keybind or not.
* [UndoRedo](https://github.com/Eisa01/mpv-scripts#undoredo) ⭐ 843 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Undo and Redo feature for mpv. If you seek/jump to a different time in the video, press undo \[ctrl]+\[z] to linearly undo the seeks/jumps in the video, and press redo \[ctrl]+\[y] to linearly return to previous undo positions. More details in the link above.
* [SimpleBookmark-1.0](https://github.com/Eisa01/mpv-scripts#simplebookmark) ⭐ 843 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Bookmark with a \[ctrl]+\[b], then list and access your bookmarks with \[b]. Assign your favorites to a keybind then access your favorites with that same keybind. Much more explained in the link above.
* [SimpleHistory-1.0](https://github.com/Eisa01/mpv-scripts#simplehistory) ⭐ 843 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Powerful history features that logs videos that you opened into a log file along with the time you have reached on each video. Select, filter, and search from your history list, Optional resume by \[ctrl]+\[r] for all videos you have played. Much more explained in the link above.
* [SimpleUndo-3.2](https://github.com/Eisa01/mpv-scripts#simpleundo) ⭐ 843 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Simple undo feature. If you accidentally seek/jump to a different time in the video, press undo \[ctrl]+\[z] to return to your previous time and vice-versa. More details in the link above.
* [SmartSkip](https://github.com/Eisa01/mpv-scripts/#smartskip) ⭐ 843 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Automatically or manually skip opening, intro, outro, and preview, like never before. Jump to next file, previous file, and save your chapter changes! Much more explained in the link above.
...
* [reload](https://github.com/4e6/mpv-reload) ⭐ 155 | 🐛 8 | 🌐 Lua | 📅 2025-02-07 - When an online video is stuck during buffering or got slow CDN source, restarting often helps. This script provides automatic reloading of videos that didn't have buffering progress for some time, keeping the current time position. It also adds `Ctrl+r` keybinding to reload video manually.
* [bookmarker-menu](https://github.com/NurioHin/mpv-bookmarker) ⭐ 134 | 🐛 20 | 🌐 Lua | 📅 2021-01-27 - Menu to manage all your bookmarks.
...
* [osd-bar](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/osd-bar.lua) ⭐ 1,433 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - Always show osd progress bar, with the more beautiful color matching in the [configuration file](https://github.com/422658476/MPV-EASY-Player/blob/master/mpv-easy-data/rjno1.conf) ⭐ 1,433 | 🐛 1 | 🌐 Lua | 📅 2026-09-06, you can make the osd progress bar display the current progress at the bottom of the window beautifully,this is a [preview](https://raw.githubusercontent.com/422658476/MPV-EASY-Player/master/img/mpv-easy-player-osd-bar-lua.jpg).

* [osc-style](https://github.com/422658476/MPV-EASY-Player/tree/master/mpv-easy-data/osc-style) ⭐ 1,433 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - Change the mpv OSC to a more beautiful and practical look, which is the osc theme feature, a variety of styles to choose from,this is a [tutorial and a preview](https://github.com/422658476/MPV-EASY-Player#%E7%9C%8B%E5%88%B0%E4%B8%8A%E9%9D%A2%E5%9B%BE%E4%B8%8A%E8%BF%99%E4%BA%9Bosc%E6%A0%B7%E5%BC%8F%E4%BA%86%E5%90%97%E5%AE%83%E4%BB%AC%E4%B8%8D%E4%BB%85%E5%8F%AF%E4%BB%A5%E5%AD%98%E5%9C%A8%E4%BA%8Empv-easy-player%E4%B8%AD%E4%BD%A0%E4%BD%BF%E7%94%A8%E7%9A%84mpv%E7%9A%84osc%E4%B9%9F%E5%8F%AF%E4%BB%A5%E5%8F%98%E6%88%90%E8%BF%99%E6%A0%B7) ⭐ 1,433 | 🐛 1 | 🌐 Lua | 📅 2026-09-06.

* [ModernZ](https://github.com/Samillion/ModernZ) ⭐ 1,242 | 🐛 27 | 🌐 Lua | 📅 2026-06-04 - A fork of ModernX designed to enhance functionality by adding more features, all while preserving the core standards of mpv's OSC.
...
* [mpvacious](https://github.com/Ajatt-Tools/mpvacious) ⭐ 891 | 🐛 12 | 🌐 Lua | 📅 2026-09-17 - Add keybindings to create Anki flashcards for (language) learning.
...
* [acompressor](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/acompressor.lua) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23 - Dynamic range compressor using acompressor ffmpeg filter with controls to dynamically adjust parameters.
...
* [torrserver](https://github.com/kritma/mpv-torrserver) ⭐ 9 | 🐛 0 | 🌐 Lua | 📅 2024-02-05 - Allows streaming torrents using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,060 | 🐛 28 | 🌐 Go | 📅 2026-09-23. Support magnet links and .torrent files
...
* [torrserver-hook](https://github.com/eNV25/mpv-torrserver-hook) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-06-07 - Allows for playback of media from the BitTorrent network using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,060 | 🐛 28 | 🌐 Go | 📅 2026-09-23.
...
* [autocrop](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autocrop.lua) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23 - Automatically crop the video by using lavfi's cropdetect filter to detect black bars.
* [autodeint](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autodeint.lua) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23 - Automatically deinterlace the video by using lavfi's idet filter to detect interlaced content.
* [cycle-deinterlace-pullup](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/cycle-deinterlace-pullup.lua) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23 - Cycle between deinterlacing, pullup (IVTC), and both filters off.
* [use-cpu](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/use-cpu.lua) ⭐ 1,433 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - If the width of the video is greater than 3000 or the height of the video is greater than 2000, it will automatically switch back to using cpu decoding.
...
* [thumbfast](https://github.com/po5/thumbfast) ⭐ 1,699 | 🐛 56 | 🌐 Lua | 📅 2026-08-12 - High-performance on-the-fly thumbnailer for mpv.
...
* [gallery-dl\_hook](https://github.com/jgreco/mpv-scripts/blob/master/gallery-dl_hook.lua) ⭐ 46 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Load online image galleries (imgur, etc) as playlists using [gallery-dl](https://github.com/mikf/gallery-dl/) ⭐ 19,814 | 🐛 1,135 | 🌐 Python | 📅 2026-09-19.
...
* [youtube-chat](https://github.com/BanchouBoo/mpv-youtube-chat) ⭐ 59 | 🐛 6 | 🌐 Lua | 📅 2024-06-08 - Overlays YouTube chat on top of a video using yt-dlp.
...
* [ontop-playback](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/ontop-playback.lua) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23 - Disables the ontop property when pausing, and enables it again when unpausing the video, if it was disabled. Change it only when the player is not in fullscreen to prevent screen flickering.
* [pause-when-minimize](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/pause-when-minimize.lua) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23 - Pauses the player video when minimizing, and unpauses it when brought up again.
* [single-instance](https://github.com/mpv-player/mpv/issues/43#issuecomment-2496083283) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23 - Reuse the existing mpv window when opening new files rather than spawning a new window.
* [local-language](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/local-language.lua) ⭐ 1,433 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - Let the text displayed by osd become the language you are most familiar with, that is, language localization, such as 【volume: 100%】 becomes 【音量:100%】.
* [SmartCopyPaste-3.0](https://github.com/Eisa01/mpv-scripts#smartcopypaste) ⭐ 843 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Powerful copy paste features. Paste URL or local videos directly to mpv. Copy URL or currently playing video in mpv player then paste to access at a later time. Add videos to playlist simply by pasting. Much more explained in the link above.
* [SmartCopyPaste-II-3.0](https://github.com/Eisa01/mpv-scripts#smartcopypaste_ii) ⭐ 843 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Powerful copy paste and clipboard list features using a log file. Select, filter, and search from your clipboard list. Paste URL or local videos directly to mpv. Copy URL or currently playing video in mpv player then paste to access at a later time. Paste to access previously copied times of same video. Much more explained in the link above.
...
* [jellyfin mpv shim](https://github.com/jellyfin/jellyfin-mpv-shim) ⭐ 2,420 | 🐛 204 | 🌐 Python | 📅 2026-09-22 - Jellyfin (Emby/Plex alternative) Client, based on Python.
...
* [Zabooby](https://github.com/Zabooby/mpv-config) ⭐ 570 | 🐛 0 | 🌐 GLSL | 📅 2026-08-13
...
* [Awan](https://github.com/Awan/cfg/tree/master/mpv/.config/mpv) ⭐ 37 | 🐛 0 | 🌐 Vim Script | 📅 2026-09-23
...
* [Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,425 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17 - A series of shaders designed to scale and enhance anime. Includes shaders for line sharpening, artefact removal, denoising, upscaling, and more.
...
* [vidcutter](https://github.com/ozmartian/vidcutter) ⭐ 1,989 | 🐛 297 | 🌐 Python | 📅 2025-04-24 - Cross-platform video cutter/joiner, based on Python/QT.
...
* <https://github.com/mpv-player/mpv/blob/master/TOOLS/umpv> ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23
* <https://github.com/davatorium/rofi> ⭐ 16,412 | 🐛 115 | 🌐 C | 📅 2026-09-17
* <https://github.com/Flow-Launcher/Flow.Launcher> ⭐ 15,619 | 🐛 309 | 🌐 C# | 📅 2026-09-23
* <https://github.com/ikas-mc/ContextMenuForWindows11> ⭐ 2,891 | 🐛 22 | 🌐 C# | 📅 2026-09-19
...
* [Compiling for Windows](https://github.com/mpv-player/mpv/blob/master/DOCS/compile-windows.md) ⭐ 37,087 | 🐛 1,157 | 🌐 C | 📅 2026-09-23
* [Building mpv and libmpv using wsl2 and Ubuntu](https://github.com/mpvnet-player/mpv.net/wiki/Building-mpv-and-libmpv-using-wsl2-and-Ubuntu) ⭐ 5,414 | 🐛 156 | 🌐 C# | 📅 2026-02-09
* [Media Auto Build Suite (MABS)](https://github.com/m-ab-s/media-autobuild_suite) ⭐ 1,824 | 🐛 219 | 🌐 Shell | 📅 2026-09-23
...
* [Kit](https://github.com/mpvkit/MPVKit) ⭐ 201 | 🐛 10 | 🌐 Swift | 📅 2026-09-21 - MPVKit is a collection of tools to use mpv in iOS, macOS, tvOS applications. It includes scripts to build mpv native libraries.
* [easy](https://github.com/mpv-easy/mpv-easy) ⭐ 137 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-23 - TS and React GUI toolkit for mpv script.
...
* [Memento](https://github.com/ripose-jp/Memento) ⭐ 1,482 | 🐛 27 | 🌐 C++ | 📅 2026-08-24 - Cross-platform video player for studying Japanese, based on C++/QT.
