...
* [SMPlayer](https://github.com/smplayer-dev/smplayer) ⭐ 1,060 | 🐛 77 | 🌐 C++ | 📅 2026-09-16 - Based on C++/QT.
...
* [mpv.net](https://github.com/mpvnet-player/mpv.net) ⭐ 5,418 | 🐛 156 | 🌐 C# | 📅 2026-02-09 - Based on C#/WinForms/WPF.
* [MPV-EASY Player](https://github.com/422658476/MPV-EASY-Player) ⭐ 1,438 | 🐛 1 | 🌐 Lua | 📅 2026-09-06
* [mpc-qt](https://github.com/mpc-qt/mpc-qt) ⭐ 1,098 | 🐛 117 | 🌐 C++ | 📅 2026-09-22 - Based on C++/QT.
...
* [android](https://github.com/mpv-android/mpv-android) ⭐ 3,590 | 🐛 163 | 🌐 Kotlin | 📅 2026-09-17 - Player for Android, based on Kotlin.
* [Kt](https://github.com/abdallahmehiz/mpvKt) ⚠️ Archived - Player for Android, based on Kotlin.

# Installation/Download

* [shinchiro GitHub](https://github.com/shinchiro/mpv-winbuild-cmake) ⭐ 1,768 | 🐛 61 | 🌐 CMake | 📅 2026-09-25 - Daily Windows builds of mpv and libmpv. This is the most popular choice on Windows.
* [zhongfly](https://github.com/zhongfly/mpv-winbuild) ⭐ 929 | 🐛 0 | 🌐 Shell | 📅 2026-09-25 - Windows builds of mpv and libmpv. This choice is very similar to `shinchiro GitHub`, so it's also a recommendation.
* [mpsm](https://github.com/mpv-easy/mpv-easy/tree/main/mpv-mpsm) ⭐ 138 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-23 - mpsm is a mpv script manager, you can install scripts provided by [mpsm-scripts](https://github.com/mpv-easy/mpsm-scripts) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-23, or install any script with added [meta info](https://github.com/mpv-easy/mpsm-scripts?tab=readme-ov-file#meta-info) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-23 via url.
* [mitzsch](https://github.com/mitzsch/mpv-winbuild) ⭐ 29 | 🐛 0 | 🌐 Shell | 📅 2026-08-08 - Windows builds of mpv and libmpv.
* [Andarwinux](https://github.com/Andarwinux/mpv-winbuild) ⭐ 23 | 🐛 3 | 🌐 Shell | 📅 2026-09-25 - Daily Windows builds of mpv and libmpv including ARM64 architecture.
...
* [Wiki](https://github.com/mpv-player/mpv/wiki) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23
...
* <https://github.com/mpv-player/mpv/issues> ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23
* <https://github.com/mpv-player/mpv/discussions> ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23
...
in the [wiki](https://github.com/mpv-player/mpv/wiki/User-Scripts) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23,
the advantage of the following list is that everything is categorized
into popular sections, like Subtitles etc.

## Menu

* [select](https://github.com/mpv-player/mpv/blob/master/player/lua/select.lua) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23 - Menu script built into mpv.
...
* [search-menu](https://github.com/stax76/mpv-scripts) ⭐ 230 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Searchable and configurable menu to quickly find key bindings, commands, properties, audio/subtitle tracks and playlist entries.
...
* [mpvc-tui](https://github.com/gmt4/mpvc) ⭐ 160 | 🐛 1 | 🌐 Shell | 📅 2026-09-25 - Command-line and TUI for mpv.
...
* [betterchapters](https://gist.github.com/Hakkin/4f978a5c87c31f7fe3ae) ([update](https://github.com/mpv-player/mpv/issues/4738#issuecomment-321298846) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23) - Loads the next or previous playlist entry if there are no more chapters in the seek direction.
* [autoload](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autoload.lua) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23 - Automatically load playlist entries before and after the currently playing file, by scanning the directory. **Obsolete:** mpv now has a native `--autocreate-playlist` option.
* [print-playlist](https://git.sr.ht/~jagrg/dotfiles/tree/master/item/common/.config/mpv/scripts/print-playlist.lua) - Cleans [the playlist formatting](https://github.com/mpv-player/mpv/issues/5868#issue-327675880) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23 on the terminal.
...
* [pause-indicator-lite](https://github.com/Samillion/ModernZ/tree/main/extras/pause-indicator-lite) ⭐ 1,252 | 🐛 27 | 🌐 Lua | 📅 2026-06-04 - A simple script that displays an indicator on pause, with options to adjust icon, color, height, width, opacity and whether to toggle pause with a keybind or not.
...
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 230 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Navigate in playlist to next/previous/first/last file.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 230 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Jump to a random position in the playlist.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 230 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Load or append files/URLs from clipboard.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 230 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Cycle audio and subtitle tracks, include only languages you know.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 230 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Show detailed media info on screen.
...
* [chapters\_for\_mpv](https://github.com/mar04/chapters_for_mpv) ⭐ 83 | 🐛 5 | 🌐 Lua | 📅 2025-01-29 - Add, remove and edit chapters of the currently played media. Chapters you create can be saved into a separate text file and automatically loaded when you open the same media file again.
...
* [file-browser](https://github.com/CogentRedTester/mpv-file-browser) ⭐ 331 | 🐛 5 | 🌐 Lua | 📅 2026-09-24 - On screen file browser.
* [delete-current-file](https://github.com/stax76/mpv-scripts) ⭐ 230 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Moves the current file instantly to the recycle bin.
...
* [ModernZ](https://github.com/Samillion/ModernZ) ⭐ 1,252 | 🐛 27 | 🌐 Lua | 📅 2026-06-04 - A fork of ModernX designed to enhance functionality by adding more features, all while preserving the core standards of mpv's OSC.
...
* [sub-pause](https://github.com/Ben-Kerman/mpv-sub-scripts) ⭐ 94 | 🐛 7 | 🌐 Lua | 📅 2024-07-11 - Automatically pause just before the end of each subtitle line. Also allows replaying the currently active line.
* [sub-skip](https://github.com/Ben-Kerman/mpv-sub-scripts) ⭐ 94 | 🐛 7 | 🌐 Lua | 📅 2024-07-11 - Automatically skip parts of a video that don't contain any subtitles. Does so by either fast-forwarding or seeking.
...
* [acompressor](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/acompressor.lua) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23 - Dynamic range compressor using acompressor ffmpeg filter with controls to dynamically adjust parameters.
...
* [youtube-upnext](https://github.com/cvzi/mpv-youtube-upnext) ⭐ 80 | 🐛 7 | 🌐 Lua | 📅 2026-07-20 - A menu for (auto) playing YouTube's "up next"/recommended videos, that show up on the right side on the website.
...
* [torrserver](https://github.com/kritma/mpv-torrserver) ⭐ 9 | 🐛 0 | 🌐 Lua | 📅 2024-02-05 - Allows streaming torrents using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,066 | 🐛 31 | 🌐 Go | 📅 2026-09-23. Support magnet links and .torrent files
...
* [torrserver-hook](https://github.com/eNV25/mpv-torrserver-hook) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-06-07 - Allows for playback of media from the BitTorrent network using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,066 | 🐛 31 | 🌐 Go | 📅 2026-09-23.
...
* [autocrop](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autocrop.lua) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23 - Automatically crop the video by using lavfi's cropdetect filter to detect black bars.
* [autodeint](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autodeint.lua) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23 - Automatically deinterlace the video by using lavfi's idet filter to detect interlaced content.
* [cycle-deinterlace-pullup](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/cycle-deinterlace-pullup.lua) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23 - Cycle between deinterlacing, pullup (IVTC), and both filters off.
...
* [mpv360](https://github.com/kasper93/mpv360) ⭐ 80 | 🐛 3 | 🌐 Lua | 📅 2026-01-30 - Interactive 360° Video Viewer. With full camera control through mouse and keyboard inputs.
...
* [thumbfast](https://github.com/po5/thumbfast) ⭐ 1,701 | 🐛 56 | 🌐 Lua | 📅 2026-08-12 - High-performance on-the-fly thumbnailer for mpv.
...
* [gallery-dl\_hook](https://github.com/jgreco/mpv-scripts/blob/master/gallery-dl_hook.lua) ⭐ 46 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Load online image galleries (imgur, etc) as playlists using [gallery-dl](https://github.com/mikf/gallery-dl/) ⭐ 19,834 | 🐛 1,138 | 🌐 Python | 📅 2026-09-19.
...
* [youtube-chat](https://github.com/BanchouBoo/mpv-youtube-chat) ⭐ 59 | 🐛 4 | 🌐 Lua | 📅 2024-06-08 - Overlays YouTube chat on top of a video using yt-dlp.
...
* [ontop-playback](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/ontop-playback.lua) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23 - Disables the ontop property when pausing, and enables it again when unpausing the video, if it was disabled. Change it only when the player is not in fullscreen to prevent screen flickering.
* [pause-when-minimize](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/pause-when-minimize.lua) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23 - Pauses the player video when minimizing, and unpauses it when brought up again.
* [single-instance](https://github.com/mpv-player/mpv/issues/43#issuecomment-2496083283) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23 - Reuse the existing mpv window when opening new files rather than spawning a new window.
...
* [jellyfin mpv shim](https://github.com/jellyfin/jellyfin-mpv-shim) ⭐ 2,427 | 🐛 209 | 🌐 Python | 📅 2026-09-25 - Jellyfin (Emby/Plex alternative) Client, based on Python.
...
* [dyphire](https://github.com/dyphire/mpv-config) ⭐ 1,890 | 🐛 8 | 🌐 GLSL | 📅 2026-08-26
...
* [Awan](https://github.com/Awan/cfg/tree/master/mpv/.config/mpv) ⭐ 37 | 🐛 0 | 🌐 Vim Script | 📅 2026-09-25
...
* [KikoPlay](https://github.com/KikoPlayProject/KikoPlay) ⭐ 2,235 | 🐛 9 | 🌐 C++ | 📅 2026-09-19 - Cross-platform [Danmu](https://en.wikipedia.org/wiki/Danmu) player, based on C++/QT.
...
* [Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,429 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17 - A series of shaders designed to scale and enhance anime. Includes shaders for line sharpening, artefact removal, denoising, upscaling, and more.
...
* <https://github.com/mpv-player/mpv/blob/master/TOOLS/umpv> ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23
* <https://github.com/davatorium/rofi> ⭐ 16,416 | 🐛 114 | 🌐 C | 📅 2026-09-25
* <https://github.com/Flow-Launcher/Flow.Launcher> ⭐ 15,635 | 🐛 311 | 🌐 C# | 📅 2026-09-23
* <https://github.com/ikas-mc/ContextMenuForWindows11> ⭐ 2,896 | 🐛 22 | 🌐 C# | 📅 2026-09-19
...
* [Compiling for Windows](https://github.com/mpv-player/mpv/blob/master/DOCS/compile-windows.md) ⭐ 37,117 | 🐛 1,161 | 🌐 C | 📅 2026-09-23
* [Building mpv and libmpv using wsl2 and Ubuntu](https://github.com/mpvnet-player/mpv.net/wiki/Building-mpv-and-libmpv-using-wsl2-and-Ubuntu) ⭐ 5,418 | 🐛 156 | 🌐 C# | 📅 2026-02-09
* [Media Auto Build Suite (MABS)](https://github.com/m-ab-s/media-autobuild_suite) ⭐ 1,824 | 🐛 202 | 🌐 Shell | 📅 2026-09-24
...
* [easy](https://github.com/mpv-easy/mpv-easy) ⭐ 138 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-23 - TS and React GUI toolkit for mpv script.
