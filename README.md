...
* [SMPlayer](https://github.com/smplayer-dev/smplayer) ⭐ 1,045 | 🐛 81 | 🌐 C++ | 📅 2026-09-08 - Based on C++/QT.
...
* [mpv.net](https://github.com/mpvnet-player/mpv.net) ⭐ 5,381 | 🐛 156 | 🌐 C# | 📅 2026-02-09 - Based on C#/WinForms/WPF.
* [MPV-EASY Player](https://github.com/422658476/MPV-EASY-Player) ⭐ 1,430 | 🐛 1 | 🌐 Lua | 📅 2026-09-06
* [mpc-qt](https://github.com/mpc-qt/mpc-qt) ⭐ 1,080 | 🐛 110 | 🌐 C++ | 📅 2026-09-08 - Based on C++/QT.
...
* [android](https://github.com/mpv-android/mpv-android) ⭐ 3,533 | 🐛 163 | 🌐 Kotlin | 📅 2026-09-04 - Player for Android, based on Kotlin.
* [Kt](https://github.com/abdallahmehiz/mpvKt) ⚠️ Archived - Player for Android, based on Kotlin.

# Installation/Download

* [shinchiro GitHub](https://github.com/shinchiro/mpv-winbuild-cmake) ⭐ 1,741 | 🐛 60 | 🌐 CMake | 📅 2026-09-03 - Daily Windows builds of mpv and libmpv. This is the most popular choice on Windows.
* [zhongfly](https://github.com/zhongfly/mpv-winbuild) ⭐ 908 | 🐛 0 | 🌐 Shell | 📅 2026-09-08 - Windows builds of mpv and libmpv. This choice is very similar to `shinchiro GitHub`, so it's also a recommendation.
* [mpsm](https://github.com/mpv-easy/mpv-easy/tree/main/mpv-mpsm) ⭐ 138 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-07 - mpsm is a mpv script manager, you can install scripts provided by [mpsm-scripts](https://github.com/mpv-easy/mpsm-scripts) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-07, or install any script with added [meta info](https://github.com/mpv-easy/mpsm-scripts?tab=readme-ov-file#meta-info) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-07 via url.
* [mitzsch](https://github.com/mitzsch/mpv-winbuild) ⭐ 29 | 🐛 0 | 🌐 Shell | 📅 2026-08-08 - Windows builds of mpv and libmpv.
* [Andarwinux](https://github.com/Andarwinux/mpv-winbuild) ⭐ 23 | 🐛 3 | 🌐 Shell | 📅 2026-09-08 - Daily Windows builds of mpv and libmpv including ARM64 architecture.
...
* [Wiki](https://github.com/mpv-player/mpv/wiki) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08
...
* <https://github.com/mpv-player/mpv/issues> ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08
* <https://github.com/mpv-player/mpv/discussions> ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08
...
in the [wiki](https://github.com/mpv-player/mpv/wiki/User-Scripts) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08,
the advantage of the following list is that everything is categorized
into popular sections, like Subtitles etc.

## Menu

* [select](https://github.com/mpv-player/mpv/blob/master/player/lua/select.lua) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08 - Menu script built into mpv.
* [uosc](https://github.com/tomasklaen/uosc) ⭐ 3,377 | 🐛 35 | 🌐 Lua | 📅 2026-08-30 - Popular OSC with menu.
...
* [mpvc-tui](https://github.com/gmt4/mpvc) ⭐ 158 | 🐛 1 | 🌐 Shell | 📅 2026-09-08 - Command-line and TUI for mpv.
...
* [betterchapters](https://gist.github.com/Hakkin/4f978a5c87c31f7fe3ae) ([update](https://github.com/mpv-player/mpv/issues/4738#issuecomment-321298846) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08) - Loads the next or previous playlist entry if there are no more chapters in the seek direction.
* [autoload](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autoload.lua) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08 - Automatically load playlist entries before and after the currently playing file, by scanning the directory. **Obsolete:** mpv now has a native `--autocreate-playlist` option.
* [print-playlist](https://git.sr.ht/~jagrg/dotfiles/tree/master/item/common/.config/mpv/scripts/print-playlist.lua) - Cleans [the playlist formatting](https://github.com/mpv-player/mpv/issues/5868#issue-327675880) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08 on the terminal.
...
* [pause-indicator-lite](https://github.com/Samillion/ModernZ/tree/main/extras/pause-indicator-lite) ⭐ 1,218 | 🐛 25 | 🌐 Lua | 📅 2026-06-04 - A simple script that displays an indicator on pause, with options to adjust icon, color, height, width, opacity and whether to toggle pause with a keybind or not.
...
* [autoloop](https://github.com/zc62/mpv-scripts/blob/master/autoloop.lua) ⭐ 42 | 🐛 0 | 🌐 Lua | 📅 2020-08-28 - Automatically loops files that are under a given duration (default 5 seconds).
...
* [guess-media-title](https://github.com/zenwarr/mpv-config/blob/master/scripts/guess-media-title.lua) ⭐ 35 | 🐛 3 | 🌐 Lua | 📅 2025-11-16 - Uses [guessit](https://github.com/guessit-io/guessit) ⭐ 933 | 🐛 17 | 🌐 Python | 📅 2026-08-09 to detect a media title by filename and set `force-media-title` variable. Useful for getting cleaner screenshot file names.
...
* [ModernZ](https://github.com/Samillion/ModernZ) ⭐ 1,218 | 🐛 25 | 🌐 Lua | 📅 2026-06-04 - A fork of ModernX designed to enhance functionality by adding more features, all while preserving the core standards of mpv's OSC.

* [ModernX cyl0](https://github.com/cyl0/ModernX) ⭐ 760 | 🐛 20 | 🌐 Lua | 📅 2026-02-04 - Modern OSC replacement.
...
* [ModernX zydezu](https://github.com/zydezu/ModernX) ⭐ 294 | 🐛 4 | 🌐 Lua | 📅 2026-08-11 - A fork of ModernX with many additional features and customization.
...
* [save-sub-delay](https://github.com/zc62/mpv-scripts/blob/master/save-sub-delay.lua) ⭐ 42 | 🐛 0 | 🌐 Lua | 📅 2020-08-28 - This script saves the sub-delay quantity for each file. When next time the file is opened, sub-delay is automatically restored.
...
* [mpvacious](https://github.com/Ajatt-Tools/mpvacious) ⭐ 884 | 🐛 12 | 🌐 Lua | 📅 2026-09-04 - Add keybindings to create Anki flashcards for (language) learning.
...
* [acompressor](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/acompressor.lua) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08 - Dynamic range compressor using acompressor ffmpeg filter with controls to dynamically adjust parameters.
...
* [autocrop](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autocrop.lua) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08 - Automatically crop the video by using lavfi's cropdetect filter to detect black bars.
* [autodeint](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autodeint.lua) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08 - Automatically deinterlace the video by using lavfi's idet filter to detect interlaced content.
* [cycle-deinterlace-pullup](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/cycle-deinterlace-pullup.lua) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08 - Cycle between deinterlacing, pullup (IVTC), and both filters off.
...
* [gallery-dl\_hook](https://github.com/jgreco/mpv-scripts/blob/master/gallery-dl_hook.lua) ⭐ 46 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Load online image galleries (imgur, etc) as playlists using [gallery-dl](https://github.com/mikf/gallery-dl/) ⭐ 19,447 | 🐛 1,138 | 🌐 Python | 📅 2026-09-04.
* [screenshot-to-clipboard](https://github.com/zc62/mpv-scripts/blob/master/screenshot-to-clipboard.js) ⭐ 42 | 🐛 0 | 🌐 Lua | 📅 2020-08-28 - Takes a screenshot and saves it to the clipboard.
...
* [ontop-playback](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/ontop-playback.lua) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08 - Disables the ontop property when pausing, and enables it again when unpausing the video, if it was disabled. Change it only when the player is not in fullscreen to prevent screen flickering.
* [pause-when-minimize](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/pause-when-minimize.lua) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08 - Pauses the player video when minimizing, and unpauses it when brought up again.
* [single-instance](https://github.com/mpv-player/mpv/issues/43#issuecomment-2496083283) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08 - Reuse the existing mpv window when opening new files rather than spawning a new window.
...
* [exit-fullscreen](https://github.com/zc62/mpv-scripts/blob/master/exit-fullscreen.lua) ⭐ 42 | 🐛 0 | 🌐 Lua | 📅 2020-08-28 - If you use `--keep-open=yes`, this script exits fullscreen mode when the playback reaches the end of file/playlist.
...
* [jellyfin mpv shim](https://github.com/jellyfin/jellyfin-mpv-shim) ⭐ 2,363 | 🐛 188 | 🌐 Python | 📅 2026-09-08 - Jellyfin (Emby/Plex alternative) Client, based on Python.
...
* [dyphire](https://github.com/dyphire/mpv-config) ⭐ 1,874 | 🐛 8 | 🌐 GLSL | 📅 2026-08-26
* [Zabooby](https://github.com/Zabooby/mpv-config) ⭐ 568 | 🐛 0 | 🌐 GLSL | 📅 2026-08-13
...
* [Awan](https://github.com/Awan/cfg/tree/master/mpv/.config/mpv) ⭐ 37 | 🐛 0 | 🌐 Vim Script | 📅 2026-09-08
...
* [KikoPlay](https://github.com/KikoPlayProject/KikoPlay) ⭐ 2,228 | 🐛 9 | 🌐 C++ | 📅 2026-09-06 - Cross-platform [Danmu](https://en.wikipedia.org/wiki/Danmu) player, based on C++/QT.
...
* [Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,371 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17 - A series of shaders designed to scale and enhance anime. Includes shaders for line sharpening, artefact removal, denoising, upscaling, and more.
* [FSRCNN](https://github.com/igv/FSRCNN-TensorFlow/releases) ⭐ 504 | 🐛 0 | 🌐 Python | 📅 2021-04-12 - Prescaler based on layered convolutional networks.
...
* [AniSD ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/AniSD-ArtCNN) ⭐ 362 | 🐛 5 | 📅 2025-06-08 - AniSD ArtCNN shader for standard definition anime content.
* [Ani4K v2 ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/Ani4k-v2-ArtCNN) ⭐ 362 | 🐛 5 | 📅 2025-06-08 - Ani4K shader v2 targets modern anime, from high quality Bluray to crappy WEB releases, for upscaling to either 2K or 4K.
* [hdr-toys](https://github.com/natural-harmonia-gropius/hdr-toys) ⭐ 194 | 🐛 19 | 🌐 GLSL | 📅 2026-09-04 - Componentized Rec.2100 to Rec.709 conversion shader.
...
* [qimgv](https://github.com/easymodo/qimgv) ⭐ 3,119 | 🐛 308 | 🌐 C++ | 📅 2026-01-19 - Cross-platform, based on C++/QT.

# Launcher

* <https://github.com/mpv-player/mpv/blob/master/TOOLS/umpv> ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08
* <https://github.com/davatorium/rofi> ⭐ 16,374 | 🐛 115 | 🌐 C | 📅 2026-09-06
* <https://github.com/Flow-Launcher/Flow.Launcher> ⭐ 15,523 | 🐛 304 | 🌐 C# | 📅 2026-09-06
* <https://github.com/ikas-mc/ContextMenuForWindows11> ⭐ 2,878 | 🐛 21 | 🌐 C# | 📅 2026-08-31
...
* [Compiling for Windows](https://github.com/mpv-player/mpv/blob/master/DOCS/compile-windows.md) ⭐ 36,904 | 🐛 1,144 | 🌐 C | 📅 2026-09-08
* [Building mpv and libmpv using wsl2 and Ubuntu](https://github.com/mpvnet-player/mpv.net/wiki/Building-mpv-and-libmpv-using-wsl2-and-Ubuntu) ⭐ 5,381 | 🐛 156 | 🌐 C# | 📅 2026-02-09
* [Media Auto Build Suite (MABS)](https://github.com/m-ab-s/media-autobuild_suite) ⭐ 1,820 | 🐛 220 | 🌐 Shell | 📅 2026-09-08
* [Helper scripts to compile mpv on Linux](https://github.com/mpv-player/mpv-build) ⭐ 490 | 🐛 10 | 🌐 Shell | 📅 2025-11-02
...
* [easy](https://github.com/mpv-easy/mpv-easy) ⭐ 138 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-07 - TS and React GUI toolkit for mpv script.
* [object pascal](https://github.com/URUWorks/UW_MPVPlayer) ⭐ 28 | 🐛 2 | 🌐 Pascal | 📅 2026-07-01 - Embeddable player for Object Pascal.
...
* [Memento](https://github.com/ripose-jp/Memento) ⭐ 1,479 | 🐛 26 | 🌐 C++ | 📅 2026-08-24 - Cross-platform video player for studying Japanese, based on C++/QT.
...
* [mpvQC](https://github.com/mpvqc/mpvQC) ⭐ 79 | 🐛 6 | 🌐 Python | 📅 2026-09-08 - Cross-platform application for quality control of videos, based on Python/QT.
