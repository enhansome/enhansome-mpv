...
* [SMPlayer](https://github.com/smplayer-dev/smplayer) ⭐ 1,059 | 🐛 77 | 🌐 C++ | 📅 2026-09-26 - Based on C++/QT.
...
* [mpv.net](https://github.com/mpvnet-player/mpv.net) ⭐ 5,419 | 🐛 156 | 🌐 C# | 📅 2026-02-09 - Based on C#/WinForms/WPF.
* [MPV-EASY Player](https://github.com/422658476/MPV-EASY-Player) ⭐ 1,438 | 🐛 1 | 🌐 Lua | 📅 2026-09-06
* [mpc-qt](https://github.com/mpc-qt/mpc-qt) ⭐ 1,099 | 🐛 117 | 🌐 C++ | 📅 2026-09-22 - Based on C++/QT.
...
* [android](https://github.com/mpv-android/mpv-android) ⭐ 3,592 | 🐛 163 | 🌐 Kotlin | 📅 2026-09-26 - Player for Android, based on Kotlin.
* [Kt](https://github.com/abdallahmehiz/mpvKt) ⚠️ Archived - Player for Android, based on Kotlin.

# Installation/Download

* [shinchiro GitHub](https://github.com/shinchiro/mpv-winbuild-cmake) ⭐ 1,769 | 🐛 61 | 🌐 CMake | 📅 2026-09-26 - Daily Windows builds of mpv and libmpv. This is the most popular choice on Windows.
* [zhongfly](https://github.com/zhongfly/mpv-winbuild) ⭐ 930 | 🐛 0 | 🌐 Shell | 📅 2026-09-26 - Windows builds of mpv and libmpv. This choice is very similar to `shinchiro GitHub`, so it's also a recommendation.
...
* [Andarwinux](https://github.com/Andarwinux/mpv-winbuild) ⭐ 23 | 🐛 3 | 🌐 Shell | 📅 2026-09-26 - Daily Windows builds of mpv and libmpv including ARM64 architecture.
...
* [Wiki](https://github.com/mpv-player/mpv/wiki) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26
...
* <https://github.com/mpv-player/mpv/issues> ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26
* <https://github.com/mpv-player/mpv/discussions> ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26
...
in the [wiki](https://github.com/mpv-player/mpv/wiki/User-Scripts) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26,
the advantage of the following list is that everything is categorized
into popular sections, like Subtitles etc.

## Menu

* [select](https://github.com/mpv-player/mpv/blob/master/player/lua/select.lua) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26 - Menu script built into mpv.
* [uosc](https://github.com/tomasklaen/uosc) ⭐ 3,416 | 🐛 34 | 🌐 Lua | 📅 2026-08-30 - Popular OSC with menu.
...
* [mpvc-tui](https://github.com/gmt4/mpvc) ⭐ 160 | 🐛 1 | 🌐 Shell | 📅 2026-09-26 - Command-line and TUI for mpv.
...
* [betterchapters](https://gist.github.com/Hakkin/4f978a5c87c31f7fe3ae) ([update](https://github.com/mpv-player/mpv/issues/4738#issuecomment-321298846) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26) - Loads the next or previous playlist entry if there are no more chapters in the seek direction.
* [autoload](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autoload.lua) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26 - Automatically load playlist entries before and after the currently playing file, by scanning the directory. **Obsolete:** mpv now has a native `--autocreate-playlist` option.
* [print-playlist](https://git.sr.ht/~jagrg/dotfiles/tree/master/item/common/.config/mpv/scripts/print-playlist.lua) - Cleans [the playlist formatting](https://github.com/mpv-player/mpv/issues/5868#issue-327675880) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26 on the terminal.
...
* [pause-indicator-lite](https://github.com/Samillion/ModernZ/tree/main/extras/pause-indicator-lite) ⭐ 1,254 | 🐛 27 | 🌐 Lua | 📅 2026-06-04 - A simple script that displays an indicator on pause, with options to adjust icon, color, height, width, opacity and whether to toggle pause with a keybind or not.
...
* [ModernZ](https://github.com/Samillion/ModernZ) ⭐ 1,254 | 🐛 27 | 🌐 Lua | 📅 2026-06-04 - A fork of ModernX designed to enhance functionality by adding more features, all while preserving the core standards of mpv's OSC.
...
* [acompressor](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/acompressor.lua) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26 - Dynamic range compressor using acompressor ffmpeg filter with controls to dynamically adjust parameters.
...
* [torrserver](https://github.com/kritma/mpv-torrserver) ⭐ 9 | 🐛 0 | 🌐 Lua | 📅 2024-02-05 - Allows streaming torrents using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,069 | 🐛 33 | 🌐 Go | 📅 2026-09-23. Support magnet links and .torrent files
...
* [torrserver-hook](https://github.com/eNV25/mpv-torrserver-hook) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-06-07 - Allows for playback of media from the BitTorrent network using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,069 | 🐛 33 | 🌐 Go | 📅 2026-09-23.
...
* [autocrop](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autocrop.lua) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26 - Automatically crop the video by using lavfi's cropdetect filter to detect black bars.
* [autodeint](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autodeint.lua) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26 - Automatically deinterlace the video by using lavfi's idet filter to detect interlaced content.
* [cycle-deinterlace-pullup](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/cycle-deinterlace-pullup.lua) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26 - Cycle between deinterlacing, pullup (IVTC), and both filters off.
...
* [thumbfast](https://github.com/po5/thumbfast) ⭐ 1,703 | 🐛 56 | 🌐 Lua | 📅 2026-08-12 - High-performance on-the-fly thumbnailer for mpv.
...
* [gallery-dl\_hook](https://github.com/jgreco/mpv-scripts/blob/master/gallery-dl_hook.lua) ⭐ 46 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Load online image galleries (imgur, etc) as playlists using [gallery-dl](https://github.com/mikf/gallery-dl/) ⭐ 19,848 | 🐛 1,135 | 🌐 Python | 📅 2026-09-19.
...
* [image-config](https://github.com/guidocella/mpv-image-config) ⭐ 35 | 🐛 0 | 🌐 Lua | 📅 2026-09-26 - A configuration to use mpv as an image viewer.
...
* [ontop-playback](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/ontop-playback.lua) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26 - Disables the ontop property when pausing, and enables it again when unpausing the video, if it was disabled. Change it only when the player is not in fullscreen to prevent screen flickering.
* [pause-when-minimize](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/pause-when-minimize.lua) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26 - Pauses the player video when minimizing, and unpauses it when brought up again.
* [single-instance](https://github.com/mpv-player/mpv/issues/43#issuecomment-2496083283) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26 - Reuse the existing mpv window when opening new files rather than spawning a new window.
...
* [anilist-updater](https://github.com/AzuredBlue/mpv-anilist-updater) ⭐ 41 | 🐛 0 | 🌐 Python | 📅 2026-09-26 - Automatically updates your AniList when reaching 80% completion based on the file name.
...
* [lua-repl](https://github.com/guidocella/mpv-lua-repl) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2026-02-26 - A Lua REPL in the console with autocompletion and pretty-printing of returned tables. It lets you test mpv's and Lua's API without writing a script.
...
* [Olivia](https://github.com/keshavbhatt/olivia) ⭐ 378 | 🐛 22 | 🌐 C++ | 📅 2022-10-19 - Linux cloud music player, based on C++/QT/Web.
...
* [jellyfin mpv shim](https://github.com/jellyfin/jellyfin-mpv-shim) ⭐ 2,432 | 🐛 210 | 🌐 Python | 📅 2026-09-26 - Jellyfin (Emby/Plex alternative) Client, based on Python.
...
* [Zabooby](https://github.com/Zabooby/mpv-config) ⭐ 572 | 🐛 0 | 🌐 GLSL | 📅 2026-08-13
...
* [Awan](https://github.com/Awan/cfg/tree/master/mpv/.config/mpv) ⭐ 37 | 🐛 0 | 🌐 Vim Script | 📅 2026-09-26
...
* [Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,432 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17 - A series of shaders designed to scale and enhance anime. Includes shaders for line sharpening, artefact removal, denoising, upscaling, and more.
...
* <https://github.com/mpv-player/mpv/blob/master/TOOLS/umpv> ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26
* <https://github.com/davatorium/rofi> ⭐ 16,421 | 🐛 115 | 🌐 C | 📅 2026-09-25
* <https://github.com/Flow-Launcher/Flow.Launcher> ⭐ 15,650 | 🐛 312 | 🌐 C# | 📅 2026-09-23
...
* [Compiling for Windows](https://github.com/mpv-player/mpv/blob/master/DOCS/compile-windows.md) ⭐ 37,127 | 🐛 1,159 | 🌐 C | 📅 2026-09-26
* [Building mpv and libmpv using wsl2 and Ubuntu](https://github.com/mpvnet-player/mpv.net/wiki/Building-mpv-and-libmpv-using-wsl2-and-Ubuntu) ⭐ 5,419 | 🐛 156 | 🌐 C# | 📅 2026-02-09
...
* [mpvQC](https://github.com/mpvqc/mpvQC) ⭐ 79 | 🐛 5 | 🌐 Python | 📅 2026-09-26 - Cross-platform application for quality control of videos, based on Python/QT.
