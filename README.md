...
* [SMPlayer](https://github.com/smplayer-dev/smplayer) ⭐ 1,053 | 🐛 78 | 🌐 C++ | 📅 2026-09-16 - Based on C++/QT.
* [ImPlay](https://github.com/tsl0922/ImPlay) ⭐ 784 | 🐛 24 | 🌐 C++ | 📅 2026-02-23 - Based on C++/imgui.
* [MoonPlayer](https://github.com/coslyk/moonplayer) ⭐ 683 | 🐛 43 | 🌐 C++ | 📅 2024-09-03 - Based on C++/QT/QML.
...
* [mpv.net](https://github.com/mpvnet-player/mpv.net) ⭐ 5,400 | 🐛 156 | 🌐 C# | 📅 2026-02-09 - Based on C#/WinForms/WPF.
* [MPV-EASY Player](https://github.com/422658476/MPV-EASY-Player) ⭐ 1,433 | 🐛 1 | 🌐 Lua | 📅 2026-09-06
* [mpc-qt](https://github.com/mpc-qt/mpc-qt) ⭐ 1,092 | 🐛 112 | 🌐 C++ | 📅 2026-09-16 - Based on C++/QT.
...
* [Kawaii Player](https://github.com/kanishka-linux/kawaii-player) ⭐ 712 | 🐛 17 | 🌐 Python | 📅 2026-09-16 - Player/Library/Server, based on Python/QT.
* [xt7-player-mpv](https://github.com/kokoko3k/xt7-player-mpv) ⭐ 105 | 🐛 2 | 🌐 Lua | 📅 2026-09-11 - Based on Gambas/QT.
* [Deepin Movie](https://github.com/linuxdeepin/deepin-movie-reborn) ⭐ 88 | 🐛 7 | 🌐 C++ | 📅 2026-09-17 - Unmaintained, based on C++/QT.
...
* [android](https://github.com/mpv-android/mpv-android) ⭐ 3,561 | 🐛 161 | 🌐 Kotlin | 📅 2026-09-17 - Player for Android, based on Kotlin.
* [Kt](https://github.com/abdallahmehiz/mpvKt) ⚠️ Archived - Player for Android, based on Kotlin.

# Installation/Download

* [shinchiro GitHub](https://github.com/shinchiro/mpv-winbuild-cmake) ⭐ 1,752 | 🐛 62 | 🌐 CMake | 📅 2026-09-03 - Daily Windows builds of mpv and libmpv. This is the most popular choice on Windows.
* [zhongfly](https://github.com/zhongfly/mpv-winbuild) ⭐ 917 | 🐛 0 | 🌐 Shell | 📅 2026-09-17 - Windows builds of mpv and libmpv. This choice is very similar to `shinchiro GitHub`, so it's also a recommendation.
* [mpsm](https://github.com/mpv-easy/mpv-easy/tree/main/mpv-mpsm) ⭐ 137 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-13 - mpsm is a mpv script manager, you can install scripts provided by [mpsm-scripts](https://github.com/mpv-easy/mpsm-scripts) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-13, or install any script with added [meta info](https://github.com/mpv-easy/mpsm-scripts?tab=readme-ov-file#meta-info) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-13 via url.
* [mitzsch](https://github.com/mitzsch/mpv-winbuild) ⭐ 29 | 🐛 0 | 🌐 Shell | 📅 2026-08-08 - Windows builds of mpv and libmpv.
* [Andarwinux](https://github.com/Andarwinux/mpv-winbuild) ⭐ 23 | 🐛 3 | 🌐 Shell | 📅 2026-09-17 - Daily Windows builds of mpv and libmpv including ARM64 architecture.
...
* [Wiki](https://github.com/mpv-player/mpv/wiki) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14
...
* <https://github.com/mpv-player/mpv/issues> ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14
* <https://github.com/mpv-player/mpv/discussions> ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14
...
in the [wiki](https://github.com/mpv-player/mpv/wiki/User-Scripts) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14,
the advantage of the following list is that everything is categorized
into popular sections, like Subtitles etc.

## Menu

* [select](https://github.com/mpv-player/mpv/blob/master/player/lua/select.lua) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14 - Menu script built into mpv.
* [uosc](https://github.com/tomasklaen/uosc) ⭐ 3,399 | 🐛 34 | 🌐 Lua | 📅 2026-08-30 - Popular OSC with menu.
...
* [menu-plugin](https://github.com/tsl0922/mpv-menu-plugin) ⭐ 206 | 🐛 10 | 🌐 C | 📅 2025-01-15 - Win32 context menu, file dialog, clipboard support for mpv on Windows.
* [dyn\_menu](https://github.com/tsl0922/mpv-menu-plugin/blob/main/src/lua/dyn_menu.lua) ⭐ 206 | 🐛 10 | 🌐 C | 📅 2025-01-15 - Context Menu with support for defining the context menu in input.conf.
* [mpvc-tui](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-17 - Command-line and TUI for mpv.
...
* [betterchapters](https://gist.github.com/Hakkin/4f978a5c87c31f7fe3ae) ([update](https://github.com/mpv-player/mpv/issues/4738#issuecomment-321298846) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14) - Loads the next or previous playlist entry if there are no more chapters in the seek direction.
* [autoload](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autoload.lua) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14 - Automatically load playlist entries before and after the currently playing file, by scanning the directory. **Obsolete:** mpv now has a native `--autocreate-playlist` option.
* [print-playlist](https://git.sr.ht/~jagrg/dotfiles/tree/master/item/common/.config/mpv/scripts/print-playlist.lua) - Cleans [the playlist formatting](https://github.com/mpv-player/mpv/issues/5868#issue-327675880) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14 on the terminal.
...
* [pause-indicator-lite](https://github.com/Samillion/ModernZ/tree/main/extras/pause-indicator-lite) ⭐ 1,230 | 🐛 26 | 🌐 Lua | 📅 2026-06-04 - A simple script that displays an indicator on pause, with options to adjust icon, color, height, width, opacity and whether to toggle pause with a keybind or not.
* [UndoRedo](https://github.com/Eisa01/mpv-scripts#undoredo) ⭐ 841 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Undo and Redo feature for mpv. If you seek/jump to a different time in the video, press undo \[ctrl]+\[z] to linearly undo the seeks/jumps in the video, and press redo \[ctrl]+\[y] to linearly return to previous undo positions. More details in the link above.
* [SimpleBookmark-1.0](https://github.com/Eisa01/mpv-scripts#simplebookmark) ⭐ 841 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Bookmark with a \[ctrl]+\[b], then list and access your bookmarks with \[b]. Assign your favorites to a keybind then access your favorites with that same keybind. Much more explained in the link above.
* [SimpleHistory-1.0](https://github.com/Eisa01/mpv-scripts#simplehistory) ⭐ 841 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Powerful history features that logs videos that you opened into a log file along with the time you have reached on each video. Select, filter, and search from your history list, Optional resume by \[ctrl]+\[r] for all videos you have played. Much more explained in the link above.
* [SimpleUndo-3.2](https://github.com/Eisa01/mpv-scripts#simpleundo) ⭐ 841 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Simple undo feature. If you accidentally seek/jump to a different time in the video, press undo \[ctrl]+\[z] to return to your previous time and vice-versa. More details in the link above.
* [SmartSkip](https://github.com/Eisa01/mpv-scripts/#smartskip) ⭐ 841 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Automatically or manually skip opening, intro, outro, and preview, like never before. Jump to next file, previous file, and save your chapter changes! Much more explained in the link above.
...
* [stats](https://github.com/Argon-/mpv-stats/) ⭐ 209 | 🐛 1 | 🌐 Lua | 📅 2018-12-09 - Display some statistics about the currently played file on-screen.
...
* [chapter-make-read](https://github.com/dyphire/mpv-scripts/blob/main/chapter-make-read.lua) ⭐ 125 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Automatically read an load the namesake external chapter file with extension of CHP. Temporarily mark the current playback position as a chapter so you can seek to it later. Also allows writing current chapters as CHP or XML. Based on `createchapter`.
* [track-list](https://github.com/dyphire/mpv-scripts/blob/main/track-list.lua) ⭐ 125 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Interractive track-list menu.
* [skiptosilence dyphire](https://github.com/dyphire/mpv-scripts/blob/main/skiptosilence.lua) ⭐ 125 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Skips to the next silence in the file.
* [memo](https://github.com/po5/memo) ⭐ 122 | 🐛 11 | 🌐 Lua | 📅 2024-11-01 - A recent files/history menu for mpv with optional uosc integration.
...
* [guess-media-title](https://github.com/zenwarr/mpv-config/blob/master/scripts/guess-media-title.lua) ⭐ 34 | 🐛 3 | 🌐 Lua | 📅 2025-11-16 - Uses [guessit](https://github.com/guessit-io/guessit) ⭐ 936 | 🐛 19 | 🌐 Python | 📅 2026-09-09 to detect a media title by filename and set `force-media-title` variable. Useful for getting cleaner screenshot file names.
...
* [file-browser](https://github.com/CogentRedTester/mpv-file-browser) ⭐ 331 | 🐛 4 | 🌐 Lua | 📅 2026-03-27 - On screen file browser.
...
* [ModernZ](https://github.com/Samillion/ModernZ) ⭐ 1,230 | 🐛 26 | 🌐 Lua | 📅 2026-06-04 - A fork of ModernX designed to enhance functionality by adding more features, all while preserving the core standards of mpv's OSC.

* [ModernX cyl0](https://github.com/cyl0/ModernX) ⭐ 762 | 🐛 20 | 🌐 Lua | 📅 2026-02-04 - Modern OSC replacement.

* [thumbnail\_script](https://github.com/TheAMM/mpv_thumbnail_script) ⭐ 712 | 🐛 57 | 🌐 Lua | 📅 2023-08-07 - Shows preview thumbnails in the seekbar.

* [osc-modern](https://github.com/maoiscat/mpv-osc-modern) ⭐ 430 | 🐛 15 | 🌐 Lua | 📅 2024-04-20 - Modern OSC replacement.
...
* [ModernX zydezu](https://github.com/zydezu/ModernX) ⭐ 298 | 🐛 4 | 🌐 Lua | 📅 2026-08-11 - A fork of ModernX with many additional features and customization.
...
* [modern-x-compact](https://github.com/1-minute-to-midnight/mpv-modern-x-compact) ⭐ 99 | 🐛 5 | 🌐 Lua | 📅 2024-08-10 - Compact version of modern-x.

* [osc-modern-f](https://github.com/FinnRaze/mpv-osc-modern-f) ⭐ 91 | 🐛 2 | 🌐 Lua | 📅 2024-09-17 - OSC script forked from [mpv-osc-modern](https://github.com/maoiscat/mpv-osc-modern) ⭐ 430 | 🐛 15 | 🌐 Lua | 📅 2024-04-20.
...
* [sub\_export](https://github.com/dyphire/mpv-scripts/blob/main/sub_export.lua) ⭐ 125 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - fork, updated. Extract selected subtitles from .mkv file.
* [whisper-subs](https://github.com/GhostNaN/whisper-subs) ⭐ 107 | 🐛 1 | 🌐 Lua | 📅 2025-02-09 - Generates subtitles at runtime with whisper.cpp on Linux.
...
* [sub-fastwhisper](https://github.com/dyphire/mpv-sub-fastwhisper) ⭐ 44 | 🐛 2 | 🌐 Lua | 📅 2026-05-30 - Generate SRT subtitles through voice transcription using faster-whisper.
...
* [acompressor](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/acompressor.lua) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14 - Dynamic range compressor using acompressor ffmpeg filter with controls to dynamically adjust parameters.
...
* [adevice-list](https://github.com/dyphire/mpv-scripts/blob/main/adevice-list.lua) ⭐ 125 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Interractive audio-device list menu.
...
* [sponsorblock](https://github.com/po5/mpv_sponsorblock) ⭐ 633 | 🐛 29 | 🌐 Lua | 📅 2024-05-01 - Script to skip sponsored segments of YouTube videos.
...
* [quality-menu](https://github.com/christoph-heinrich/mpv-quality-menu) ⭐ 237 | 🐛 3 | 🌐 Lua | 📅 2026-01-30 - Change the streamed video and audio quality (ytdl-format) on the fly.
...
* [torrserver](https://github.com/kritma/mpv-torrserver) ⭐ 9 | 🐛 0 | 🌐 Lua | 📅 2024-02-05 - Allows streaming torrents using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,042 | 🐛 24 | 🌐 Go | 📅 2026-09-17. Support magnet links and .torrent files
...
* [torrserver-hook](https://github.com/eNV25/mpv-torrserver-hook) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-06-07 - Allows for playback of media from the BitTorrent network using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,042 | 🐛 24 | 🌐 Go | 📅 2026-09-17.
...
* [autocrop](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autocrop.lua) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14 - Automatically crop the video by using lavfi's cropdetect filter to detect black bars.
* [autodeint](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autodeint.lua) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14 - Automatically deinterlace the video by using lavfi's idet filter to detect interlaced content.
* [cycle-deinterlace-pullup](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/cycle-deinterlace-pullup.lua) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14 - Cycle between deinterlacing, pullup (IVTC), and both filters off.
...
* [hdr-mode](https://github.com/dyphire/mpv-scripts/blob/main/hdr-mode.lua) ⭐ 125 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Automatically switches the display's SDR and HDR modes for HDR passthrough based on the content of the video being played.
...
* [thumbfast](https://github.com/po5/thumbfast) ⭐ 1,695 | 🐛 56 | 🌐 Lua | 📅 2026-08-12 - High-performance on-the-fly thumbnailer for mpv.
* [image-viewer](https://github.com/occivink/mpv-image-viewer) ⭐ 367 | 🐛 18 | 🌐 Lua | 📅 2024-11-23 - Configuration, scripts and tips for using mpv as an image viewer.
...
* [gallery-dl\_hook](https://github.com/jgreco/mpv-scripts/blob/master/gallery-dl_hook.lua) ⭐ 46 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Load online image galleries (imgur, etc) as playlists using [gallery-dl](https://github.com/mikf/gallery-dl/) ⭐ 19,719 | 🐛 1,131 | 🌐 Python | 📅 2026-09-12.
...
* [gallery-dl-view](https://github.com/noctuid/gallery-dl-view) ⭐ 27 | 🐛 1 | 🌐 Clojure | 📅 2026-03-19 - Load image galleries directly in mpv like gallery-dl\_hook but with extra functionality like binding a key to download images, optionally only loading images that are new since the gallery was last opened, and more.
...
* [ontop-playback](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/ontop-playback.lua) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14 - Disables the ontop property when pausing, and enables it again when unpausing the video, if it was disabled. Change it only when the player is not in fullscreen to prevent screen flickering.
* [pause-when-minimize](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/pause-when-minimize.lua) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14 - Pauses the player video when minimizing, and unpauses it when brought up again.
* [single-instance](https://github.com/mpv-player/mpv/issues/43#issuecomment-2496083283) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14 - Reuse the existing mpv window when opening new files rather than spawning a new window.
...
* [SmartCopyPaste-3.0](https://github.com/Eisa01/mpv-scripts#smartcopypaste) ⭐ 841 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Powerful copy paste features. Paste URL or local videos directly to mpv. Copy URL or currently playing video in mpv player then paste to access at a later time. Add videos to playlist simply by pasting. Much more explained in the link above.
* [SmartCopyPaste-II-3.0](https://github.com/Eisa01/mpv-scripts#smartcopypaste_ii) ⭐ 841 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Powerful copy paste and clipboard list features using a log file. Select, filter, and search from your clipboard list. Paste URL or local videos directly to mpv. Copy URL or currently playing video in mpv player then paste to access at a later time. Paste to access previously copied times of same video. Much more explained in the link above.
* [webm](https://github.com/ekisu/mpv-webm) ⭐ 678 | 🐛 61 | 🌐 MoonScript | 📅 2026-09-14 - WebM converter based on MoonScript.
...
* [anilist-updater](https://github.com/AzuredBlue/mpv-anilist-updater) ⭐ 42 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - Automatically updates your AniList when reaching 80% completion based on the file name.
...
* [trakt-scrobble](https://github.com/dyphire/trakt-scrobble) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-04-30 - Connects trakt.tv with mpv and automatically scrobbles movies/shows.
...
* [jellyfin mpv shim](https://github.com/jellyfin/jellyfin-mpv-shim) ⭐ 2,391 | 🐛 195 | 🌐 Python | 📅 2026-09-17 - Jellyfin (Emby/Plex alternative) Client, based on Python.
* [ff2mpv](https://github.com/woodruffw/ff2mpv) ⭐ 640 | 🐛 10 | 🌐 PowerShell | 📅 2026-01-08 - A Firefox/Chrome extension for playing URLs in mpv, based on PowerShel/Shell/Python/JavaScript.
...
* [dyphire](https://github.com/dyphire/mpv-config) ⭐ 1,881 | 🐛 8 | 🌐 GLSL | 📅 2026-08-26
* [Zabooby](https://github.com/Zabooby/mpv-config) ⭐ 569 | 🐛 1 | 🌐 GLSL | 📅 2026-08-13
* [noelsimbolon](https://github.com/noelsimbolon/mpv-config) ⭐ 309 | 🐛 2 | 🌐 GLSL | 📅 2026-04-30
* [Natural-Harmonia-Gropius](https://github.com/Natural-Harmonia-Gropius/mpv_config) ⭐ 104 | 🐛 0 | 🌐 GLSL | 📅 2026-09-14
* [tuilakhanh](https://github.com/tuilakhanh/mpv-config) ⭐ 74 | 🐛 0 | 🌐 GLSL | 📅 2026-08-18
* [Awan](https://github.com/Awan/cfg/tree/master/mpv/.config/mpv) ⭐ 37 | 🐛 0 | 🌐 Vim Script | 📅 2026-09-17
...
* [KikoPlay](https://github.com/KikoPlayProject/KikoPlay) ⭐ 2,234 | 🐛 9 | 🌐 C++ | 📅 2026-09-13 - Cross-platform [Danmu](https://en.wikipedia.org/wiki/Danmu) player, based on C++/QT.
...
* [Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,403 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17 - A series of shaders designed to scale and enhance anime. Includes shaders for line sharpening, artefact removal, denoising, upscaling, and more.
...
* [AniSD ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/AniSD-ArtCNN) ⭐ 364 | 🐛 5 | 📅 2025-06-08 - AniSD ArtCNN shader for standard definition anime content.
* [Ani4K v2 ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/Ani4k-v2-ArtCNN) ⭐ 364 | 🐛 5 | 📅 2025-06-08 - Ani4K shader v2 targets modern anime, from high quality Bluray to crappy WEB releases, for upscaling to either 2K or 4K.
* [hdr-toys](https://github.com/natural-harmonia-gropius/hdr-toys) ⭐ 194 | 🐛 17 | 🌐 GLSL | 📅 2026-09-14 - Componentized Rec.2100 to Rec.709 conversion shader.
...
* [vidcutter](https://github.com/ozmartian/vidcutter) ⭐ 1,985 | 🐛 297 | 🌐 Python | 📅 2025-04-24 - Cross-platform video cutter/joiner, based on Python/QT.
...
* [qimgv](https://github.com/easymodo/qimgv) ⭐ 3,127 | 🐛 308 | 🌐 C++ | 📅 2026-01-19 - Cross-platform, based on C++/QT.

# Launcher

* <https://github.com/mpv-player/mpv/blob/master/TOOLS/umpv> ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14
* <https://github.com/davatorium/rofi> ⭐ 16,397 | 🐛 115 | 🌐 C | 📅 2026-09-17
* <https://github.com/Flow-Launcher/Flow.Launcher> ⭐ 15,583 | 🐛 309 | 🌐 C# | 📅 2026-09-16
* <https://github.com/ikas-mc/ContextMenuForWindows11> ⭐ 2,886 | 🐛 22 | 🌐 C# | 📅 2026-09-13
...
* [mpv-mpris](https://github.com/hoyon/mpv-mpris) ⭐ 741 | 🐛 2 | 🌐 C | 📅 2026-09-16 - On Linux allows controlling mpv using standard media keys.
...
* [Compiling for Windows](https://github.com/mpv-player/mpv/blob/master/DOCS/compile-windows.md) ⭐ 37,005 | 🐛 1,157 | 🌐 C | 📅 2026-09-14
* [Building mpv and libmpv using wsl2 and Ubuntu](https://github.com/mpvnet-player/mpv.net/wiki/Building-mpv-and-libmpv-using-wsl2-and-Ubuntu) ⭐ 5,400 | 🐛 156 | 🌐 C# | 📅 2026-02-09
* [Media Auto Build Suite (MABS)](https://github.com/m-ab-s/media-autobuild_suite) ⭐ 1,824 | 🐛 220 | 🌐 Shell | 📅 2026-09-08
* [Helper scripts to compile mpv on Linux](https://github.com/mpv-player/mpv-build) ⭐ 491 | 🐛 10 | 🌐 Shell | 📅 2025-11-02
...
* [Kit](https://github.com/mpvkit/MPVKit) ⭐ 198 | 🐛 9 | 🌐 Swift | 📅 2026-09-11 - MPVKit is a collection of tools to use mpv in iOS, macOS, tvOS applications. It includes scripts to build mpv native libraries.
* [easy](https://github.com/mpv-easy/mpv-easy) ⭐ 137 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-13 - TS and React GUI toolkit for mpv script.
* [object pascal](https://github.com/URUWorks/UW_MPVPlayer) ⭐ 32 | 🐛 1 | 🌐 Pascal | 📅 2026-09-17 - Embeddable player for Object Pascal.
...
* [Memento](https://github.com/ripose-jp/Memento) ⭐ 1,481 | 🐛 26 | 🌐 C++ | 📅 2026-08-24 - Cross-platform video player for studying Japanese, based on C++/QT.
* [gnome-shell-extension-caffeine](https://github.com/eonpatapon/gnome-shell-extension-caffeine) ⭐ 782 | 🐛 43 | 🌐 JavaScript | 📅 2026-09-17 - Prevent the display from turning off (Gnome doesn't support the idle-inhibit protocol on Wayland) and disable the 'night light' when a mpv window is in focus.
...
* [mpvQC](https://github.com/mpvqc/mpvQC) ⭐ 79 | 🐛 5 | 🌐 Python | 📅 2026-09-13 - Cross-platform application for quality control of videos, based on Python/QT.
