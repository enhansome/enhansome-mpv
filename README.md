...
* [SMPlayer](https://github.com/smplayer-dev/smplayer) ⭐ 1,057 | 🐛 77 | 🌐 C++ | 📅 2026-09-16 - Based on C++/QT.
* [ImPlay](https://github.com/tsl0922/ImPlay) ⭐ 783 | 🐛 24 | 🌐 C++ | 📅 2026-02-23 - Based on C++/imgui.
* [MoonPlayer](https://github.com/coslyk/moonplayer) ⭐ 685 | 🐛 43 | 🌐 C++ | 📅 2024-09-03 - Based on C++/QT/QML.
...
* [OvoPlayer](https://github.com/varianus/ovoplayer) ⭐ 65 | 🐛 1 | 🌐 Pascal | 📅 2026-09-09 - Unmaintained, based on Pascal.
* [mpv](https://mpv.io) - Based on C/Lua.

## Windows

* [mpv.net](https://github.com/mpvnet-player/mpv.net) ⭐ 5,407 | 🐛 156 | 🌐 C# | 📅 2026-02-09 - Based on C#/WinForms/WPF.
* [MPV-EASY Player](https://github.com/422658476/MPV-EASY-Player) ⭐ 1,434 | 🐛 1 | 🌐 Lua | 📅 2026-09-06
* [mpc-qt](https://github.com/mpc-qt/mpc-qt) ⭐ 1,096 | 🐛 115 | 🌐 C++ | 📅 2026-09-21 - Based on C++/QT.
...
* [Deepin Movie](https://github.com/linuxdeepin/deepin-movie-reborn) ⭐ 88 | 🐛 2 | 🌐 C++ | 📅 2026-09-20 - Unmaintained, based on C++/QT.
...
* [android](https://github.com/mpv-android/mpv-android) ⭐ 3,578 | 🐛 166 | 🌐 Kotlin | 📅 2026-09-17 - Player for Android, based on Kotlin.
* [Kt](https://github.com/abdallahmehiz/mpvKt) ⚠️ Archived - Player for Android, based on Kotlin.

# Installation/Download

* [shinchiro GitHub](https://github.com/shinchiro/mpv-winbuild-cmake) ⭐ 1,760 | 🐛 61 | 🌐 CMake | 📅 2026-09-21 - Daily Windows builds of mpv and libmpv. This is the most popular choice on Windows.
* [zhongfly](https://github.com/zhongfly/mpv-winbuild) ⭐ 925 | 🐛 0 | 🌐 Shell | 📅 2026-09-21 - Windows builds of mpv and libmpv. This choice is very similar to `shinchiro GitHub`, so it's also a recommendation.
* [mpsm](https://github.com/mpv-easy/mpv-easy/tree/main/mpv-mpsm) ⭐ 137 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-21 - mpsm is a mpv script manager, you can install scripts provided by [mpsm-scripts](https://github.com/mpv-easy/mpsm-scripts) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-13, or install any script with added [meta info](https://github.com/mpv-easy/mpsm-scripts?tab=readme-ov-file#meta-info) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-09-13 via url.
* [mitzsch](https://github.com/mitzsch/mpv-winbuild) ⭐ 29 | 🐛 0 | 🌐 Shell | 📅 2026-08-08 - Windows builds of mpv and libmpv.
* [Andarwinux](https://github.com/Andarwinux/mpv-winbuild) ⭐ 23 | 🐛 3 | 🌐 Shell | 📅 2026-09-21 - Daily Windows builds of mpv and libmpv including ARM64 architecture.
...
* [Wiki](https://github.com/mpv-player/mpv/wiki) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20
...
* <https://github.com/mpv-player/mpv/issues> ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20
* <https://github.com/mpv-player/mpv/discussions> ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20
...
in the [wiki](https://github.com/mpv-player/mpv/wiki/User-Scripts) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20,
the advantage of the following list is that everything is categorized
into popular sections, like Subtitles etc.

## Menu

* [select](https://github.com/mpv-player/mpv/blob/master/player/lua/select.lua) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20 - Menu script built into mpv.
* [uosc](https://github.com/tomasklaen/uosc) ⭐ 3,409 | 🐛 34 | 🌐 Lua | 📅 2026-08-30 - Popular OSC with menu.
* [command\_palette](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Searchable menu for
...
* [search-menu](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Searchable and configurable menu to quickly find key bindings, commands, properties, audio/subtitle tracks and playlist entries.
* [osm](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Configurable on screen menu to run custom commands.
...
* [mpvc-tui](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-21 - Command-line and TUI for mpv.
...
* [menu](https://github.com/nezumisama/mpvmenu) ⭐ 34 | 🐛 1 | 🌐 Python | 📅 2018-10-23 - Configurable on screen context-menu.
...
* [betterchapters](https://gist.github.com/Hakkin/4f978a5c87c31f7fe3ae) ([update](https://github.com/mpv-player/mpv/issues/4738#issuecomment-321298846) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20) - Loads the next or previous playlist entry if there are no more chapters in the seek direction.
* [autoload](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autoload.lua) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20 - Automatically load playlist entries before and after the currently playing file, by scanning the directory. **Obsolete:** mpv now has a native `--autocreate-playlist` option.
* [print-playlist](https://git.sr.ht/~jagrg/dotfiles/tree/master/item/common/.config/mpv/scripts/print-playlist.lua) - Cleans [the playlist formatting](https://github.com/mpv-player/mpv/issues/5868#issue-327675880) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20 on the terminal.
* [playlistnoplayback](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/playlistnoplayback.lua) ⭐ 1,434 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - If you enable the save play history and progress function, this lua script can solve the problem of automatically jumping to the previous playback progress when playing the next file when playing the playlist, that is, let the playlist always play the next file from the beginning every time. the limitations of this script, please see the comments section in the content.
* [pause-indicator-lite](https://github.com/Samillion/ModernZ/tree/main/extras/pause-indicator-lite) ⭐ 1,238 | 🐛 26 | 🌐 Lua | 📅 2026-06-04 - A simple script that displays an indicator on pause, with options to adjust icon, color, height, width, opacity and whether to toggle pause with a keybind or not.
* [UndoRedo](https://github.com/Eisa01/mpv-scripts#undoredo) ⭐ 842 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Undo and Redo feature for mpv. If you seek/jump to a different time in the video, press undo \[ctrl]+\[z] to linearly undo the seeks/jumps in the video, and press redo \[ctrl]+\[y] to linearly return to previous undo positions. More details in the link above.
* [SimpleBookmark-1.0](https://github.com/Eisa01/mpv-scripts#simplebookmark) ⭐ 842 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Bookmark with a \[ctrl]+\[b], then list and access your bookmarks with \[b]. Assign your favorites to a keybind then access your favorites with that same keybind. Much more explained in the link above.
* [SimpleHistory-1.0](https://github.com/Eisa01/mpv-scripts#simplehistory) ⭐ 842 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Powerful history features that logs videos that you opened into a log file along with the time you have reached on each video. Select, filter, and search from your history list, Optional resume by \[ctrl]+\[r] for all videos you have played. Much more explained in the link above.
* [SimpleUndo-3.2](https://github.com/Eisa01/mpv-scripts#simpleundo) ⭐ 842 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Simple undo feature. If you accidentally seek/jump to a different time in the video, press undo \[ctrl]+\[z] to return to your previous time and vice-versa. More details in the link above.
* [SmartSkip](https://github.com/Eisa01/mpv-scripts/#smartskip) ⭐ 842 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Automatically or manually skip opening, intro, outro, and preview, like never before. Jump to next file, previous file, and save your chapter changes! Much more explained in the link above.
* [playlist-manager](https://github.com/jonniek/mpv-playlistmanager) ⭐ 699 | 🐛 12 | 🌐 Lua | 📅 2026-03-16 - Create and manage playlists.
...
* [playlist-view](https://github.com/occivink/mpv-gallery-view) ⭐ 259 | 🐛 26 | 🌐 Lua | 📅 2024-09-27 - Display and navigate the playlist in a grid view of thumbnails.
* [history](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Writes date, time, playtime and filename to a log file: `10.09.2022 19:50  3 D:\Samples\Big Buck Bunny.mkv`
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - When seeking display position and duration like so: 70:00 / 80:00
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Navigate in playlist to next/previous/first/last file.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Jump to a random position in the playlist.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Load or append files/URLs from clipboard.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Cycle audio and subtitle tracks, include only languages you know.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Show detailed media info on screen.
* [stats](https://github.com/Argon-/mpv-stats/) ⭐ 210 | 🐛 1 | 🌐 Lua | 📅 2018-12-09 - Display some statistics about the currently played file on-screen.
* [censor](https://github.com/zenyd/mpv-scripts) ⭐ 192 | 🐛 1 | 🌐 Lua | 📅 2025-12-07 - Skip over parts of videos you don't want (others) to view
* [speed-transition](https://github.com/zenyd/mpv-scripts) ⭐ 192 | 🐛 1 | 🌐 Lua | 📅 2025-12-07 - Increases playback speed if a subtitle will not be displayed soon. Resumes normal speed just before the subtitle shows up.
...
* [bookmarker-menu](https://github.com/NurioHin/mpv-bookmarker) ⭐ 133 | 🐛 20 | 🌐 Lua | 📅 2021-01-27 - Menu to manage all your bookmarks.
* [chapter-make-read](https://github.com/dyphire/mpv-scripts/blob/main/chapter-make-read.lua) ⭐ 126 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Automatically read an load the namesake external chapter file with extension of CHP. Temporarily mark the current playback position as a chapter so you can seek to it later. Also allows writing current chapters as CHP or XML. Based on `createchapter`.
* [track-list](https://github.com/dyphire/mpv-scripts/blob/main/track-list.lua) ⭐ 126 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Interractive track-list menu.
* [skiptosilence dyphire](https://github.com/dyphire/mpv-scripts/blob/main/skiptosilence.lua) ⭐ 126 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Skips to the next silence in the file.
* [memo](https://github.com/po5/memo) ⭐ 123 | 🐛 11 | 🌐 Lua | 📅 2024-11-01 - A recent files/history menu for mpv with optional uosc integration.
* [btime](https://github.com/butterw/bShaders/blob/master/mpv/settings/scripts/btime.js) ⭐ 112 | 🐛 3 | 🌐 HLSL | 📅 2024-01-19 - Shows a shorter time format when seeking: 0:15 / 3:10, 08:20 / 55:00, 0:00:05 / 1:30:14.
* [countdown](https://github.com/butterw/bShaders/blob/master/mpv/settings/scripts/countdown.lua) ⭐ 112 | 🐛 3 | 🌐 HLSL | 📅 2024-01-19 - Display a countdown on OSD for the final seconds of the video (or music file).
* [nextfile](https://github.com/jonniek/mpv-nextfile) ⭐ 88 | 🐛 4 | 🌐 Lua | 📅 2023-08-09 - Force opens next or previous file in the currently playing files directory.
...
* [chapterskip](https://github.com/po5/chapterskip) ⭐ 51 | 🐛 4 | 🌐 Lua | 📅 2022-09-08 - Skip chapters based on their title.
...
* [recent-menu](https://github.com/natural-harmonia-gropius/recent-menu) ⭐ 46 | 🐛 2 | 🌐 Lua | 📅 2026-07-26 - Recently (history) played menu integrated with uosc.
...
* [fastforward](https://github.com/jgreco/mpv-scripts/blob/master/fastforward.lua) ⭐ 46 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Instead of skipping forward in media files, speed up the playback for a few seconds.  Playback speed decays back to 1x after a few seconds.  Tap rapidly or hold down to go faster.
...
* [autoloop](https://github.com/zc62/mpv-scripts/blob/master/autoloop.lua) ⭐ 43 | 🐛 0 | 🌐 Lua | 📅 2020-08-28 - Automatically loops files that are under a given duration (default 5 seconds).
...
* [guess-media-title](https://github.com/zenwarr/mpv-config/blob/master/scripts/guess-media-title.lua) ⭐ 34 | 🐛 3 | 🌐 Lua | 📅 2025-11-16 - Uses [guessit](https://github.com/guessit-io/guessit) ⭐ 938 | 🐛 20 | 🌐 Python | 📅 2026-09-09 to detect a media title by filename and set `force-media-title` variable. Useful for getting cleaner screenshot file names.
...
* [autochapters](https://github.com/po5/mpv-auto-chapters) ⭐ 29 | 🐛 0 | 🌐 Lua | 📅 2025-12-27 - Automatically finds chapters for your anime files.
...
* [dvd-browser](https://github.com/CogentRedTester/mpv-dvd-browser) ⭐ 16 | 🐛 0 | 🌐 Lua | 📅 2025-01-15 - Browse and load DVD titles.
...
* [time](https://github.com/mustaqimM/mpv-scripts/blob/master/time.lua) ⭐ 8 | 🐛 2 | 🌐 Lua | 📅 2023-12-27 - Shows the current time or the time at which playback will end.
...
* [mpvclip-mpvival-mpvloop](https://github.com/o770/mpvclip-mpvival-mpvloop) ⭐ 3 | 🐛 0 | 🌐 Shell | 📅 2024-09-09 - Run MPV with options for loops and playback start and end times set according to a pattern or intervals of the total duration of a file.
...
* [file-browser](https://github.com/CogentRedTester/mpv-file-browser) ⭐ 332 | 🐛 4 | 🌐 Lua | 📅 2026-03-27 - On screen file browser.
* [delete-current-file](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Moves the current file instantly to the recycle bin.
* [file-rating](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Writes a star rating to the filename of the current file.
...
* [rename](https://github.com/Kayizoku/mpv-rename) ⭐ 23 | 🐛 6 | 🌐 Lua | 📅 2025-02-05 - Rename files on the go directly from within MPV player window without leaving it.
...
* [osd-bar](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/osd-bar.lua) ⭐ 1,434 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - Always show osd progress bar, with the more beautiful color matching in the [configuration file](https://github.com/422658476/MPV-EASY-Player/blob/master/mpv-easy-data/rjno1.conf) ⭐ 1,434 | 🐛 1 | 🌐 Lua | 📅 2026-09-06, you can make the osd progress bar display the current progress at the bottom of the window beautifully,this is a [preview](https://raw.githubusercontent.com/422658476/MPV-EASY-Player/master/img/mpv-easy-player-osd-bar-lua.jpg).

* [osc-style](https://github.com/422658476/MPV-EASY-Player/tree/master/mpv-easy-data/osc-style) ⭐ 1,434 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - Change the mpv OSC to a more beautiful and practical look, which is the osc theme feature, a variety of styles to choose from,this is a [tutorial and a preview](https://github.com/422658476/MPV-EASY-Player#%E7%9C%8B%E5%88%B0%E4%B8%8A%E9%9D%A2%E5%9B%BE%E4%B8%8A%E8%BF%99%E4%BA%9Bosc%E6%A0%B7%E5%BC%8F%E4%BA%86%E5%90%97%E5%AE%83%E4%BB%AC%E4%B8%8D%E4%BB%85%E5%8F%AF%E4%BB%A5%E5%AD%98%E5%9C%A8%E4%BA%8Empv-easy-player%E4%B8%AD%E4%BD%A0%E4%BD%BF%E7%94%A8%E7%9A%84mpv%E7%9A%84osc%E4%B9%9F%E5%8F%AF%E4%BB%A5%E5%8F%98%E6%88%90%E8%BF%99%E6%A0%B7) ⭐ 1,434 | 🐛 1 | 🌐 Lua | 📅 2026-09-06.

* [ModernZ](https://github.com/Samillion/ModernZ) ⭐ 1,238 | 🐛 26 | 🌐 Lua | 📅 2026-06-04 - A fork of ModernX designed to enhance functionality by adding more features, all while preserving the core standards of mpv's OSC.

* [ModernX cyl0](https://github.com/cyl0/ModernX) ⭐ 763 | 🐛 20 | 🌐 Lua | 📅 2026-02-04 - Modern OSC replacement.

* [thumbnail\_script](https://github.com/TheAMM/mpv_thumbnail_script) ⭐ 714 | 🐛 57 | 🌐 Lua | 📅 2023-08-07 - Shows preview thumbnails in the seekbar.

* [osc-modern](https://github.com/maoiscat/mpv-osc-modern) ⭐ 432 | 🐛 15 | 🌐 Lua | 📅 2024-04-20 - Modern OSC replacement.
...
* [ModernX zydezu](https://github.com/zydezu/ModernX) ⭐ 302 | 🐛 4 | 🌐 Lua | 📅 2026-08-11 - A fork of ModernX with many additional features and customization.

* [tethys](https://github.com/Zren/mpv-osc-tethys) ⭐ 215 | 🐛 20 | 🌐 Lua | 📅 2024-04-30 - OSC replacement with seekbar thumbnail preview.

* [progressbar](https://github.com/torque/mpv-progressbar) ⭐ 170 | 🐛 10 | 🌐 MoonScript | 📅 2025-03-05 - A minimalistic OSC replacement. It provides a small, unintrusive progress bar that persists at the bottom of the video window.

* [modern-x-compact](https://github.com/1-minute-to-midnight/mpv-modern-x-compact) ⭐ 100 | 🐛 5 | 🌐 Lua | 📅 2024-08-10 - Compact version of modern-x.

* [osc-modern-f](https://github.com/FinnRaze/mpv-osc-modern-f) ⭐ 91 | 🐛 2 | 🌐 Lua | 📅 2024-09-17 - OSC script forked from [mpv-osc-modern](https://github.com/maoiscat/mpv-osc-modern) ⭐ 432 | 🐛 15 | 🌐 Lua | 📅 2024-04-20.

* [oscc](https://github.com/longtermfree/oscc) ⭐ 70 | 🐛 3 | 🌐 Lua | 📅 2024-10-02 - Dark-themed OSC.
...
* [uosc\_history\_menu](https://github.com/Koopex/uosc_history_menu) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-09-15 - A history and bookmark management menu integrated with uosc.

* [osc-simple](https://github.com/maoiscat/mpv-osc-simple) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2023-05-11 - An OSC/UI replacement of white theme.
...
* [cycle-commands](https://github.com/CogentRedTester/mpv-scripts/blob/master/cycle-commands.lua) ⭐ 301 | 🐛 4 | 🌐 Lua | 📅 2026-01-11 - Allows input.conf commands to be cycled through with keybinds.
* [auto-mode](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Use mpv as video player, music player and image viewer, switch automatically between, video, audio and image mode.
...
* [InputEvent](https://github.com/Natural-Harmonia-Gropius/InputEvent) ⭐ 95 | 🐛 0 | 🌐 Lua | 📅 2026-05-14 - Enhanced input.conf with better, conflict-free, low-latency event mechanism.
...
* [autosubsync](https://github.com/joaquintorres/autosubsync-mpv) ⭐ 190 | 🐛 7 | 🌐 Lua | 📅 2026-05-17 - Automatically sync subtitles using **ffsubsync**.
...
* [auto-load-fonts](https://github.com/Hill-98/mpv-config/blob/main/scripts/auto-load-fonts.js) ⭐ 85 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-01 - Auto load the font files in the fonts folder under the play file path.
...
* [tts-subs](https://github.com/jgreco/mpv-scripts/blob/master/tts-subs.lua) ⭐ 46 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Use voice synthesis to read subtitles out-loud.
* [sub-fastwhisper](https://github.com/dyphire/mpv-sub-fastwhisper) ⭐ 45 | 🐛 2 | 🌐 Lua | 📅 2026-05-30 - Generate SRT subtitles through voice transcription using faster-whisper.
* [autosubsync](https://github.com/Ajatt-Tools/autosubsync-mpv) ⭐ 43 | 🐛 1 | 🌐 Lua | 📅 2026-05-17 - Automatic subtitle synchronization script.
* [save-sub-delay](https://github.com/zc62/mpv-scripts/blob/master/save-sub-delay.lua) ⭐ 43 | 🐛 0 | 🌐 Lua | 📅 2020-08-28 - This script saves the sub-delay quantity for each file. When next time the file is opened, sub-delay is automatically restored.
...
* [subtitle-lines](https://github.com/christoph-heinrich/mpv-subtitle-lines) ⭐ 37 | 🐛 1 | 🌐 Lua | 📅 2026-07-19 - List and search subtitle lines of the selected subtitle track.
* [subtitle-search](https://github.com/zenwarr/mpv-config/blob/master/scripts/subtitle-search.lua) ⭐ 34 | 🐛 3 | 🌐 Lua | 📅 2025-11-16 - Script to search for a phrase inside an active `.srt` subtitle. Displays matched lines in OSD list, takes `sub-delay` into account and allows searching for Unicode text in utf8 subtitle files.
* [restore-subtitles](https://github.com/zenwarr/mpv-config/blob/master/scripts/restore-subtitles.lua) ⭐ 34 | 🐛 3 | 🌐 Lua | 📅 2025-11-16 - Saves selected subtitle tracks and visibility state to `saved-subs.json` file in config directory and restores them whenever file is loaded. Differs from `watch-later`-saved data in that it saves secondary subtitles too (and uses subtitle file paths instead of ids).
* [subai](https://github.com/zenwarr/mpv-config?tab=readme-ov-file#subai) ⭐ 34 | 🐛 3 | 🌐 Lua | 📅 2025-11-16 - Translate and explain the currently displayed subtitle line into your preferred language. Helps learning a foreign language.
...
* [llm-subtrans](https://github.com/sorz/mpv-llm-subtrans/) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2025-04-07 - Extract & translate subtitles with OpenAI API. Streaming & contextual.
* [sub-assrt by dyphire](https://github.com/dyphire/mpv-sub-assrt) ⭐ 12 | 🐛 1 | 🌐 Lua | 📅 2026-04-30 - Download Chinese subtitles from assrt.
...
* [mpvacious](https://github.com/Ajatt-Tools/mpvacious) ⭐ 890 | 🐛 12 | 🌐 Lua | 📅 2026-09-17 - Add keybindings to create Anki flashcards for (language) learning.
...
* [lrc](https://github.com/guidocella/mpv-lrc) ⭐ 38 | 🐛 0 | 🌐 Lua | 📅 2026-09-14 - Download synchronized lyrics of the currently playing song.
...
* [acompressor](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/acompressor.lua) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20 - Dynamic range compressor using acompressor ffmpeg filter with controls to dynamically adjust parameters.
* [smart-volume](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Replay gain alternative.
...
* [adevice-list](https://github.com/dyphire/mpv-scripts/blob/main/adevice-list.lua) ⭐ 126 | 🐛 1 | 🌐 Lua | 📅 2026-08-17 - Interractive audio-device list menu.
...
* [sponsorblock](https://github.com/po5/mpv_sponsorblock) ⭐ 632 | 🐛 29 | 🌐 Lua | 📅 2024-05-01 - Script to skip sponsored segments of YouTube videos.
* [youtube-search](https://github.com/CogentRedTester/mpv-scripts/blob/master/youtube-search.lua) ⭐ 301 | 🐛 4 | 🌐 Lua | 📅 2026-01-11 - A script that allows users to search youtube and open results from within mpv. Requires a couple of extra API scripts, along with curl and a personal youtube API key.
* [quality-menu](https://github.com/christoph-heinrich/mpv-quality-menu) ⭐ 238 | 🐛 3 | 🌐 Lua | 📅 2026-01-30 - Change the streamed video and audio quality (ytdl-format) on the fly.
* [webtorrent-hook](https://github.com/noctuid/mpv-webtorrent-hook) ⭐ 129 | 🐛 8 | 🌐 Lua | 📅 2026-02-20 - Allows streaming torrents using webtorrent (same as mpv-peerflix-hook but using webtorrent instead). Webtorrent-cli can play in mpv with `webtorrent --mpv`, but this script allows using torrent identifiers as the file argument to mpv or pasting them into the current playlist using one of the pasting scripts listed here. It also supports additional functionality like automatic file cleanup and the ability to remember the last file played in the torrent. See the readme for more information. See [here](https://github.com/noctuid/mpv-webtorrent-hook#comparison-with-webtorrent-mpv-hook) ⭐ 129 | 🐛 8 | 🌐 Lua | 📅 2026-02-20 for a comparison with the other javascript webtorrent plugin. I recommend this plugin over my others (mpv-peerflix-hook and btfs-stream).
* [streamsave](https://github.com/Sagnac/streamsave) ⭐ 128 | 🐛 2 | 🌐 Lua | 📅 2024-07-19 - Save live streams without encoding.
* [youtube-download](https://github.com/cvzi/mpv-youtube-download) ⭐ 105 | 🐛 2 | 🌐 Lua | 📅 2023-10-17 - Download YouTube audio and video with one key press.
...
* [mpvDLNA](https://github.com/chachmu/mpvDLNA) ⭐ 86 | 🐛 9 | 🌐 JavaScript | 📅 2024-08-18 - Browse and watch content hosted on DLNA servers.
* [youtube-upnext](https://github.com/cvzi/mpv-youtube-upnext) ⭐ 81 | 🐛 7 | 🌐 Lua | 📅 2026-07-20 - A menu for (auto) playing YouTube's "up next"/recommended videos, that show up on the right side on the website.
* [jellyfin](https://github.com/EmperorPenguin18/mpv-jellyfin) ⭐ 72 | 🐛 5 | 🌐 Lua | 📅 2026-03-22 - Turns mpv into a Jellyfin client.
* [ytdlautoformat](https://github.com/Samillion/mpv-ytdlautoformat) ⭐ 60 | 🐛 0 | 🌐 Lua | 📅 2026-04-10 - Automatically adjusts `ytdl-format` (yt-dlp) for specified domains.
...
* [torrserver](https://github.com/kritma/mpv-torrserver) ⭐ 9 | 🐛 0 | 🌐 Lua | 📅 2024-02-05 - Allows streaming torrents using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,052 | 🐛 26 | 🌐 Go | 📅 2026-09-21. Support magnet links and .torrent files
...
* [torrserver-hook](https://github.com/eNV25/mpv-torrserver-hook) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-06-07 - Allows for playback of media from the BitTorrent network using [TorrServer](https://github.com/YouROK/TorrServer) ⭐ 3,052 | 🐛 26 | 🌐 Go | 📅 2026-09-21.
...
* [autocrop](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autocrop.lua) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20 - Automatically crop the video by using lavfi's cropdetect filter to detect black bars.
* [autodeint](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/autodeint.lua) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20 - Automatically deinterlace the video by using lavfi's idet filter to detect interlaced content.
* [cycle-deinterlace-pullup](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/cycle-deinterlace-pullup.lua) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20 - Cycle between deinterlacing, pullup (IVTC), and both filters off.
* [use-cpu](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/use-cpu.lua) ⭐ 1,434 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - If the width of the video is greater than 3000 or the height of the video is greater than 2000, it will automatically switch back to using cpu decoding.
...
* [dynamic-crop](https://github.com/Ashyni/mpv-scripts#dynamic-croplua) ⭐ 134 | 🐛 5 | 🌐 Lua | 📅 2024-09-14 - Dynamically crop the video by using lavfi's cropdetect filter to detect hard-coded black bars for Ultra Wide Screen (21:9) or any screen different from 16:9 (phone/old TV).
...
* [store-shaders](https://github.com/butterw/bShaders/blob/master/mpv/settings/scripts/store-shaders.js) ⭐ 112 | 🐛 3 | 🌐 HLSL | 📅 2024-01-19 - Store current glsl-shaders config on first run, this config will then be restored by subsequent calls.
* [switch-shader](https://github.com/butterw/bShaders/blob/master/mpv/settings/scripts/switch-shader.js) ⭐ 112 | 🐛 3 | 🌐 HLSL | 📅 2024-01-19 - Provides a switch to disable/restore shaders and vf filters.
* [mpv360](https://github.com/kasper93/mpv360) ⭐ 79 | 🐛 3 | 🌐 Lua | 📅 2026-01-30 - Interactive 360° Video Viewer. With full camera control through mouse and keyboard inputs.
...
* [changerefresh](https://github.com/CogentRedTester/mpv-changerefresh) ⭐ 51 | 🐛 4 | 🌐 Lua | 📅 2024-03-05 - Automatically change the refresh rate of the current display to match the playing video (Windows).
...
* [vlcaspectratio](https://github.com/kism/mpvscripts/blob/main/scripts/vlcaspectratio.lua) ⭐ 29 | 🐛 0 | 🌐 Lua | 📅 2025-09-09 - Implements a VLC style aspect ratio hotkey 'a' that stretches the video to different aspect ratios.
* [vlccrop](https://github.com/kism/mpvscripts/blob/main/scripts/vlccrop.lua) ⭐ 29 | 🐛 0 | 🌐 Lua | 📅 2025-09-09 - Implements a VLC style crop hotkey 'c' that cycles through crop settings, useful for cropping letter-boxed or pillar-boxed content.
* [frame\_info](https://github.com/Kagami/mpv_frame_info) ⭐ 23 | 🐛 1 | 🌐 Lua | 📅 2017-10-12 - Show frame info, similar to ffdshow's OSD.
* [display-plugin](https://github.com/dyphire/mpv-display-plugin) ⭐ 19 | 🐛 0 | 🌐 C | 📅 2025-05-26 - More display properties for mpv, support toggle Windows HDR.
...
* [thumbfast](https://github.com/po5/thumbfast) ⭐ 1,697 | 🐛 56 | 🌐 Lua | 📅 2026-08-12 - High-performance on-the-fly thumbnailer for mpv.
...
* [contact-sheet](https://github.com/occivink/mpv-gallery-view) ⭐ 259 | 🐛 26 | 🌐 Lua | 📅 2024-09-27 - Display thumbnails of the current file in the style of a contact sheet.
* [auto-mode](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Use mpv as video player, music player and image viewer, switch automatically between, video, audio and image mode.
...
* [gallery-dl\_hook](https://github.com/jgreco/mpv-scripts/blob/master/gallery-dl_hook.lua) ⭐ 46 | 🐛 3 | 🌐 Lua | 📅 2019-10-10 - Load online image galleries (imgur, etc) as playlists using [gallery-dl](https://github.com/mikf/gallery-dl/) ⭐ 19,795 | 🐛 1,134 | 🌐 Python | 📅 2026-09-19.
...
* [image-config](https://github.com/guidocella/mpv-image-config) ⭐ 35 | 🐛 0 | 🌐 Lua | 📅 2026-09-14 - A configuration to use mpv as an image viewer.
...
* [gallery-screenshots](https://github.com/XeinyX/mpv_gallery-screenshots) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2025-09-22 - In‑player tiled screenshot gallery that turns your screenshots into visual bookmarks for fast navigation. Click thumbnails to jump instantly. Export screenshots to contact sheets (PNG), CSV, and Excel table XLSX.
...
* [videoclip](https://github.com/Ajatt-Tools/videoclip) ⭐ 201 | 🐛 7 | 🌐 Lua | 📅 2026-07-30 - Create video and audio clips.
...
* [remember-props](https://github.com/zenwarr/mpv-config/blob/master/scripts/remember-props.lua) ⭐ 34 | 🐛 3 | 🌐 Lua | 📅 2025-11-16 - When a property changes, it saves it to restore on next start. Saved values are not file-specific. List of properties to save is configured in `script-opts/remember-props.conf` file.
...
* [user-input](https://github.com/CogentRedTester/mpv-user-input) ⭐ 58 | 🐛 1 | 🌐 Lua | 📅 2023-12-27 - API to request text user input.
...
* [ontop-playback](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/ontop-playback.lua) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20 - Disables the ontop property when pausing, and enables it again when unpausing the video, if it was disabled. Change it only when the player is not in fullscreen to prevent screen flickering.
* [pause-when-minimize](https://github.com/mpv-player/mpv/blob/master/TOOLS/lua/pause-when-minimize.lua) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20 - Pauses the player video when minimizing, and unpauses it when brought up again.
* [single-instance](https://github.com/mpv-player/mpv/issues/43#issuecomment-2496083283) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20 - Reuse the existing mpv window when opening new files rather than spawning a new window.
* [local-language](https://github.com/422658476/MPV-EASY-Player/blob/master/portable-data/scripts/local-language.lua) ⭐ 1,434 | 🐛 1 | 🌐 Lua | 📅 2026-09-06 - Let the text displayed by osd become the language you are most familiar with, that is, language localization, such as 【volume: 100%】 becomes 【音量:100%】.
* [SmartCopyPaste-3.0](https://github.com/Eisa01/mpv-scripts#smartcopypaste) ⭐ 842 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Powerful copy paste features. Paste URL or local videos directly to mpv. Copy URL or currently playing video in mpv player then paste to access at a later time. Add videos to playlist simply by pasting. Much more explained in the link above.
* [SmartCopyPaste-II-3.0](https://github.com/Eisa01/mpv-scripts#smartcopypaste_ii) ⭐ 842 | 🐛 56 | 🌐 Lua | 📅 2025-06-21 - Powerful copy paste and clipboard list features using a log file. Select, filter, and search from your clipboard list. Paste URL or local videos directly to mpv. Copy URL or currently playing video in mpv player then paste to access at a later time. Paste to access previously copied times of same video. Much more explained in the link above.
...
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Execute Lua code from input.conf.
* [misc](https://github.com/stax76/mpv-scripts) ⭐ 231 | 🐛 9 | 🌐 Lua | 📅 2025-11-26 - Restart mpv restoring the properties path, time-pos, pause and volume.
...
* [exit-fullscreen](https://github.com/zc62/mpv-scripts/blob/master/exit-fullscreen.lua) ⭐ 43 | 🐛 0 | 🌐 Lua | 📅 2020-08-28 - If you use `--keep-open=yes`, this script exits fullscreen mode when the playback reaches the end of file/playlist.
* [manager](https://github.com/po5/mpv_manager) ⭐ 42 | 🐛 0 | 🌐 Lua | 📅 2023-08-08 - Script and shader manager.
* [anilist-updater](https://github.com/AzuredBlue/mpv-anilist-updater) ⭐ 41 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - Automatically updates your AniList when reaching 80% completion based on the file name.
...
* [debug-plugin](https://github.com/tsl0922/mpv-debug-plugin) ⭐ 36 | 🐛 3 | 🌐 C++ | 📅 2024-05-04 - A debug tool for mpv script developers, with GUI support for properties and console.
...
* [taskbar-buttons](https://github.com/qwerty12/mpv-taskbar-buttons) ⭐ 27 | 🐛 0 | 🌐 Lua | 📅 2022-10-19 - (Windows) Adds thumbbar buttons.
...
* [open-anilist-page](https://github.com/ehoneyse/mpv-open-anilist-page) ⭐ 15 | 🐛 2 | 🌐 Python | 📅 2020-09-12 - Opens the Anilist page that corresponds to the currently playing (anime) file.
* [mpvMatroska](https://github.com/hubblec4/mpvMatroska) ⭐ 14 | 🐛 2 | 🌐 Lua | 📅 2023-12-14 - mpvMatroska turns mpv into a Matroska player.
* [trakt-scrobble](https://github.com/dyphire/trakt-scrobble) ⭐ 14 | 🐛 0 | 🌐 Lua | 📅 2026-04-30 - Connects trakt.tv with mpv and automatically scrobbles movies/shows.
...
* [lua-repl](https://github.com/guidocella/mpv-lua-repl) ⭐ 9 | 🐛 0 | 🌐 Lua | 📅 2026-02-26 - A Lua REPL in the console with autocompletion and pretty-printing of returned tables. It lets you test mpv's and Lua's API without writing a script.
...
* [ontop-window](https://github.com/wishyu/mpv-ontop-window/blob/main/ontop-window.lua) ⭐ 1 | 🐛 0 | 🌐 Lua | 📅 2021-02-01 - Disables the ontop property when in fullscreen, and enables it again when in window mode, if it was disabled.
...
* [notification-osd](https://github.com/layercak3/mpv-notification-osd) ⭐ 1 | 🐛 1 | 🌐 C | 📅 2025-10-10 - XDG desktop notification OSD plugin for track changes or media key playback control while the window is unfocused. Supports cover art and video thumbnail of the current time position.
...
* [jellyfin mpv shim](https://github.com/jellyfin/jellyfin-mpv-shim) ⭐ 2,412 | 🐛 205 | 🌐 Python | 📅 2026-09-21 - Jellyfin (Emby/Plex alternative) Client, based on Python.
* [ff2mpv](https://github.com/woodruffw/ff2mpv) ⭐ 642 | 🐛 10 | 🌐 PowerShell | 📅 2026-01-08 - A Firefox/Chrome extension for playing URLs in mpv, based on PowerShel/Shell/Python/JavaScript.
...
* [plex-mpv-shim](https://github.com/iwalton3/plex-mpv-shim) ⭐ 410 | 🐛 70 | 🌐 Python | 📅 2025-10-20 - Cast media from Plex Mobile and Web apps to MPV, based on Python.
...
* [dyphire](https://github.com/dyphire/mpv-config) ⭐ 1,888 | 🐛 8 | 🌐 GLSL | 📅 2026-08-26
* [Zabooby](https://github.com/Zabooby/mpv-config) ⭐ 569 | 🐛 0 | 🌐 GLSL | 📅 2026-08-13
...
* [Awan](https://github.com/Awan/cfg/tree/master/mpv/.config/mpv) ⭐ 37 | 🐛 0 | 🌐 Vim Script | 📅 2026-09-21
...
* [DonCanjas](https://github.com/DonCanjas/mpv-dotfiles) ⭐ 10 | 🐛 1 | 🌐 Lua | 📅 2025-12-02
* [mustaqimM](https://github.com/mustaqimM/mpv-scripts) ⭐ 8 | 🐛 2 | 🌐 Lua | 📅 2023-12-27
...
* [webm.py](https://github.com/Kagami/webm.py) ⭐ 146 | 🐛 4 | 🌐 Python | 📅 2020-08-02 - Cross-platform command-line WebM converter, based on Python.

# Shaders

* [Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,422 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17 - A series of shaders designed to scale and enhance anime. Includes shaders for line sharpening, artefact removal, denoising, upscaling, and more.
* [FSRCNN](https://github.com/igv/FSRCNN-TensorFlow/releases) ⭐ 505 | 🐛 0 | 🌐 Python | 📅 2021-04-12 - Prescaler based on layered convolutional networks.
* [nnedi3 and ravu](https://github.com/bjin/mpv-prescalers/tree/master) ⭐ 451 | 🐛 5 | 📅 2024-01-24 - User shaders for prescaling.
* [ArtCNN](https://github.com/Artoriuz/ArtCNN) ⭐ 368 | 🐛 1 | 🌐 GLSL | 📅 2026-09-13 - Luma doublers trained on Manga109.
* [AniSD ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/AniSD-ArtCNN) ⭐ 366 | 🐛 5 | 📅 2025-06-08 - AniSD ArtCNN shader for standard definition anime content.
* [Ani4K v2 ArtCNN](https://github.com/Sirosky/Upscale-Hub/releases/tag/Ani4k-v2-ArtCNN) ⭐ 366 | 🐛 5 | 📅 2025-06-08 - Ani4K shader v2 targets modern anime, from high quality Bluray to crappy WEB releases, for upscaling to either 2K or 4K.
...
* [CuNNy](https://github.com/funnyplanter/CuNNy) ⭐ 168 | 🐛 4 | 🌐 GLSL | 📅 2025-08-29 - Cute and funny CNN-based upscaler optimized for anime.
...
* [vidcutter](https://github.com/ozmartian/vidcutter) ⭐ 1,988 | 🐛 297 | 🌐 Python | 📅 2025-04-24 - Cross-platform video cutter/joiner, based on Python/QT.
...
* [qimgv](https://github.com/easymodo/qimgv) ⭐ 3,134 | 🐛 308 | 🌐 C++ | 📅 2026-01-19 - Cross-platform, based on C++/QT.

# Launcher

* <https://github.com/mpv-player/mpv/blob/master/TOOLS/umpv> ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20
* <https://github.com/davatorium/rofi> ⭐ 16,405 | 🐛 115 | 🌐 C | 📅 2026-09-17
* <https://github.com/Flow-Launcher/Flow.Launcher> ⭐ 15,607 | 🐛 308 | 🌐 C# | 📅 2026-09-20
* <https://github.com/ikas-mc/ContextMenuForWindows11> ⭐ 2,889 | 🐛 22 | 🌐 C# | 📅 2026-09-19
...
* [mpv-mpris](https://github.com/hoyon/mpv-mpris) ⭐ 743 | 🐛 3 | 🌐 C | 📅 2026-09-17 - On Linux allows controlling mpv using standard media keys.
...
* [Compiling for Windows](https://github.com/mpv-player/mpv/blob/master/DOCS/compile-windows.md) ⭐ 37,058 | 🐛 1,161 | 🌐 C | 📅 2026-09-20
* [Building mpv and libmpv using wsl2 and Ubuntu](https://github.com/mpvnet-player/mpv.net/wiki/Building-mpv-and-libmpv-using-wsl2-and-Ubuntu) ⭐ 5,407 | 🐛 156 | 🌐 C# | 📅 2026-02-09
* [Media Auto Build Suite (MABS)](https://github.com/m-ab-s/media-autobuild_suite) ⭐ 1,824 | 🐛 219 | 🌐 Shell | 📅 2026-09-20
...
* [easy](https://github.com/mpv-easy/mpv-easy) ⭐ 137 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-21 - TS and React GUI toolkit for mpv script.
* [object pascal](https://github.com/URUWorks/UW_MPVPlayer) ⭐ 32 | 🐛 0 | 🌐 Pascal | 📅 2026-09-18 - Embeddable player for Object Pascal.
...
* [Memento](https://github.com/ripose-jp/Memento) ⭐ 1,483 | 🐛 27 | 🌐 C++ | 📅 2026-08-24 - Cross-platform video player for studying Japanese, based on C++/QT.
* [gnome-shell-extension-caffeine](https://github.com/eonpatapon/gnome-shell-extension-caffeine) ⭐ 783 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-17 - Prevent the display from turning off (Gnome doesn't support the idle-inhibit protocol on Wayland) and disable the 'night light' when a mpv window is in focus.
...
* [mpvQC](https://github.com/mpvqc/mpvQC) ⭐ 79 | 🐛 4 | 🌐 Python | 📅 2026-09-20 - Cross-platform application for quality control of videos, based on Python/QT.
